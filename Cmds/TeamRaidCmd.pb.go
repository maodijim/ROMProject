...
const (
	...
	TeamRaidParam_TEAMRAIDPARAM_TEAM_SAVE_RAID_CREATE   TeamRaidParam = 10
)
...
var (
	TeamRaidParam_name = map[int32]string{
		...
		10: "TEAMRAIDPARAM_TEAM_SAVE_RAID_CREATE",
	}
	TeamRaidParam_value = map[string]int32{
		...
		"TEAMRAIDPARAM_TEAM_SAVE_RAID_CREATE":   10,
	}
)
...
type TeamSaveRaidCreateCmd struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cmd        *Command       `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=67" json:"cmd,omitempty"`
	Param      *TeamRaidParam `protobuf:"varint,2,opt,name=param,enum=Cmd.TeamRaidParam,def=10" json:"param,omitempty"`
	RaidType   *ERaidType     `protobuf:"varint,3,opt,name=raid_type,json=raidType,enum=Cmd.ERaidType" json:"raid_type,omitempty"`
	Difficulty *uint32        `protobuf:"varint,4,opt,name=difficulty" json:"difficulty,omitempty"`
}

// Default values for TeamSaveRaidCreateCmd fields.
const (
	Default_TeamSaveRaidCreateCmd_Cmd   = Command_TEAM_RAID_PROTOCMD
	Default_TeamSaveRaidCreateCmd_Param = TeamRaidParam_TEAMRAIDPARAM_TEAM_SAVE_RAID_CREATE
)

func (x *TeamSaveRaidCreateCmd) Reset() {
	*x = TeamSaveRaidCreateCmd{}
	if protoimpl.UnsafeEnabled {
...
func (x *TeamSaveRaidCreateCmd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TeamSaveRaidCreateCmd) ProtoMessage() {}

func (x *TeamSaveRaidCreateCmd) ProtoReflect() protoreflect.Message {
	mi := &file_TeamRaidCmd_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TeamSaveRaidCreateCmd.ProtoReflect.Descriptor instead.
func (*TeamSaveRaidCreateCmd) Descriptor() ([]byte, []int) {
	return file_TeamRaidCmd_proto_rawDescGZIP(), []int{8}
}

func (x *TeamSaveRaidCreateCmd) GetCmd() Command {
	if x != nil && x.Cmd != nil {
		return *x.Cmd
	}
	return Default_TeamSaveRaidCreateCmd_Cmd
}

func (x *TeamSaveRaidCreateCmd) GetParam() TeamRaidParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
	return Default_TeamSaveRaidCreateCmd_Param
}

func (x *TeamSaveRaidCreateCmd) GetRaidType() ERaidType {
	if x != nil && x.RaidType != nil {
		return *x.RaidType
	}
	return ERaidType_ERAIDTYPE_MIN
}

func (x *TeamSaveRaidCreateCmd) GetDifficulty() uint32 {
	if x != nil && x.Difficulty != nil {
		return *x.Difficulty
	}
	return 0
...
var file_TeamRaidCmd_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x86, 0x02, 0x0a, 0x11, 0x54, 0x65, 0x61, 0x6d, 0x52, 0x61,
	...
	0x28, 0x0d, 0x52, 0x0a, 0x64, 0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74, 0x79, 0x22, 0xf9,
	...
	0x52, 0x08, 0x72, 0x61, 0x69, 0x64, 0x54, 0x79, 0x70, 0x65, 0x22, 0xc2, 0x02, 0x0a, 0x10, 0x54,
	...
	0x01, 0x28, 0x0d, 0x52, 0x0a, 0x64, 0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74, 0x79, 0x22,
	...
	,
	...
	,
}
...
var file_TeamRaidCmd_proto_goTypes = []interface{}{
	...
	(*TeamSaveRaidCreateCmd)(nil),   // 9: Cmd.TeamSaveRaidCreateCmd
...
var file_TeamRaidCmd_proto_depIdxs = []int32{
	...
	10, // 21: Cmd.TeamSaveRaidCreateCmd.cmd:type_name -> Cmd.Command
	0,  // 22: Cmd.TeamSaveRaidCreateCmd.param:type_name -> Cmd.TeamRaidParam
	11, // 23: Cmd.TeamSaveRaidCreateCmd.raid_type:type_name -> Cmd.ERaidType
...
func file_TeamRaidCmd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_TeamRaidCmd_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TeamSaveRaidCreateCmd); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
