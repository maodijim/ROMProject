...
type SnapShotUserCmd struct {
	...
	Deletecdtime *uint32           `protobuf:"varint,6,opt,name=deletecdtime" json:"deletecdtime,omitempty"` // 删角功能解锁时间
	Maincharid   *uint64           `protobuf:"varint,7,opt,name=maincharid" json:"maincharid,omitempty"`     // 主角色id
}
...
type ExtraData struct {
	...
	Phone      *string `protobuf:"bytes,1,opt,name=phone" json:"phone,omitempty"`            //绑定的手机号码
	Safedevice *bool   `protobuf:"varint,2,opt,name=safedevice" json:"safedevice,omitempty"` //安全设备
}
...
type SelectRoleUserCmd struct {
	...
	Ignorepwd      *bool          `protobuf:"varint,10,opt,name=ignorepwd" json:"ignorepwd,omitempty"` //true 需要密码 false 不需要
...
type ReqLoginUserCmd struct {
	...
	Accid      *uint64        `protobuf:"varint,3,opt,name=accid,def=0" json:"accid,omitempty"`
	Zoneid     *uint32        `protobuf:"varint,4,opt,name=zoneid,def=0" json:"zoneid,omitempty"`
	Sha1       *string        `protobuf:"bytes,5,opt,name=sha1" json:"sha1,omitempty"`
	Version    *string        `protobuf:"bytes,6,opt,name=version" json:"version,omitempty"`
	Timestamp  *uint32        `protobuf:"varint,7,opt,name=timestamp,def=0" json:"timestamp,omitempty"`
...
type ReqLoginParamUserCmd struct {
	...
	Pwd       *string        `protobuf:"bytes,8,opt,name=pwd" json:"pwd,omitempty"`
}
...
func (x *ReqLoginParamUserCmd) GetPwd() string {
	if x != nil && x.Pwd != nil {
		return *x.Pwd
	}
	return ""
...
type ConfirmAuthorizeUserCmd struct {
	...
	Success   *bool          `protobuf:"varint,4,opt,name=success" json:"success,omitempty"` // false 输密码  true 跳过密码
	Resettime *uint32        `protobuf:"varint,5,opt,name=resettime" json:"resettime,omitempty"`
	Hasset    *bool          `protobuf:"varint,6,opt,name=hasset" json:"hasset,omitempty"` // false 未设置 true 设置
}
...
type SyncAuthorizeGateCmd struct {
	...
	Ignorepwd *bool          `protobuf:"varint,3,opt,name=ignorepwd" json:"ignorepwd,omitempty"` //true 需要密码 false 不需要
...
type RealAuthorizeUserCmd struct {
	...
	// res
	Authorized *bool `protobuf:"varint,4,opt,name=authorized" json:"authorized,omitempty"` //是否实名验证
}
...
type RealAuthorizeServerCmd struct {
	...
	Authorized *bool          `protobuf:"varint,3,opt,name=authorized" json:"authorized,omitempty"` //是否实名验证过
}
...
var file_LoginUserCmd_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x03, 0x43, 0x6d, 0x64, 0x1a, 0x12, 0x45, 0x72, 0x72, 0x6f, 0x72,
	0x55, 0x73, 0x65, 0x72, 0x43, 0x6d, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x11, 0x50,
	0x72, 0x6f, 0x74, 0x6f, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x1a, 0x0a, 0x78, 0x43, 0x6d, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xbb, 0x01, 0x0a,
	0x10, 0x52, 0x65, 0x67, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6d,
	...
	0x6e, 0x43, 0x6d, 0x64, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a, 0x13, 0x52, 0x45, 0x47, 0x5f, 0x52,
	0x45, 0x53, 0x55, 0x4c, 0x54, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x43, 0x4d, 0x44, 0x52, 0x05,
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x11, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x03, 0x20, 0x02, 0x28,
	0x0d, 0x3a, 0x01, 0x30, 0x52, 0x02, 0x69, 0x64, 0x12, 0x20, 0x0a, 0x03, 0x72, 0x65, 0x74, 0x18,
	0x04, 0x20, 0x02, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x52, 0x65, 0x67, 0x45,
	0x72, 0x72, 0x52, 0x65, 0x74, 0x52, 0x03, 0x72, 0x65, 0x74, 0x22, 0xf5, 0x02, 0x0a, 0x11, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x68, 0x61, 0x72, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6d, 0x64,
	...
	,
	...
	0x6f, 0x6e, 0x22, 0xb0, 0x02, 0x0a, 0x0f, 0x53, 0x6e, 0x61, 0x70, 0x53, 0x68, 0x6f, 0x74, 0x55,
	...
	0x68, 0x61, 0x72, 0x69, 0x64, 0x22, 0x41, 0x0a, 0x09, 0x45, 0x78, 0x74, 0x72, 0x61, 0x44, 0x61,
	0x74, 0x61, 0x12, 0x14, 0x0a, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x73, 0x61, 0x66, 0x65,
	0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x73, 0x61,
	0x66, 0x65, 0x64, 0x65, 0x76, 0x69, 0x63, 0x65, 0x22, 0xf8, 0x03, 0x0a, 0x11, 0x53, 0x65, 0x6c,
	0x65, 0x63, 0x74, 0x52, 0x6f, 0x6c, 0x65, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6d, 0x64, 0x12, 0x33,
	...
	,
	...
	,
	...
	0x3f, 0x0a, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x12,
	0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x43, 0x6d, 0x64, 0x50, 0x61, 0x72,
	0x61, 0x6d, 0x3a, 0x15, 0x4c, 0x4f, 0x47, 0x49, 0x4e, 0x5f, 0x52, 0x45, 0x53, 0x55, 0x4c, 0x54,
	0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x43, 0x4d, 0x44, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x12, 0x13, 0x0a, 0x03, 0x72, 0x65, 0x74, 0x18, 0x03, 0x20, 0x02, 0x28, 0x0d, 0x3a, 0x01, 0x30,
	0x52, 0x03, 0x72, 0x65, 0x74, 0x22, 0xc8, 0x01, 0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65,
	0x43, 0x68, 0x61, 0x72, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6d, 0x64, 0x12, 0x33, 0x0a, 0x03, 0x63,
	...
	0x72, 0x61, 0x6d, 0x3a, 0x14, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x5f, 0x43, 0x48, 0x41, 0x52,
	0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x43, 0x4d, 0x44, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64,
	0x12, 0x14, 0x0a, 0x05, 0x61, 0x63, 0x63, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x05, 0x61, 0x63, 0x63, 0x69, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e,
	0x22, 0x9d, 0x01, 0x0a, 0x10, 0x48, 0x65, 0x61, 0x72, 0x74, 0x42, 0x65, 0x61, 0x74, 0x55, 0x73,
	...
	,
	...
	0x53, 0x45, 0x52, 0x56, 0x45, 0x52, 0x54, 0x49, 0x4d, 0x45, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f,
	0x43, 0x4d, 0x44, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x15, 0x0a, 0x04, 0x74, 0x69,
	0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x3a, 0x01, 0x30, 0x52, 0x04, 0x74, 0x69, 0x6d,
	0x65, 0x22, 0xc1, 0x01, 0x0a, 0x13, 0x47, 0x4d, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x68,
	...
	0x6d, 0x3a, 0x17, 0x47, 0x4d, 0x5f, 0x44, 0x45, 0x4c, 0x45, 0x54, 0x45, 0x5f, 0x43, 0x48, 0x41,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x04, 0x52, 0x05, 0x61, 0x63, 0x63, 0x69, 0x64, 0x22, 0xa0, 0x01, 0x0a, 0x12, 0x43, 0x6c, 0x69,
	0x65, 0x6e, 0x74, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6d, 0x64, 0x12,
	...
	,
	...
	0x43, 0x4f, 0x4e, 0x46, 0x49, 0x52, 0x4d, 0x5f, 0x41, 0x55, 0x54, 0x48, 0x4f, 0x52, 0x49, 0x5a,
	0x45, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x43, 0x4d, 0x44, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61,
	0x6d, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x03, 0x20,
	...
	,
	...
	0x53, 0x59, 0x4e, 0x43, 0x5f, 0x41, 0x55, 0x54, 0x48, 0x4f, 0x52, 0x49, 0x5a, 0x45, 0x5f, 0x47,
	0x41, 0x54, 0x45, 0x5f, 0x43, 0x4d, 0x44, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x1c,
	0x0a, 0x09, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x70, 0x77, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x09, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x70, 0x77, 0x64, 0x12, 0x1a, 0x0a, 0x08,
	...
	,
}
...
var file_LoginUserCmd_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_LoginUserCmd_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_LoginUserCmd_proto_goTypes = []interface{}{
	(LoginCmdParam)(0),              // 0: Cmd.LoginCmdParam
	(*RegResultUserCmd)(nil),        // 1: Cmd.RegResultUserCmd
	(*CreateCharUserCmd)(nil),       // 2: Cmd.CreateCharUserCmd
	(*SnapShotUserCmd)(nil),         // 3: Cmd.SnapShotUserCmd
	(*ExtraData)(nil),               // 4: Cmd.ExtraData
	(*SelectRoleUserCmd)(nil),       // 5: Cmd.SelectRoleUserCmd
	(*LoginResultUserCmd)(nil),      // 6: Cmd.LoginResultUserCmd
	(*DeleteCharUserCmd)(nil),       // 7: Cmd.DeleteCharUserCmd
	(*HeartBeatUserCmd)(nil),        // 8: Cmd.HeartBeatUserCmd
	(*ServerTimeUserCmd)(nil),       // 9: Cmd.ServerTimeUserCmd
	(*GMDeleteCharUserCmd)(nil),     // 10: Cmd.GMDeleteCharUserCmd
	(*ClientInfoUserCmd)(nil),       // 11: Cmd.ClientInfoUserCmd
	(*ReqLoginUserCmd)(nil),         // 12: Cmd.ReqLoginUserCmd
	(*ReqLoginParamUserCmd)(nil),    // 13: Cmd.ReqLoginParamUserCmd
	(*KickParamUserCmd)(nil),        // 14: Cmd.KickParamUserCmd
	(*CancelDeleteCharUserCmd)(nil), // 15: Cmd.CancelDeleteCharUserCmd
	(*ClientFrameUserCmd)(nil),      // 16: Cmd.ClientFrameUserCmd
	(*SafeDeviceUserCmd)(nil),       // 17: Cmd.SafeDeviceUserCmd
	(*ConfirmAuthorizeUserCmd)(nil), // 18: Cmd.ConfirmAuthorizeUserCmd
	(*SyncAuthorizeGateCmd)(nil),    // 19: Cmd.SyncAuthorizeGateCmd
	(*RealAuthorizeUserCmd)(nil),    // 20: Cmd.RealAuthorizeUserCmd
	(*RealAuthorizeServerCmd)(nil),  // 21: Cmd.RealAuthorizeServerCmd
	(Command)(0),                    // 22: Cmd.Command
	(RegErrRet)(0),                  // 23: Cmd.RegErrRet
	(*SnapShotDataPB)(nil),          // 24: Cmd.SnapShotDataPB
}
var file_LoginUserCmd_proto_depIdxs = []int32{
	22, // 0: Cmd.RegResultUserCmd.cmd:type_name -> Cmd.Command
	0,  // 1: Cmd.RegResultUserCmd.param:type_name -> Cmd.LoginCmdParam
	23, // 2: Cmd.RegResultUserCmd.ret:type_name -> Cmd.RegErrRet
	22, // 3: Cmd.CreateCharUserCmd.cmd:type_name -> Cmd.Command
	0,  // 4: Cmd.CreateCharUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 5: Cmd.SnapShotUserCmd.cmd:type_name -> Cmd.Command
	0,  // 6: Cmd.SnapShotUserCmd.param:type_name -> Cmd.LoginCmdParam
	24, // 7: Cmd.SnapShotUserCmd.data:type_name -> Cmd.SnapShotDataPB
	22, // 8: Cmd.SelectRoleUserCmd.cmd:type_name -> Cmd.Command
	0,  // 9: Cmd.SelectRoleUserCmd.param:type_name -> Cmd.LoginCmdParam
	4,  // 10: Cmd.SelectRoleUserCmd.extraData:type_name -> Cmd.ExtraData
	22, // 11: Cmd.LoginResultUserCmd.cmd:type_name -> Cmd.Command
	0,  // 12: Cmd.LoginResultUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 13: Cmd.DeleteCharUserCmd.cmd:type_name -> Cmd.Command
	0,  // 14: Cmd.DeleteCharUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 15: Cmd.HeartBeatUserCmd.cmd:type_name -> Cmd.Command
	0,  // 16: Cmd.HeartBeatUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 17: Cmd.ServerTimeUserCmd.cmd:type_name -> Cmd.Command
	0,  // 18: Cmd.ServerTimeUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 19: Cmd.GMDeleteCharUserCmd.cmd:type_name -> Cmd.Command
	0,  // 20: Cmd.GMDeleteCharUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 21: Cmd.ClientInfoUserCmd.cmd:type_name -> Cmd.Command
	0,  // 22: Cmd.ClientInfoUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 23: Cmd.ReqLoginUserCmd.cmd:type_name -> Cmd.Command
	0,  // 24: Cmd.ReqLoginUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 25: Cmd.ReqLoginParamUserCmd.cmd:type_name -> Cmd.Command
	0,  // 26: Cmd.ReqLoginParamUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 27: Cmd.KickParamUserCmd.cmd:type_name -> Cmd.Command
	0,  // 28: Cmd.KickParamUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 29: Cmd.CancelDeleteCharUserCmd.cmd:type_name -> Cmd.Command
	0,  // 30: Cmd.CancelDeleteCharUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 31: Cmd.ClientFrameUserCmd.cmd:type_name -> Cmd.Command
	0,  // 32: Cmd.ClientFrameUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 33: Cmd.SafeDeviceUserCmd.cmd:type_name -> Cmd.Command
	0,  // 34: Cmd.SafeDeviceUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 35: Cmd.ConfirmAuthorizeUserCmd.cmd:type_name -> Cmd.Command
	0,  // 36: Cmd.ConfirmAuthorizeUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 37: Cmd.SyncAuthorizeGateCmd.cmd:type_name -> Cmd.Command
	0,  // 38: Cmd.SyncAuthorizeGateCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 39: Cmd.RealAuthorizeUserCmd.cmd:type_name -> Cmd.Command
	0,  // 40: Cmd.RealAuthorizeUserCmd.param:type_name -> Cmd.LoginCmdParam
	22, // 41: Cmd.RealAuthorizeServerCmd.cmd:type_name -> Cmd.Command
	0,  // 42: Cmd.RealAuthorizeServerCmd.param:type_name -> Cmd.LoginCmdParam
