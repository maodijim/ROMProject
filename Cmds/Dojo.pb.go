...
const (
	...
	DojoParam_EDOJOPARAM_ENTERDOJO         DojoParam = 5  //进入道场
	DojoParam_EDOJOPARAM_ADD_MSG           DojoParam = 6  //添加留言
	DojoParam_EDOJOPARAM_PANEL_OPER        DojoParam = 7  //道场面板操作
	DojoParam_EDOJOPARAM_SPONSOR           DojoParam = 9  //发起道场
	DojoParam_EDOJOPARAM_QUERYSTATE        DojoParam = 10 //请求状态
	DojoParam_EDOJOPARAM_REWARD            DojoParam = 11 //道场奖励
)
...
const (
	...
	DojoState_DOJOSTATE_SPONSORED DojoState = 1 //有人发起了
	DojoState_DOJOSTATE_OPENED    DojoState = 2 //道场已经开始
...
type DojoPrivateInfoCmd struct {
	...
	Groupid     *uint32    `protobuf:"varint,3,opt,name=groupid" json:"groupid,omitempty"` //组策划表id  //feiqi
...
type DojoPublicInfoCmd struct {
	...
	Dojoid  *uint32      `protobuf:"varint,3,opt,name=dojoid" json:"dojoid,omitempty"` //道场id
...
type DojoInviteCmd struct {
	...
	Dojoid      *uint32    `protobuf:"varint,3,opt,name=dojoid" json:"dojoid,omitempty"`          //道场id
	Sponsorid   *uint64    `protobuf:"varint,4,opt,name=sponsorid" json:"sponsorid,omitempty"`    //发起人
	Sponsorname *string    `protobuf:"bytes,5,opt,name=sponsorname" json:"sponsorname,omitempty"` //发起人name
}
...
type DojoSponsorCmd struct {
	...
	Dojoid      *uint32    `protobuf:"varint,3,opt,name=dojoid" json:"dojoid,omitempty"`                           //道场id
	IsCancel    *bool      `protobuf:"varint,4,opt,name=is_cancel,json=isCancel,def=0" json:"is_cancel,omitempty"` //取消进入
	Sponsorid   *uint64    `protobuf:"varint,5,opt,name=sponsorid" json:"sponsorid,omitempty"`                     //发起人
	Sponsorname *string    `protobuf:"bytes,6,opt,name=sponsorname" json:"sponsorname,omitempty"`                  //发起人name
...
type DojoRewardCmd struct {
	...
	Items    []*ItemInfo `protobuf:"bytes,5,rep,name=items" json:"items,omitempty"` //奖励
}
