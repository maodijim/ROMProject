...
const (
	...
	AuthorizeParam_SYNC_REAL_AUTHORIZE_TO_SESSION AuthorizeParam = 5 //实名认证
)
...
const (
	...
	EUnlockType_EUNLOCKTYPE_ITEM_CODE     EUnlockType = 15 //黑猫包获得礼包码
	EUnlockType_EUNLOCKTYPE_MAX           EUnlockType = 16
)
...
type ResetAuthorizeUserCmd struct {
	...
	Reset_ *bool           `protobuf:"varint,3,req,name=reset" json:"reset,omitempty"` //true 重置密码 false 取消重置
}
...
var file_Authorize_proto_rawDesc = []byte{
	...
	0xbe, 0x03, 0x0a, 0x0b, 0x45, 0x55, 0x6e, 0x6c, 0x6f, 0x63, 0x6b, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x49, 0x54, 0x45, 0x4d, 0x5f, 0x43, 0x4f, 0x44, 0x45, 0x10, 0x0f, 0x12, 0x13, 0x0a, 0x0f, 0x45,
	0x55, 0x4e, 0x4c, 0x4f, 0x43, 0x4b, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4d, 0x41, 0x58, 0x10, 0x10,
}
