...
const (
	...
	ErrCmdParam_MAINTAIN_USER_CMD ErrCmdParam = 3 // 服务器维护提示
)
...
const (
	RegErrRet_REG_ERR_SUCC                 RegErrRet = 0  // 登陆成功
	RegErrRet_REG_ERR_SERVER_STOP          RegErrRet = 1  // 服务器维护
	RegErrRet_REG_ERR_SERVER_STOP_LOGIN    RegErrRet = 2  // 服务器流程中服务器维护
	RegErrRet_REG_ERR_DUPLICATE_LOGIN      RegErrRet = 3  // 账号强行登陆
	RegErrRet_REG_ERR_RELOGIN_OVERTIME     RegErrRet = 4  // 重连超时
	RegErrRet_REG_ERR_NEW_VERSION          RegErrRet = 5  // 有新版本更新
	RegErrRet_REG_ERR_PROFESSION_NOOPEN    RegErrRet = 6  // 无法创建-职业未开放
	RegErrRet_REG_ERR_NAME_INVALID         RegErrRet = 7  // 无法创建-含非法字符
	RegErrRet_REG_ERR_NAME_EMPTY           RegErrRet = 8  // 无法创建-名字为空
	RegErrRet_REG_ERR_NAME_OVERMAXLEN      RegErrRet = 9  // 无法创建-名字太长
	RegErrRet_REG_ERR_NAME_DUPLICATE       RegErrRet = 10 // 无法创建-重名
	RegErrRet_REG_ERR_SEQUENCE             RegErrRet = 16 // 无法创建-该格子无法创建
	RegErrRet_REG_ERR_DELETE_ERROR         RegErrRet = 17 // 无法删除
	RegErrRet_REG_ERR_DELETE_ERROR_LOCKED  RegErrRet = 18 // 无法删除-被封号
	RegErrRet_REG_ERR_PASSWD_INVALID       RegErrRet = 20 // 服务器密码验证错误
	RegErrRet_REG_ERR_OVERTIME             RegErrRet = 21
	RegErrRet_REG_ERR_ACC_FORBID           RegErrRet = 22  // 账号封停
	RegErrRet_REG_ERR_SERVER_UNOPENED      RegErrRet = 51  // 服务器未开放
	RegErrRet_REG_ERR_RELOGIN_SCENE        RegErrRet = 100 // 场景重复登录
	RegErrRet_REG_ERR_SESSION_CREATE_FAILD RegErrRet = 101 // 会话创建角色失败
	RegErrRet_REG_ERR_NOTIFY_SCENE         RegErrRet = 102 // 未找到对应场景
	RegErrRet_REG_ERR_SCENE_CREATE_FAILD   RegErrRet = 103 // 场景创建角色失败
	RegErrRet_REG_ERR_FIND_GATE            RegErrRet = 104 // 找不到登录网关
	RegErrRet_REG_ERR_REQ_DATA_FROM_RECORD RegErrRet = 105 // 从record请求数据错误
	RegErrRet_REG_ERR_SET_USER_DATA_SCENE  RegErrRet = 106 // 设置玩家数据失败
	RegErrRet_REG_ERR_FORBID_REG           RegErrRet = 107 // 被封号
	RegErrRet_REG_ERR_ENTER_SCENE          RegErrRet = 108 // 进入场景失败
	RegErrRet_REG_ERR_GET_USER_DATA        RegErrRet = 109 // 读档失败
)
...
type MaintainUserCmd struct {
	...
	Content *string      `protobuf:"bytes,3,opt,name=content" json:"content,omitempty"` //内容文字
	Tip     *string      `protobuf:"bytes,4,opt,name=tip" json:"tip,omitempty"`         //提示文字
	Picture *string      `protobuf:"bytes,5,opt,name=picture" json:"picture,omitempty"` //图片地址
}
...
var file_ErrorUserCmd_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x02, 0x0a, 0x0d, 0x52, 0x65, 0x67, 0x45, 0x72, 0x72,
	...
	0x03, 0x28, 0x0d, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x22, 0x9b, 0x01, 0x0a, 0x10, 0x4b, 0x69,
	...
	0x4d, 0x44, 0x10, 0x03, 0x2a, 0x88, 0x06, 0x0a, 0x09, 0x52, 0x65, 0x67, 0x45, 0x72, 0x72, 0x52,
	...
	0x47, 0x45, 0x54, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x44, 0x41, 0x54, 0x41, 0x10, 0x6d,
}
