...
const (
	WeddingCParam_WEDDINGCPARAM_REQ_WEDDINGDATE_LIST          WeddingCParam = 1  //请求婚礼排期列表
	WeddingCParam_WEDDINGCPARAM_REQ_WEDDING_ONEDAY_LIST       WeddingCParam = 3  //某一天的预定时间
	WeddingCParam_WEDDINGCPARAM_REQ_WEDDING_INFO              WeddingCParam = 4  //查看某个预定的详情
	WeddingCParam_WEDDINGCPARAM_RESERVE_WEDDINGDATE           WeddingCParam = 5  //预定
	WeddingCParam_WEDDINGCPARAM_NTF_RESERVE_WEDDINGDATE       WeddingCParam = 6  //对方收到预定通知
	WeddingCParam_WEDDINGCPARAM_REPLY_RESERVE_WEDDINGDATE     WeddingCParam = 7  //对方回复预定通知
	WeddingCParam_WEDDINGCPARAM_GIVEUP_RESERVE                WeddingCParam = 8  //放弃预定
	WeddingCParam_WEDDINGCPARAM_REQ_DIVORCE                   WeddingCParam = 9  //请求离婚
	WeddingCParam_WEDDINGCPARAM_UPDATE_MANUAL                 WeddingCParam = 10 //结婚手册数据查询/更新
	WeddingCParam_WEDDINGCPARAM_BUY_PACKAGE                   WeddingCParam = 11 //购买套餐
	WeddingCParam_WEDDINGCPARAM_BUY_RING                      WeddingCParam = 12 //购买戒指
	WeddingCParam_WEDDINGCPARAM_INVITE                        WeddingCParam = 13 //邀请
	WeddingCParam_WEDDINGCPARAM_UPLOAD_WEDDING_PHOTO          WeddingCParam = 14 //上传结婚照
	WeddingCParam_WEDDINGCPARAM_CHECK_CAN_RESERVE             WeddingCParam = 15 //检查可否订婚
	WeddingCParam_WEDDINGCPARAM_REQ_PARTNER_INFO              WeddingCParam = 16 //请求伴侣信息
	WeddingCParam_WEDDINGCPARAM_NTF_WEDDING_INFO              WeddingCParam = 17 //玩家上线推送订婚信息给玩家
	WeddingCParam_WEDDINGCPARAM_INVITE_WEDDING                WeddingCParam = 18 //邀请开始婚礼仪式
	WeddingCParam_WEDDINGCPARAM_REPLY_WEDDING                 WeddingCParam = 19 //同意开始婚礼仪式
	WeddingCParam_WEDDINGCPARAM_GOTO_WEDDINGPOS               WeddingCParam = 20 //通知婚礼双方移动到主教位置
	WeddingCParam_WEDDINGCPARAM_QUESTION                      WeddingCParam = 21 //答题,问题
	WeddingCParam_WEDDINGCPARAM_ANSWER                        WeddingCParam = 22 //答题,回答
	WeddingCParam_WEDDINGCPARAM_WEDDING_EVENT_MSG             WeddingCParam = 23 //婚礼事件到场景，可能会离线
	WeddingCParam_WEDDINGCPARAM_WEDDING_STOP                  WeddingCParam = 24 //婚礼结束消息
	WeddingCParam_WEDDINGCPARAM_QUESTION_SWITCH               WeddingCParam = 25 //答题, 开始或者结束
	WeddingCParam_WEDDINGCPARAM_ENTER_ROLLER_COASTER          WeddingCParam = 26 //进入婚礼过山车
	WeddingCParam_WEDDINGCPARAM_DIVORCE_ROLLER_COASTER_INVITE WeddingCParam = 27 //离婚过山车邀请
	WeddingCParam_WEDDINGCPARAM_DIVORCE_ROLLER_COASTER_REPLY  WeddingCParam = 28 //离婚过山车回复
	WeddingCParam_WEDDINGCPARAM_ENTER_WEDDINGMAP              WeddingCParam = 29 //访问Npc进入婚礼地图
	WeddingCParam_WEDDINGCPARAM_MISSYOU_INVITE                WeddingCParam = 30 //好想你邀请
	WeddingCParam_WEDDINGCPARAM_MISSYOU_REPLY                 WeddingCParam = 31 //好想你应答
	WeddingCParam_WEDDINGCPARAM_CARRIER                       WeddingCParam = 32 //乘坐载具
)
...
const (
	EWeddingStatus_EWeddingStatus_Reserve EWeddingStatus = 0 //预定
	EWeddingStatus_EWeddingStatus_Married EWeddingStatus = 1 //结婚
	EWeddingStatus_EWeddingStatus_None    EWeddingStatus = 2 //无
)
...
const (
	EWeddingEvent_EWeddingEvent_Reserve              EWeddingEvent = 1  //订婚
	EWeddingEvent_EWeddingEvent_GiveupReserve        EWeddingEvent = 2  //放弃订婚
	EWeddingEvent_EWeddingEvent_Marry                EWeddingEvent = 3  //结婚
	EWeddingEvent_EWeddingEvent_CancelReserveTimeOut EWeddingEvent = 5  //超时取消订婚
	EWeddingEvent_EWeddingEvent_CancelReserveSys     EWeddingEvent = 6  //系统维护取消订婚
	EWeddingEvent_EWeddingEvent_DivorceTogether      EWeddingEvent = 7  //协议离婚
	EWeddingEvent_EWeddingEvent_DivorceSingle        EWeddingEvent = 8  //单方面离婚
	EWeddingEvent_EWeddingEvent_DivorceForce         EWeddingEvent = 9  //强制离婚
	EWeddingEvent_EWeddingEvent_DivorceDelChar       EWeddingEvent = 10 //删角色离婚
	EWeddingEvent_EWeddingEvent_DelInvitation        EWeddingEvent = 11 //删除邀请函
)
...
type WeddingDateStatus struct {
	...
	Date   *uint32      `protobuf:"varint,1,opt,name=date,def=0" json:"date,omitempty"` //那天0点时间戳
...
type ReqWeddingDateListCCmd struct {
	...
	DateList  []*WeddingDateStatus `protobuf:"bytes,3,rep,name=date_list,json=dateList" json:"date_list,omitempty"`     //那天0点时间戳
	UseTicket *bool                `protobuf:"varint,4,opt,name=use_ticket,json=useTicket" json:"use_ticket,omitempty"` //是否是婚礼券
}
...
type WeddingOneDayInfo struct {
	...
	Ban       *bool   `protobuf:"varint,2,opt,name=ban,def=0" json:"ban,omitempty"` //是否禁止
	...
	Id        *uint64 `protobuf:"varint,6,opt,name=id" json:"id,omitempty"` //婚礼id如果为0表示每人预定
}
...
type BirefWeddingInfo struct {
	...
	CanSingleDivorce *bool           `protobuf:"varint,8,opt,name=can_single_divorce,json=canSingleDivorce" json:"can_single_divorce,omitempty"` //可否单方面离婚
}
...
type GiveUpReserveCCmd struct {
	...
	Id    *uint64        `protobuf:"varint,3,opt,name=id" json:"id,omitempty"` //婚礼id
}
...
type ReqDivorceCCmd struct {
	...
	Id    *uint64        `protobuf:"varint,3,opt,name=id" json:"id,omitempty"` //婚礼唯一id
...
type ClientWeddingManual struct {
	...
	Packageids []uint32 `protobuf:"varint,1,rep,name=packageids" json:"packageids,omitempty"` // 已购买套餐id
...
type BuyWeddingPackageCCmd struct {
	...
	Id        *uint32        `protobuf:"varint,3,opt,name=id,def=0" json:"id,omitempty"`               // 套餐id
	Priceitem *uint32        `protobuf:"varint,4,opt,name=priceitem,def=0" json:"priceitem,omitempty"` // 使用的货币id
}
...
type WeddingInviteCCmd struct {
	...
	Charids []uint64       `protobuf:"varint,3,rep,name=charids" json:"charids,omitempty"` // 被邀请人charid
}
...
type WeddingEventMsgCCmd struct {
	...
	OptCharid *uint64        `protobuf:"varint,9,opt,name=opt_charid,json=optCharid" json:"opt_charid,omitempty"` //操作者
}
...
type DivorceRollerCoasterInviteCCmd struct {
	...
	Inviter     *uint64        `protobuf:"varint,3,opt,name=inviter" json:"inviter,omitempty"`                           //邀请人
	Invitee     *uint64        `protobuf:"varint,4,opt,name=invitee" json:"invitee,omitempty"`                           //被邀请人
	InviterName *string        `protobuf:"bytes,5,opt,name=inviter_name,json=inviterName" json:"inviter_name,omitempty"` //邀请人名字
}
