...
const (
	...
	ECookType_ECOOKTYPE_JIANCHAO ECookType = 1 //煎炒
	ECookType_ECOOKTYPE_BARBECUE ECookType = 2 //烧烤
	ECookType_ECOOKTYPE_SOUP     ECookType = 3 //汤
	ECookType_ECOOKTYPE_DESSERT  ECookType = 4 //点心生煎
...
const (
	...
	ECookState_ECOOKSTATE_PREPAREING ECookState = 1 //准备中
	ECookState_ECOOKSTATE_COOKING    ECookState = 2 //制作中，进度
	ECookState_ECOOKSTATE_COMPLETE   ECookState = 3 //完成，附带结果成功，失败
)
...
type CookStateMsg struct {
	...
	Cooktype *ECookType  `protobuf:"varint,2,opt,name=cooktype,enum=Cmd.ECookType" json:"cooktype,omitempty"` //烹饪方式
	Progress *uint32     `protobuf:"varint,3,opt,name=progress" json:"progress,omitempty"`                    //制作中的进度，百分制，1表示百分之一。
	Success  *bool       `protobuf:"varint,4,opt,name=success" json:"success,omitempty"`                      //制作是否成功
...
type StartCook struct {
	...
	Cooktype      *ECookType       `protobuf:"varint,3,opt,name=cooktype,enum=Cmd.ECookType" json:"cooktype,omitempty"`
	Material      []*BriefItemInfo `protobuf:"bytes,4,rep,name=material" json:"material,omitempty"` //食材
	Recipe        *uint32          `protobuf:"varint,5,opt,name=recipe" json:"recipe,omitempty"`    //食谱 暂时弃用
	Skipanimation *bool            `protobuf:"varint,6,opt,name=skipanimation,def=0" json:"skipanimation,omitempty"`
	Recipes       []uint32         `protobuf:"varint,7,rep,name=recipes" json:"recipes,omitempty"` //匹配到的食谱
}
...
type PutFood struct {
	...
	Foodnum  *uint32    `protobuf:"varint,5,opt,name=foodnum" json:"foodnum,omitempty"`     //放置料理数量
	Peteat   *bool      `protobuf:"varint,6,opt,name=peteat,def=0" json:"peteat,omitempty"` //本次放置是否宠物享用
}
...
type QueryFoodNpcInfo struct {
	...
	Npcguid      *uint64    `protobuf:"varint,3,opt,name=npcguid" json:"npcguid,omitempty"`
	EatingPeople *uint32    `protobuf:"varint,4,opt,name=eating_people,json=eatingPeople" json:"eating_people,omitempty"` //多少人在吃
	Itemid       *uint32    `protobuf:"varint,5,opt,name=itemid" json:"itemid,omitempty"`
	Ownerid      *uint64    `protobuf:"varint,6,opt,name=ownerid" json:"ownerid,omitempty"` //主人id
	Itemnum      *uint32    `protobuf:"varint,7,opt,name=itemnum" json:"itemnum,omitempty"` //料理数量
}
...
type StartEat struct {
	...
	Eatnum  *uint32    `protobuf:"varint,5,opt,name=eatnum" json:"eatnum,omitempty"` //吃的数量
}
...
type FoodInfoNtf struct {
	...
	Recipeids       []uint32         `protobuf:"varint,3,rep,name=recipeids" json:"recipeids,omitempty"`                                      //解锁的食谱
	LastCookedFoods []uint32         `protobuf:"varint,4,rep,name=last_cooked_foods,json=lastCookedFoods" json:"last_cooked_foods,omitempty"` //最近烹饪的料理
	EatFoods        []*FoodItemInfo2 `protobuf:"bytes,5,rep,name=eat_foods,json=eatFoods" json:"eat_foods,omitempty"`                         //目前正在吃的料理
}
...
type UnlockRecipeNtf struct {
	...
	Recipe *uint32    `protobuf:"varint,3,opt,name=recipe" json:"recipe,omitempty"` //食谱
}
...
type QueryFoodManualData struct {
	...
	Cookerexp *uint32           `protobuf:"varint,3,opt,name=cookerexp" json:"cookerexp,omitempty"` //厨师经验
	Cookerlv  *uint32           `protobuf:"varint,4,opt,name=cookerlv" json:"cookerlv,omitempty"`   //厨师等级
	Tasterexp *uint32           `protobuf:"varint,5,opt,name=tasterexp" json:"tasterexp,omitempty"` //美食家经验
	Tasterlv  *uint32           `protobuf:"varint,6,opt,name=tasterlv" json:"tasterlv,omitempty"`   //美食家等级
...
var file_SceneFood_proto_rawDesc = []byte{
	...
	0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x22, 0xbc, 0x02, 0x0a,
	...
	,
	...
	,
	...
	0x28, 0x0d, 0x52, 0x0b, 0x69, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x22,
	0x9c, 0x02, 0x0a, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79, 0x46, 0x6f, 0x6f, 0x64, 0x4e, 0x70, 0x63,
	...
	0x18, 0x53, 0x43, 0x45, 0x4e, 0x45, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x46, 0x4f, 0x4f, 0x44,
	...
	,
	...
	,
	...
	,
}
