...
const (
	...
	ShopParam_SHOPPARAM_QUERY_SHOP_SOLD_COUNT    ShopParam = 4 //全服限售商品出售数量
	ShopParam_SHOPPARAM_UPDATE_DATA              ShopParam = 5 //商店数据更新
	ShopParam_SHOPPARAM_UPDATE_SHOP_CONFIG_CMD   ShopParam = 6 //更新商店商品信息 s->c
	ShopParam_SHOPPARAM_UPDATE_EXCHANGESHOP_DATA ShopParam = 7 //更新兑换商店信息
	ShopParam_SHOPPARAM_EXCHANGEITEM_CMD         ShopParam = 8 //兑换商品
...
const (
	...
	EShopLimitType_ESHOPLIMITTYPE_ACC_USER        EShopLimitType = 4   //账号共享次数 每天
	EShopLimitType_ESHOPLIMITTYPE_ACC_USER_ALWAYS EShopLimitType = 8   //账号永久共享次数
	EShopLimitType_ESHOPLIMITTYPE_USER_WEEK       EShopLimitType = 16  //角色周限购
	EShopLimitType_ESHOPLIMITTYPE_USER_MONTH      EShopLimitType = 32  //角色月限购
	EShopLimitType_ESHOPLIMITTYPE_ACC_WEEK        EShopLimitType = 64  //账号周限购
	EShopLimitType_ESHOPLIMITTYPE_ACC_MONTH       EShopLimitType = 128 //账号月限购
	EShopLimitType_ESHOPLIMITTYPE_MAX             EShopLimitType = 256
)
...
const (
	...
	EShopLockType_ESHOPLOCKTYPE_MAX           EShopLockType = 3
)
...
const (
	EPresentType_EPRESENTTYPE_NORMAL EPresentType = 0 // 普通商品
	EPresentType_EPRESENTTYPE_LOCK   EPresentType = 1 // 需要判断是否已解锁
)
...
const (
	EExchangeStatusType_EEXCHANGESTATUSTYPE_OK     EExchangeStatusType = 1 //可兑换
	EExchangeStatusType_EEXCHANGESTATUSTYPE_EMPTY  EExchangeStatusType = 2 //售空
	EExchangeStatusType_EEXCHANGESTATUSTYPE_DELAY  EExchangeStatusType = 3 //延迟出现
	EExchangeStatusType_EEXCHANGESTATUSTYPE_UNLOOK EExchangeStatusType = 4 //消失
)
...
type Presentation struct {
	...
	Msgid       *uint32       `protobuf:"varint,2,opt,name=msgid,def=0" json:"msgid,omitempty"` // 购买已拥有商品时的提示
	Menuid      []uint32      `protobuf:"varint,3,rep,name=menuid" json:"menuid,omitempty"`     // 道具解锁的menu ID
}
...
type ShopItem struct {
	...
	Discountmax *uint32        `protobuf:"varint,33,opt,name=discountmax" json:"discountmax,omitempty"` // 折扣活动商品最大打折次数
	Actdiscount *uint32        `protobuf:"varint,34,opt,name=actdiscount" json:"actdiscount,omitempty"` // 折扣活动商品折扣
	Producenum  *uint32        `protobuf:"varint,35,opt,name=producenum" json:"producenum,omitempty"`   //全服产出数量
	// lzq 随购买次数价格递增功能
	Nextgoodsid   *uint32  `protobuf:"varint,36,opt,name=nextgoodsid" json:"nextgoodsid,omitempty"` //达到限购次数后，要触发的下一个商品ID。
...
type UpdateShopConfigCmd struct {
	...
	Type       *uint32     `protobuf:"varint,3,opt,name=type" json:"type,omitempty"`                                 //商店类型
	Shopid     *uint32     `protobuf:"varint,4,opt,name=shopid" json:"shopid,omitempty"`                             //shop id
	DelGoodsId []uint32    `protobuf:"varint,5,rep,name=del_goods_id,json=delGoodsId" json:"del_goods_id,omitempty"` //要屏蔽掉的goods id
	AddGoods   []*ShopItem `protobuf:"bytes,6,rep,name=add_goods,json=addGoods" json:"add_goods,omitempty"`          //要添加的goods info
}
...
type ExchangeShopItem struct {
	...
	Id            *uint32              `protobuf:"varint,1,opt,name=id" json:"id,omitempty"` //商品ID
	...
	ExchangeCount *uint32              `protobuf:"varint,4,opt,name=exchange_count,json=exchangeCount" json:"exchange_count,omitempty"` //已经兑换的数量
	LeftTime      *uint32              `protobuf:"varint,5,opt,name=left_time,json=leftTime" json:"left_time,omitempty"`                //剩余时间
	DelayTime     *uint32              `protobuf:"varint,6,opt,name=delay_time,json=delayTime" json:"delay_time,omitempty"`             //延迟开始时间
}
...
type UpdateExchangeShopData struct {
	...
	Items    []*ExchangeShopItem `protobuf:"bytes,3,rep,name=items" json:"items,omitempty"`                        //添加或者更改的商品
	DelItems []uint32            `protobuf:"varint,4,rep,name=del_items,json=delItems" json:"del_items,omitempty"` //需要删除的商品
	MenuOpen *bool               `protobuf:"varint,5,opt,name=menu_open,json=menuOpen" json:"menu_open,omitempty"` //功能开启
...
type ExchangeShopItemCmd struct {
	...
	Id    *uint32             `protobuf:"varint,3,opt,name=id" json:"id,omitempty"`      //兑换的商品ID
	Items []*ExchangeItemInfo `protobuf:"bytes,4,rep,name=items" json:"items,omitempty"` //选中的消耗物品
}
...
var file_SessionShop_proto_rawDesc = []byte{
	...
	0x75, 0x69, 0x64, 0x22, 0xa6, 0x0a, 0x0a, 0x08, 0x53, 0x68, 0x6f, 0x70, 0x49, 0x74, 0x65, 0x6d,
	...
	0x70, 0x72, 0x65, 0x73, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xfc, 0x01, 0x0a,
	0x0b, 0x42, 0x75, 0x79, 0x53, 0x68, 0x6f, 0x70, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x3a, 0x0a, 0x03,
	...
	,
	...
	0x45, 0x53, 0x53, 0x49, 0x4f, 0x4e, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x53, 0x48, 0x4f, 0x50,
	...
	,
	...
	,
	...
	,
}
...
var file_SessionShop_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_SessionShop_proto_goTypes = []interface{}{
	...
	(EProfession)(0),                     // 20: Cmd.EProfession
...
var file_SessionShop_proto_depIdxs = []int32{
	...
	20, // 1: Cmd.ShopItem.profession:type_name -> Cmd.EProfession
	...
	21, // 14: Cmd.QueryShopSoldCountCmd.cmd:type_name -> Cmd.Command
	...
	21, // 17: Cmd.ShopDataUpdateCmd.cmd:type_name -> Cmd.Command
	0,  // 18: Cmd.ShopDataUpdateCmd.param:type_name -> Cmd.ShopParam
	21, // 19: Cmd.UpdateShopConfigCmd.cmd:type_name -> Cmd.Command
	...
	21, // 23: Cmd.UpdateExchangeShopData.cmd:type_name -> Cmd.Command
	...
	21, // 26: Cmd.ExchangeShopItemCmd.cmd:type_name -> Cmd.Command
	...
	21, // 29: Cmd.ResetExchangeShopDataShopCmd.cmd:type_name -> Cmd.Command
