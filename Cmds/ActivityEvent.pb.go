...
const (
	...
	EActivityEventType_EACTIVITYEVENTTYPE_FREE_TRANSFER         EActivityEventType = 1 // 免费地图传送
	EActivityEventType_EACTIVITYEVENTTYPE_SUMMON                EActivityEventType = 2 // 召唤
	EActivityEventType_EACTIVITYEVENTTYPE_REWARD                EActivityEventType = 3 // 额外/翻倍奖励
	EActivityEventType_EACTIVITYEVENTTYPE_RESETTIME             EActivityEventType = 4 // 修改重置次数
	EActivityEventType_EACTIVITYEVENTTYPE_LOTTERY_DISCOUNT      EActivityEventType = 5 // 扭蛋折扣
	EActivityEventType_EACTIVITYEVENTTYPE_LOTTERY_NPC           EActivityEventType = 6 // 扭蛋NPC开关
	EActivityEventType_EACTIVITYEVENTTYPE_LOTTERY_BANNER        EActivityEventType = 7 // 扭蛋BANNER
	EActivityEventType_EACTIVITYEVENTTYPE_GUILD_BUILDING_SUBMIT EActivityEventType = 8 // 公会建筑提交材料增益
	EActivityEventType_EACTIVITYEVENTTYPE_SHOP                  EActivityEventType = 9 // 商店商品调整
	EActivityEventType_EACTIVITYEVENTTYPE_MAX                   EActivityEventType = 10
)
...
type AEReward struct {
	...
	Minlayer    *uint32  `protobuf:"varint,4,opt,name=minlayer,def=0" json:"minlayer,omitempty"` // 最小无限塔层数
	Maxlayer    *uint32  `protobuf:"varint,5,opt,name=maxlayer,def=0" json:"maxlayer,omitempty"` // 最大无限塔层数
	Difficultys []uint32 `protobuf:"varint,6,rep,name=difficultys" json:"difficultys,omitempty"` // 卡牌副本难度
}
...
type AEFreeTransferInfo struct {
	...
	Mapids      []uint32 `protobuf:"varint,1,rep,name=mapids" json:"mapids,omitempty"`                 // 所有免费传送地图id
	Allfree     *bool    `protobuf:"varint,2,opt,name=allfree,def=0" json:"allfree,omitempty"`         // 全部免费则mapids为空
	Teammapids  []uint32 `protobuf:"varint,3,rep,name=teammapids" json:"teammapids,omitempty"`         // 组队传送,所有免费传送地图id
	Teamallfree *bool    `protobuf:"varint,4,opt,name=teamallfree,def=0" json:"teamallfree,omitempty"` // 组队传送,全部免费则teammapids为空
	Storefree   *bool    `protobuf:"varint,5,opt,name=storefree,def=0" json:"storefree,omitempty"`     // 仓库免费
}
...
type AESummonInfo struct {
	...
	Iscreate    *bool       `protobuf:"varint,4,opt,name=iscreate,def=0" json:"iscreate,omitempty"` // 是否是创建怪物, 为true时, 下面的参数有效
	...
	Type        *string     `protobuf:"bytes,8,opt,name=type" json:"type,omitempty"`                        // 暂无用
	Zone        *string     `protobuf:"bytes,9,opt,name=zone" json:"zone,omitempty"`                        // 区域, 暂无用
	Race        *string     `protobuf:"bytes,10,opt,name=race" json:"race,omitempty"`                       //  种族
	Nature      *string     `protobuf:"bytes,11,opt,name=nature" json:"nature,omitempty"`                   // 属性
	Shape       *string     `protobuf:"bytes,12,opt,name=shape" json:"shape,omitempty"`                     // 体型
	Body        *uint32     `protobuf:"varint,13,opt,name=body,def=0" json:"body,omitempty"`                // 身体
	Jobexp      *uint32     `protobuf:"varint,14,opt,name=jobexp,def=0" json:"jobexp,omitempty"`            // job经验
	Baseexp     *uint32     `protobuf:"varint,15,opt,name=baseexp,def=0" json:"baseexp,omitempty"`          // base经验
	Str         *float32    `protobuf:"fixed32,16,opt,name=str,def=0" json:"str,omitempty"`                 // 力量
	Dex         *float32    `protobuf:"fixed32,17,opt,name=dex,def=0" json:"dex,omitempty"`                 // 灵巧
	Inte        *float32    `protobuf:"fixed32,18,opt,name=inte,def=0" json:"inte,omitempty"`               // 智力
	Vit         *float32    `protobuf:"fixed32,19,opt,name=vit,def=0" json:"vit,omitempty"`                 // 体质
	Agi         *float32    `protobuf:"fixed32,20,opt,name=agi,def=0" json:"agi,omitempty"`                 // 敏捷
	Luk         *float32    `protobuf:"fixed32,21,opt,name=luk,def=0" json:"luk,omitempty"`                 // 幸运
	Atk         *float32    `protobuf:"fixed32,22,opt,name=atk,def=0" json:"atk,omitempty"`                 // 物理攻击
	Matk        *float32    `protobuf:"fixed32,23,opt,name=matk,def=0" json:"matk,omitempty"`               // 魔法攻击
	Def         *float32    `protobuf:"fixed32,24,opt,name=def,def=0" json:"def,omitempty"`                 // 物理防御
	Mdef        *float32    `protobuf:"fixed32,25,opt,name=mdef,def=0" json:"mdef,omitempty"`               // 魔法防御
	Hp          *float32    `protobuf:"fixed32,26,opt,name=hp,def=0" json:"hp,omitempty"`                   // 生命值
	Hit         *float32    `protobuf:"fixed32,27,opt,name=hit,def=0" json:"hit,omitempty"`                 // 命中
	Flee        *float32    `protobuf:"fixed32,28,opt,name=flee,def=0" json:"flee,omitempty"`               // 闪避
	Movespd     *float32    `protobuf:"fixed32,29,opt,name=movespd,def=0" json:"movespd,omitempty"`         // 移动速度
	Movespdrate *float32    `protobuf:"fixed32,30,opt,name=movespdrate,def=0" json:"movespdrate,omitempty"` // 移动倍率
	Scale       *float32    `protobuf:"fixed32,31,opt,name=scale,def=0" json:"scale,omitempty"`             // 缩放
	Normalskill *uint32     `protobuf:"varint,32,opt,name=normalskill,def=0" json:"normalskill,omitempty"`  // 普通技能
	Rewardid    *uint32     `protobuf:"varint,33,opt,name=rewardid,def=0" json:"rewardid,omitempty"`        // 奖励id
...
type AERewardExtraInfo struct {
	...
	Rewards     []*AEReward `protobuf:"bytes,1,rep,name=rewards" json:"rewards,omitempty"` // 奖励
...
type AERewardMultipleInfo struct {
	...
	Multiple    *uint32 `protobuf:"varint,1,opt,name=multiple,def=1" json:"multiple,omitempty"` // 倍率
	Finishcount *uint32 `protobuf:"varint,2,opt,name=finishcount,def=0" json:"finishcount,omitempty"`
	Daylimit    *uint32 `protobuf:"varint,3,opt,name=daylimit,def=0" json:"daylimit,omitempty"`
	Acclimit    *bool   `protobuf:"varint,4,opt,name=acclimit,def=0" json:"acclimit,omitempty"`
}
...
type AERewardInfo struct {
	...
	Extratimes     *uint32               `protobuf:"varint,4,opt,name=extratimes,def=0" json:"extratimes,omitempty"` // 新增次数
}
...
type AELotteryDiscount struct {
	...
	Lotterytype *ELotteryType `protobuf:"varint,1,opt,name=lotterytype,enum=Cmd.ELotteryType" json:"lotterytype,omitempty"` //扭蛋机类型
	Cointype    *ECoinType    `protobuf:"varint,2,opt,name=cointype,enum=Cmd.ECoinType" json:"cointype,omitempty"`          //折扣货币类型
	Usertype    *EUserType    `protobuf:"varint,3,opt,name=usertype,enum=Cmd.EUserType" json:"usertype,omitempty"`          //适用对象
	Discount    *uint32       `protobuf:"varint,4,opt,name=discount" json:"discount,omitempty"`                             //折扣，70表示7折
	Count       *uint32       `protobuf:"varint,5,opt,name=count" json:"count,omitempty"`                                   //
	Yearmonth   *uint32       `protobuf:"varint,7,opt,name=yearmonth" json:"yearmonth,omitempty"`                           //折扣年月，201701
}
...
type AELotteryBanner struct {
	...
	Lotterytype *ELotteryType `protobuf:"varint,1,opt,name=lotterytype,enum=Cmd.ELotteryType" json:"lotterytype,omitempty"` //扭蛋机类型
	Path        *string       `protobuf:"bytes,2,opt,name=path" json:"path,omitempty"`                                      //图片地址(非空时优先使用,否则取urls)
	Urls        []*AEUrl      `protobuf:"bytes,3,rep,name=urls" json:"urls,omitempty"`                                      //图片地址(按语言区分)
}
...
type AEGuildBuildingSubmitInfo struct {
	...
	Minlv     *uint32          `protobuf:"varint,2,opt,name=minlv,def=0" json:"minlv,omitempty"`         // 匹配最小建筑等级
	Maxlv     *uint32          `protobuf:"varint,3,opt,name=maxlv,def=0" json:"maxlv,omitempty"`         // 匹配最大建筑等级
	Submitinc *uint32          `protobuf:"varint,4,opt,name=submitinc,def=0" json:"submitinc,omitempty"` // 提交材料增幅, 例:10表示增加10%
	Rewardinc *uint32          `protobuf:"varint,5,opt,name=rewardinc,def=0" json:"rewardinc,omitempty"` // 提交后获得奖励增幅, 例:10表示增加10%
}
...
type AEResetInfo struct {
	...
	Mode  *EAERewardMode `protobuf:"varint,1,opt,name=mode,enum=Cmd.EAERewardMode,def=0" json:"mode,omitempty"`
	Times *uint32        `protobuf:"varint,2,opt,name=times,def=0" json:"times,omitempty"` // 重置次数
}
...
type AERewardItem struct {
	...
	Mode                   *EAERewardMode `protobuf:"varint,1,opt,name=mode,enum=Cmd.EAERewardMode,def=0" json:"mode,omitempty"`              // 玩法
	Daycount               *uint32        `protobuf:"varint,2,opt,name=daycount,def=0" json:"daycount,omitempty"`                             // 每日获得额外奖励次数
	Acclimitcharid         *uint64        `protobuf:"varint,3,opt,name=acclimitcharid,def=0" json:"acclimitcharid,omitempty"`                 // 额外奖励, 账号限制开启时, 限制的charid
	Multipledaycount       *uint32        `protobuf:"varint,4,opt,name=multipledaycount,def=0" json:"multipledaycount,omitempty"`             // 每日翻倍次数
	Multipleacclimitcharid *uint64        `protobuf:"varint,5,opt,name=multipleacclimitcharid,def=0" json:"multipleacclimitcharid,omitempty"` // 翻倍, 账号限制开启时, 限制的charid
}
...
var file_ActivityEvent_proto_rawDesc = []byte{
	...
	0x53, 0x68, 0x6f, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xb1, 0x01, 0x0a, 0x08, 0x41,
	...
	0x0d, 0x52, 0x0b, 0x64, 0x69, 0x66, 0x66, 0x69, 0x63, 0x75, 0x6c, 0x74, 0x79, 0x73, 0x22, 0x35,
	0x0a, 0x08, 0x41, 0x45, 0x4d, 0x61, 0x70, 0x50, 0x6f, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x70, 0x6f,
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x02, 0x52, 0x03, 0x70, 0x6f, 0x73, 0x12, 0x17, 0x0a, 0x05,
	0x72, 0x61, 0x6e, 0x67, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x3a, 0x01, 0x30, 0x52, 0x05,
	0x72, 0x61, 0x6e, 0x67, 0x65, 0x22, 0x53, 0x0a, 0x05, 0x41, 0x45, 0x4d, 0x61, 0x70, 0x12, 0x11,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_ActivityEvent_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_ActivityEvent_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_ActivityEvent_proto_goTypes = []interface{}{
	(ActivityEventParam)(0),             // 0: Cmd.ActivityEventParam
	(EAERewardMode)(0),                  // 1: Cmd.EAERewardMode
	(ECoinType)(0),                      // 2: Cmd.ECoinType
	(EUserType)(0),                      // 3: Cmd.EUserType
	(EActivityEventType)(0),             // 4: Cmd.EActivityEventType
	(*AEReward)(nil),                    // 5: Cmd.AEReward
	(*AEMapPos)(nil),                    // 6: Cmd.AEMapPos
	(*AEMap)(nil),                       // 7: Cmd.AEMap
	(*AEFreeTransferInfo)(nil),          // 8: Cmd.AEFreeTransferInfo
	(*AESummonInfo)(nil),                // 9: Cmd.AESummonInfo
	(*AERewardExtraInfo)(nil),           // 10: Cmd.AERewardExtraInfo
	(*AERewardMultipleInfo)(nil),        // 11: Cmd.AERewardMultipleInfo
	(*AERewardInfo)(nil),                // 12: Cmd.AERewardInfo
	(*AELotteryDiscount)(nil),           // 13: Cmd.AELotteryDiscount
	(*AELotteryNpc)(nil),                // 14: Cmd.AELotteryNpc
	(*AEUrl)(nil),                       // 15: Cmd.AEUrl
	(*AELotteryBanner)(nil),             // 16: Cmd.AELotteryBanner
	(*AEGuildBuildingSubmitInfo)(nil),   // 17: Cmd.AEGuildBuildingSubmitInfo
	(*AEShopInfo)(nil),                  // 18: Cmd.AEShopInfo
	(*ActivityEventInfo)(nil),           // 19: Cmd.ActivityEventInfo
	(*AEResetInfo)(nil),                 // 20: Cmd.AEResetInfo
	(*AERewardItem)(nil),                // 21: Cmd.AERewardItem
	(*ActivityEvent)(nil),               // 22: Cmd.ActivityEvent
	(*ActivityEventNtf)(nil),            // 23: Cmd.ActivityEventNtf
	(*ActivityEventUserDataNtf)(nil),    // 24: Cmd.ActivityEventUserDataNtf
	(*ActivityEventCnt)(nil),            // 25: Cmd.ActivityEventCnt
	(*ActivityEventNtfEventCntCmd)(nil), // 26: Cmd.ActivityEventNtfEventCntCmd
	(ELotteryType)(0),                   // 27: Cmd.ELotteryType
	(EGuildBuilding)(0),                 // 28: Cmd.EGuildBuilding
	(*ShopItem)(nil),                    // 29: Cmd.ShopItem
	(Command)(0),                        // 30: Cmd.Command
}
var file_ActivityEvent_proto_depIdxs = []int32{
	6,  // 0: Cmd.AEMap.coord:type_name -> Cmd.AEMapPos
	5,  // 1: Cmd.AESummonInfo.rewards:type_name -> Cmd.AEReward
	7,  // 2: Cmd.AESummonInfo.map:type_name -> Cmd.AEMap
	5,  // 3: Cmd.AERewardExtraInfo.rewards:type_name -> Cmd.AEReward
	1,  // 4: Cmd.AERewardInfo.mode:type_name -> Cmd.EAERewardMode
	10, // 5: Cmd.AERewardInfo.extrareward:type_name -> Cmd.AERewardExtraInfo
	11, // 6: Cmd.AERewardInfo.multiplereward:type_name -> Cmd.AERewardMultipleInfo
	27, // 7: Cmd.AELotteryDiscount.lotterytype:type_name -> Cmd.ELotteryType
	2,  // 8: Cmd.AELotteryDiscount.cointype:type_name -> Cmd.ECoinType
	3,  // 9: Cmd.AELotteryDiscount.usertype:type_name -> Cmd.EUserType
	27, // 10: Cmd.AELotteryNpc.lotterytype:type_name -> Cmd.ELotteryType
	7,  // 11: Cmd.AELotteryNpc.map:type_name -> Cmd.AEMap
	27, // 12: Cmd.AELotteryBanner.lotterytype:type_name -> Cmd.ELotteryType
	15, // 13: Cmd.AELotteryBanner.urls:type_name -> Cmd.AEUrl
	28, // 14: Cmd.AEGuildBuildingSubmitInfo.types:type_name -> Cmd.EGuildBuilding
	29, // 15: Cmd.AEShopInfo.items:type_name -> Cmd.ShopItem
	4,  // 16: Cmd.ActivityEventInfo.type:type_name -> Cmd.EActivityEventType
	8,  // 17: Cmd.ActivityEventInfo.freetransferinfo:type_name -> Cmd.AEFreeTransferInfo
	9,  // 18: Cmd.ActivityEventInfo.summoninfo:type_name -> Cmd.AESummonInfo
	12, // 19: Cmd.ActivityEventInfo.rewardinfo:type_name -> Cmd.AERewardInfo
	20, // 20: Cmd.ActivityEventInfo.resetinfo:type_name -> Cmd.AEResetInfo
	13, // 21: Cmd.ActivityEventInfo.lotterydiscount:type_name -> Cmd.AELotteryDiscount
	14, // 22: Cmd.ActivityEventInfo.lotterynpc:type_name -> Cmd.AELotteryNpc
	16, // 23: Cmd.ActivityEventInfo.lotterybanner:type_name -> Cmd.AELotteryBanner
	17, // 24: Cmd.ActivityEventInfo.gbuildingsubmitinfo:type_name -> Cmd.AEGuildBuildingSubmitInfo
	18, // 25: Cmd.ActivityEventInfo.shopinfo:type_name -> Cmd.AEShopInfo
	1,  // 26: Cmd.AEResetInfo.mode:type_name -> Cmd.EAERewardMode
	1,  // 27: Cmd.AERewardItem.mode:type_name -> Cmd.EAERewardMode
	4,  // 28: Cmd.ActivityEvent.type:type_name -> Cmd.EActivityEventType
	8,  // 29: Cmd.ActivityEvent.freetransfer:type_name -> Cmd.AEFreeTransferInfo
	12, // 30: Cmd.ActivityEvent.reward:type_name -> Cmd.AERewardInfo
	20, // 31: Cmd.ActivityEvent.resetinfo:type_name -> Cmd.AEResetInfo
	13, // 32: Cmd.ActivityEvent.lotterydiscount:type_name -> Cmd.AELotteryDiscount
	16, // 33: Cmd.ActivityEvent.lotterybanner:type_name -> Cmd.AELotteryBanner
	17, // 34: Cmd.ActivityEvent.gbuildingsubmit:type_name -> Cmd.AEGuildBuildingSubmitInfo
	30, // 35: Cmd.ActivityEventNtf.cmd:type_name -> Cmd.Command
	0,  // 36: Cmd.ActivityEventNtf.param:type_name -> Cmd.ActivityEventParam
	22, // 37: Cmd.ActivityEventNtf.events:type_name -> Cmd.ActivityEvent
	30, // 38: Cmd.ActivityEventUserDataNtf.cmd:type_name -> Cmd.Command
	0,  // 39: Cmd.ActivityEventUserDataNtf.param:type_name -> Cmd.ActivityEventParam
	21, // 40: Cmd.ActivityEventUserDataNtf.rewarditems:type_name -> Cmd.AERewardItem
	4,  // 41: Cmd.ActivityEventCnt.type:type_name -> Cmd.EActivityEventType
	30, // 42: Cmd.ActivityEventNtfEventCntCmd.cmd:type_name -> Cmd.Command
	0,  // 43: Cmd.ActivityEventNtfEventCntCmd.param:type_name -> Cmd.ActivityEventParam
	25, // 44: Cmd.ActivityEventNtfEventCntCmd.cnt:type_name -> Cmd.ActivityEventCnt
