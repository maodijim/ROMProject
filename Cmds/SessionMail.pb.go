...
const (
	...
	MailParam_MAILPARAM_READ         MailParam = 4
	MailParam_MAILPARAM_REMOVE       MailParam = 5
)
...
const (
	...
	EMailType_EMAILTYPE_AUTO_GETATTACH    EMailType = 9
	EMailType_EMAILTYPE_HINT              EMailType = 10
...
const (
	...
	EMailAttachType_EAMILATTACHTYPE_MSG_PARAMS   EMailAttachType = 6
	EMailAttachType_EMAILATTACHTYPE_LIMIT        EMailAttachType = 7
	EMailAttachType_EAMILATTACHTYPE_MAX          EMailAttachType = 8
)
...
var (
	EMailAttachType_name = map[int32]string{
		...
		6: "EAMILATTACHTYPE_MSG_PARAMS",
		7: "EMAILATTACHTYPE_LIMIT",
		8: "EAMILATTACHTYPE_MAX",
	}
...
type MailMsgParam struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Mailid *uint32  `protobuf:"varint,1,opt,name=mailid" json:"mailid,omitempty"`
	Params []string `protobuf:"bytes,2,rep,name=params" json:"params,omitempty"`
}

func (x *MailMsgParam) Reset() {
	*x = MailMsgParam{}
...
func (x *MailMsgParam) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MailMsgParam) ProtoMessage() {}

func (x *MailMsgParam) ProtoReflect() protoreflect.Message {
	mi := &file_SessionMail_proto_msgTypes[0]
...
// Deprecated: Use MailMsgParam.ProtoReflect.Descriptor instead.
func (*MailMsgParam) Descriptor() ([]byte, []int) {
	return file_SessionMail_proto_rawDescGZIP(), []int{0}
}

func (x *MailMsgParam) GetMailid() uint32 {
...
func (x *MailMsgParam) GetParams() []string {
	if x != nil {
		return x.Params
	}
	return nil
...
type MailAttach struct {
	...
	Msgdatas    *MailMsgParam    `protobuf:"bytes,5,opt,name=msgdatas" json:"msgdatas,omitempty"`
	Mailid      *uint32          `protobuf:"varint,6,opt,name=mailid,def=0" json:"mailid,omitempty"`
	Whitelistid *uint64          `protobuf:"varint,7,opt,name=whitelistid,def=0" json:"whitelistid,omitempty"`
}
...
const (
	...
	Default_MailAttach_Mailid      = uint32(0)
	Default_MailAttach_Whitelistid = uint64(0)
)
...
func (x *MailAttach) GetMsgdatas() *MailMsgParam {
	if x != nil {
		return x.Msgdatas
	}
	return nil
...
func (x *MailAttach) GetMailid() uint32 {
	if x != nil && x.Mailid != nil {
		return *x.Mailid
	}
...
func (x *MailAttach) GetWhitelistid() uint64 {
	if x != nil && x.Whitelistid != nil {
		return *x.Whitelistid
	}
	return Default_MailAttach_Whitelistid
}
...
type MailData struct {
	...
	Sendtime     *uint32              `protobuf:"varint,21,opt,name=sendtime,def=0" json:"sendtime,omitempty"`
	Expiretime   *uint32              `protobuf:"varint,22,opt,name=expiretime,def=0" json:"expiretime,omitempty"`
	Serverids    *string              `protobuf:"bytes,23,opt,name=serverids" json:"serverids,omitempty"`
	Attachtime   *uint32              `protobuf:"varint,24,opt,name=attachtime,def=0" json:"attachtime,omitempty"`
	CupMode      *uint32              `protobuf:"varint,25,opt,name=cup_mode,json=cupMode" json:"cup_mode,omitempty"`
	CupRank      *uint32              `protobuf:"varint,26,opt,name=cup_rank,json=cupRank" json:"cup_rank,omitempty"`
}
...
const (
	...
	Default_MailData_Sendtime     = uint32(0)
	Default_MailData_Expiretime   = uint32(0)
	Default_MailData_Attachtime   = uint32(0)
)
...
func (x *MailData) GetSendtime() uint32 {
	...
	return Default_MailData_Sendtime
}
...
func (x *MailData) GetExpiretime() uint32 {
	...
	return Default_MailData_Expiretime
}

func (x *MailData) GetServerids() string {
	if x != nil && x.Serverids != nil {
		return *x.Serverids
	}
	return ""
}

func (x *MailData) GetAttachtime() uint32 {
	if x != nil && x.Attachtime != nil {
		return *x.Attachtime
	}
	return Default_MailData_Attachtime
}

func (x *MailData) GetCupMode() uint32 {
	if x != nil && x.CupMode != nil {
		return *x.CupMode
	}
	return 0
}

func (x *MailData) GetCupRank() uint32 {
	if x != nil && x.CupRank != nil {
		return *x.CupRank
	}
	return 0
}
...
func (x *GetMailAttach) Reset() {
	*x = GetMailAttach{}
	if protoimpl.UnsafeEnabled {
		mi := &file_SessionMail_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetMailAttach) Descriptor() ([]byte, []int) {
	return file_SessionMail_proto_rawDescGZIP(), []int{8}
}
...
func (x *GetMailAttach) GetIds() []uint64 {
	if x != nil {
		return x.Ids
	}
	return nil
...
type MailRead struct {
	...
	Cmd   *Command   `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=55" json:"cmd,omitempty"`
	Param *MailParam `protobuf:"varint,2,opt,name=param,enum=Cmd.MailParam,def=4" json:"param,omitempty"`
	Id    *uint64    `protobuf:"varint,3,opt,name=id" json:"id,omitempty"`
}

// Default values for MailRead fields.
const (
	Default_MailRead_Cmd   = Command_SESSION_USER_MAIL_PROTOCMD
	Default_MailRead_Param = MailParam_MAILPARAM_READ
)

func (x *MailRead) Reset() {
	*x = MailRead{}
	if protoimpl.UnsafeEnabled {
		mi := &file_SessionMail_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *MailRead) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MailRead) ProtoMessage() {}

func (x *MailRead) ProtoReflect() protoreflect.Message {
	mi := &file_SessionMail_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MailRead.ProtoReflect.Descriptor instead.
func (*MailRead) Descriptor() ([]byte, []int) {
	return file_SessionMail_proto_rawDescGZIP(), []int{9}
}

func (x *MailRead) GetCmd() Command {
	if x != nil && x.Cmd != nil {
		return *x.Cmd
	}
	return Default_MailRead_Cmd
}

func (x *MailRead) GetParam() MailParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
	return Default_MailRead_Param
}

func (x *MailRead) GetId() uint64 {
	if x != nil && x.Id != nil {
		return *x.Id
	}
	return 0
...
type MailRemove struct {
	...
	Cmd   *Command   `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=55" json:"cmd,omitempty"`
	Param *MailParam `protobuf:"varint,2,opt,name=param,enum=Cmd.MailParam,def=5" json:"param,omitempty"`
	Ids   []uint64   `protobuf:"varint,3,rep,name=ids" json:"ids,omitempty"`
}

// Default values for MailRemove fields.
const (
	Default_MailRemove_Cmd   = Command_SESSION_USER_MAIL_PROTOCMD
	Default_MailRemove_Param = MailParam_MAILPARAM_REMOVE
)

func (x *MailRemove) Reset() {
	*x = MailRemove{}
	if protoimpl.UnsafeEnabled {
		mi := &file_SessionMail_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MailRemove) Descriptor() ([]byte, []int) {
	return file_SessionMail_proto_rawDescGZIP(), []int{10}
}

func (x *MailRemove) GetCmd() Command {
	if x != nil && x.Cmd != nil {
		return *x.Cmd
	}
	return Default_MailRemove_Cmd
}

func (x *MailRemove) GetParam() MailParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
	return Default_MailRemove_Param
}

func (x *MailRemove) GetIds() []uint64 {
	if x != nil {
		return x.Ids
	}
	return nil
...
var file_SessionMail_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3e, 0x0a, 0x0c, 0x4d, 0x61, 0x69,
	0x6c, 0x4d, 0x73, 0x67, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x61, 0x69,
	0x6c, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x6d, 0x61, 0x69, 0x6c, 0x69,
	0x64, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x22, 0x9f, 0x02, 0x0a, 0x0a, 0x4d, 0x61,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x74, 0x6c, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x34, 0x0a, 0x10, 0x4d, 0x61, 0x69, 0x6c, 0x54,
	0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x20, 0x0a, 0x04, 0x6d,
	0x73, 0x67, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x43, 0x6d, 0x64, 0x2e,
	0x4d, 0x61, 0x69, 0x6c, 0x4d, 0x73, 0x67, 0x52, 0x04, 0x6d, 0x73, 0x67, 0x73, 0x22, 0xad, 0x01,
	0x0a, 0x0c, 0x51, 0x75, 0x65, 0x72, 0x79, 0x41, 0x6c, 0x6c, 0x4d, 0x61, 0x69, 0x6c, 0x12, 0x3a,
	...
	0x4f, 0x4e, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x4d, 0x41, 0x49, 0x4c, 0x5f, 0x50, 0x52, 0x4f,
	...
	0x4d, 0x61, 0x69, 0x6c, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a, 0x16, 0x4d, 0x41, 0x49, 0x4c, 0x50,
	0x41, 0x52, 0x41, 0x4d, 0x5f, 0x51, 0x55, 0x45, 0x52, 0x59, 0x41, 0x4c, 0x4c, 0x4d, 0x41, 0x49,
	0x4c, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x23, 0x0a, 0x05, 0x64, 0x61, 0x74, 0x61,
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x4d, 0x61,
	0x69, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x52, 0x05, 0x64, 0x61, 0x74, 0x61, 0x73, 0x22, 0xbd, 0x01,
	0x0a, 0x0a, 0x4d, 0x61, 0x69, 0x6c, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x3a, 0x0a, 0x03,
	...
	0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x4d, 0x41, 0x49, 0x4c, 0x5f, 0x50, 0x52, 0x4f, 0x54, 0x4f,
	0x43, 0x4d, 0x44, 0x52, 0x03, 0x63, 0x6d, 0x64, 0x12, 0x36, 0x0a, 0x05, 0x70, 0x61, 0x72, 0x61,
	0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x4d, 0x61,
	0x69, 0x6c, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a, 0x10, 0x4d, 0x41, 0x49, 0x4c, 0x50, 0x41, 0x52,
	0x41, 0x4d, 0x5f, 0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d,
	0x12, 0x27, 0x0a, 0x07, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28,
	...
	0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x04, 0x52, 0x04, 0x64, 0x65, 0x6c, 0x73, 0x22, 0x98, 0x01,
	0x0a, 0x0d, 0x47, 0x65, 0x74, 0x4d, 0x61, 0x69, 0x6c, 0x41, 0x74, 0x74, 0x61, 0x63, 0x68, 0x12,
	...
	,
	...
	,
}
...
var file_SessionMail_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_SessionMail_proto_goTypes = []interface{}{
	...
	(*MailMsgParam)(nil),        // 4: Cmd.MailMsgParam
	(*MailAttach)(nil),          // 5: Cmd.MailAttach
	(*BlobAttach)(nil),          // 6: Cmd.BlobAttach
	(*MailData)(nil),            // 7: Cmd.MailData
	(*MailMsg)(nil),             // 8: Cmd.MailMsg
	(*MailTemplateData)(nil),    // 9: Cmd.MailTemplateData
	(*QueryAllMail)(nil),        // 10: Cmd.QueryAllMail
	(*MailUpdate)(nil),          // 11: Cmd.MailUpdate
	(*GetMailAttach)(nil),       // 12: Cmd.GetMailAttach
	(*MailRead)(nil),            // 13: Cmd.MailRead
	(*MailRemove)(nil),          // 14: Cmd.MailRemove
	(*ItemInfo)(nil),            // 15: Cmd.ItemInfo
	(*ItemData)(nil),            // 16: Cmd.ItemData
	(*WeddingEventMsgCCmd)(nil), // 17: Cmd.WeddingEventMsgCCmd
	(*UserEventMailCmd)(nil),    // 18: Cmd.UserEventMailCmd
	(Command)(0),                // 19: Cmd.Command
}
var file_SessionMail_proto_depIdxs = []int32{
	3,  // 0: Cmd.MailAttach.type:type_name -> Cmd.EMailAttachType
	15, // 1: Cmd.MailAttach.items:type_name -> Cmd.ItemInfo
	16, // 2: Cmd.MailAttach.itemdatas:type_name -> Cmd.ItemData
	4,  // 3: Cmd.MailAttach.msgdatas:type_name -> Cmd.MailMsgParam
	5,  // 4: Cmd.BlobAttach.attachs:type_name -> Cmd.MailAttach
	2,  // 5: Cmd.MailData.type:type_name -> Cmd.EMailType
	1,  // 6: Cmd.MailData.status:type_name -> Cmd.EMailStatus
	6,  // 7: Cmd.MailData.attach:type_name -> Cmd.BlobAttach
	17, // 8: Cmd.MailData.weddingmsg:type_name -> Cmd.WeddingEventMsgCCmd
	18, // 9: Cmd.MailData.eventmsg:type_name -> Cmd.UserEventMailCmd
	8,  // 10: Cmd.MailTemplateData.msgs:type_name -> Cmd.MailMsg
	19, // 11: Cmd.QueryAllMail.cmd:type_name -> Cmd.Command
	0,  // 12: Cmd.QueryAllMail.param:type_name -> Cmd.MailParam
	7,  // 13: Cmd.QueryAllMail.datas:type_name -> Cmd.MailData
	19, // 14: Cmd.MailUpdate.cmd:type_name -> Cmd.Command
	0,  // 15: Cmd.MailUpdate.param:type_name -> Cmd.MailParam
	7,  // 16: Cmd.MailUpdate.updates:type_name -> Cmd.MailData
	19, // 17: Cmd.GetMailAttach.cmd:type_name -> Cmd.Command
	0,  // 18: Cmd.GetMailAttach.param:type_name -> Cmd.MailParam
	19, // 19: Cmd.MailRead.cmd:type_name -> Cmd.Command
	0,  // 20: Cmd.MailRead.param:type_name -> Cmd.MailParam
	19, // 21: Cmd.MailRemove.cmd:type_name -> Cmd.Command
	0,  // 22: Cmd.MailRemove.param:type_name -> Cmd.MailParam
...
func file_SessionMail_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_SessionMail_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_SessionMail_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MailRead); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_SessionMail_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
