...
const (
	...
	GuildParam_GUILDPARAM_APPLYCONFIG           GuildParam = 35
...
const (
	...
	EGuildBuilding_EGUILDBUILDING_VENDING_MACHINE EGuildBuilding = 1 // 自动贩卖机
	EGuildBuilding_EGUILDBUILDING_BAR             EGuildBuilding = 2 // 吧台猫老板
	EGuildBuilding_EGUILDBUILDING_CAT_LITTER_BOX  EGuildBuilding = 3 // 福利猫砂盆
	EGuildBuilding_EGUILDBUILDING_MAGIC_SEWING    EGuildBuilding = 4 // 魔法缝纫机
	EGuildBuilding_EGUILDBUILDING_HIGH_REFINE     EGuildBuilding = 5 // 极限精炼铁砧
	EGuildBuilding_EGUILDBUILDING_ARTIFACT_HEAD   EGuildBuilding = 6 // 头饰工坊
	EGuildBuilding_EGUILDBUILDING_CAT_PILLOW      EGuildBuilding = 7 // 猫咪睡眠枕
	EGuildBuilding_EGUILDBUILDING_MAX             EGuildBuilding = 8
)
...
const (
	...
	EGuildData_EGUILDDATA_MAX                  EGuildData = 51
)
...
const (
	...
	EGuildMemberData_EGUILDMEMBERDATA_MAX               EGuildMemberData = 30
)
...
const (
	...
	EArtifactOptType_EARTIFACTOPTTYPE_DISTRIBUTE      EArtifactOptType = 1 // 分配
	EArtifactOptType_EARTIFACTOPTTYPE_RETRIEVE        EArtifactOptType = 2 // 收回
	EArtifactOptType_EARTIFACTOPTTYPE_RETRIEVE_CANCEL EArtifactOptType = 3 // 消息收回
	EArtifactOptType_EARTIFACTOPTTYPE_GIVEBACK        EArtifactOptType = 4 // 归还
...
type GuildMemberPray struct {
	...
	Next *GuildPrayCFG `protobuf:"bytes,4,opt,name=next" json:"next,omitempty"`
}
...
type UserGuildBuilding struct {
	...
	Submitcounttotal *uint32         `protobuf:"varint,5,opt,name=submitcounttotal,def=0" json:"submitcounttotal,omitempty"` // 当前建筑等级下的总贡献值
	Submittime       *uint32         `protobuf:"varint,6,opt,name=submittime,def=0" json:"submittime,omitempty"`             // 最近一次提交材料时间
}
...
type GuildBuilding struct {
	...
	Materials       []*GuildBuildMaterial `protobuf:"bytes,3,rep,name=materials" json:"materials,omitempty"`                    // 已消耗材料
	Isbuilding      *bool                 `protobuf:"varint,4,opt,name=isbuilding,def=0" json:"isbuilding,omitempty"`           // 是否正在建造中
	Nextwelfaretime *uint32               `protobuf:"varint,5,opt,name=nextwelfaretime,def=0" json:"nextwelfaretime,omitempty"` // 下一次福利发奖时间
	Nextbuildtime   *uint32               `protobuf:"varint,8,opt,name=nextbuildtime,def=0" json:"nextbuildtime,omitempty"`     // 下一次建造/升级时间
	// 前端用:
	Progress      *uint32               `protobuf:"varint,6,opt,name=progress,def=0" json:"progress,omitempty"`    // 建造进度
	Restmaterials []*GuildBuildMaterial `protobuf:"bytes,7,rep,name=restmaterials" json:"restmaterials,omitempty"` // 剩余可提交材料
}
...
type GuildChallenge struct {
	...
	Id          *uint32 `protobuf:"varint,1,opt,name=id,def=0" json:"id,omitempty"`             // 任务id
	Progress    *uint32 `protobuf:"varint,2,opt,name=progress,def=0" json:"progress,omitempty"` // 任务进度
	Reward      *bool   `protobuf:"varint,3,opt,name=reward,def=0" json:"reward,omitempty"`
	Extrareward *bool   `protobuf:"varint,4,opt,name=extrareward,def=0" json:"extrareward,omitempty"` // 是否有额外奖励
}
...
type GuildWelfareItem struct {
	...
	Charids     []uint64       `protobuf:"varint,7,rep,name=charids" json:"charids,omitempty"` // 已领奖的玩家id
...
type GuildArtifactItem struct {
	...
	Distributecount *uint32 `protobuf:"varint,3,opt,name=distributecount,def=0" json:"distributecount,omitempty"` // 分配次数
	Retrievetime    *uint32 `protobuf:"varint,4,opt,name=retrievetime,def=0" json:"retrievetime,omitempty"`       // 取回cd结束时间
	Ownerid         *uint64 `protobuf:"varint,5,opt,name=ownerid,def=0" json:"ownerid,omitempty"`                 // 当前持有者
}
...
type GuildArtifactData struct {
	...
	Producecount *uint32 `protobuf:"varint,2,opt,name=producecount,def=0" json:"producecount,omitempty"` // 打造次数
	Maxlevel     *uint32 `protobuf:"varint,3,opt,name=maxlevel,def=0" json:"maxlevel,omitempty"`         // 打造到的最大等级
}
...
const (
	...
	Default_PrayGuildCmd_Npcid = uint64(0)
...
func (x *PrayGuildCmd) GetNpcid() uint64 {
	if x != nil && x.Npcid != nil {
		return *x.Npcid
	}
	return Default_PrayGuildCmd_Npcid
}
...
// Default values for GuildReward fields.
const (
	Default_GuildReward_Id  = uint32(0)
	Default_GuildReward_Num = uint32(0)
)

func (x *GuildReward) Reset() {
	*x = GuildReward{}
	if protoimpl.UnsafeEnabled {
...
func (x *GuildReward) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GuildReward) ProtoMessage() {}

func (x *GuildReward) ProtoReflect() protoreflect.Message {
	mi := &file_GuildCmd_proto_msgTypes[75]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GuildReward.ProtoReflect.Descriptor instead.
func (*GuildReward) Descriptor() ([]byte, []int) {
	return file_GuildCmd_proto_rawDescGZIP(), []int{75}
}

func (x *GuildReward) GetId() uint32 {
	if x != nil && x.Id != nil {
		return *x.Id
	}
	return Default_GuildReward_Id
}

func (x *GuildReward) GetNum() uint32 {
	if x != nil && x.Num != nil {
		return *x.Num
	}
	return Default_GuildReward_Num
}

// client -> session
type ApplyRewardConGuildCmd struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cmd      *Command       `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=50" json:"cmd,omitempty"`
	Param    *GuildParam    `protobuf:"varint,2,opt,name=param,enum=Cmd.GuildParam,def=35" json:"param,omitempty"`
	Configid *uint32        `protobuf:"varint,3,opt,name=configid,def=0" json:"configid,omitempty"`
	Con      []*GuildReward `protobuf:"bytes,4,rep,name=con" json:"con,omitempty"`
	Asset    []*GuildReward `protobuf:"bytes,5,rep,name=asset" json:"asset,omitempty"`
}

// Default values for ApplyRewardConGuildCmd fields.
const (
	Default_ApplyRewardConGuildCmd_Cmd      = Command_SESSION_USER_GUILD_PROTOCMD
	Default_ApplyRewardConGuildCmd_Param    = GuildParam_GUILDPARAM_APPLYCONFIG
	Default_ApplyRewardConGuildCmd_Configid = uint32(0)
)

func (x *ApplyRewardConGuildCmd) Reset() {
	*x = ApplyRewardConGuildCmd{}
	if protoimpl.UnsafeEnabled {
...
func (x *ApplyRewardConGuildCmd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ApplyRewardConGuildCmd) ProtoMessage() {}

func (x *ApplyRewardConGuildCmd) ProtoReflect() protoreflect.Message {
	mi := &file_GuildCmd_proto_msgTypes[76]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ApplyRewardConGuildCmd.ProtoReflect.Descriptor instead.
func (*ApplyRewardConGuildCmd) Descriptor() ([]byte, []int) {
	return file_GuildCmd_proto_rawDescGZIP(), []int{76}
}

func (x *ApplyRewardConGuildCmd) GetCmd() Command {
	if x != nil && x.Cmd != nil {
		return *x.Cmd
	}
	return Default_ApplyRewardConGuildCmd_Cmd
}

func (x *ApplyRewardConGuildCmd) GetParam() GuildParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
	return Default_ApplyRewardConGuildCmd_Param
}

func (x *ApplyRewardConGuildCmd) GetConfigid() uint32 {
	if x != nil && x.Configid != nil {
		return *x.Configid
	}
	return Default_ApplyRewardConGuildCmd_Configid
}

func (x *ApplyRewardConGuildCmd) GetCon() []*GuildReward {
	if x != nil {
		return x.Con
	}
	return nil
...
func (x *ApplyRewardConGuildCmd) GetAsset() []*GuildReward {
	if x != nil {
		return x.Asset
	}
	return nil
...
type SubmitMaterialGuildCmd struct {
	...
	Building   *EGuildBuilding `protobuf:"varint,3,opt,name=building,enum=Cmd.EGuildBuilding,def=0" json:"building,omitempty"`
	Materialid *uint32         `protobuf:"varint,4,opt,name=materialid,def=0" json:"materialid,omitempty"` // repeated GuildBuildMaterial materials = 4; // 材料
}
...
type ArtifactProduceGuildCmd struct {
	...
	Id    *uint32     `protobuf:"varint,3,opt,name=id,def=0" json:"id,omitempty"` // 神器id
}
...
type OpenRealtimeVoiceGuildCmd struct {
	...
	Charid *uint64     `protobuf:"varint,3,opt,name=charid,def=0" json:"charid,omitempty"`
	Open   *bool       `protobuf:"varint,4,opt,name=open,def=0" json:"open,omitempty"` // true:开启,false关闭
}
...
var file_GuildCmd_proto_rawDesc = []byte{
	...
	0x72, 0x12, 0x25, 0x0a, 0x04, 0x6e, 0x65, 0x78, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x69, 0x6e, 0x67, 0x73, 0x22, 0xb0, 0x0a, 0x0a, 0x0b, 0x47, 0x75, 0x69, 0x6c, 0x64, 0x4d, 0x65,
	...
	,
	...
	,
	...
	0x64, 0x65, 0x72, 0x12, 0x41, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x66, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x10, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x45, 0x50,
	...
	,
	...
	0x04, 0x74, 0x69, 0x6d, 0x65, 0x22, 0x9b, 0x01, 0x0a, 0x12, 0x47, 0x75, 0x69, 0x6c, 0x64, 0x42,
	0x75, 0x69, 0x6c, 0x64, 0x4d, 0x61, 0x74, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x12, 0x11, 0x0a, 0x02,
	...
	,
	...
	0x42, 0x55, 0x49, 0x4c, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x4d, 0x49, 0x4e, 0x52, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x12, 0x17, 0x0a, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0d, 0x3a, 0x01, 0x30, 0x52, 0x05, 0x6c, 0x65, 0x76, 0x65, 0x6c, 0x12, 0x35, 0x0a, 0x09, 0x6d,
	0x61, 0x74, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17,
	...
	,
	...
	,
	...
	,
	...
	0x4e, 0x52, 0x06, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x22, 0x50, 0x0a, 0x0a, 0x50, 0x68, 0x6f,
	0x74, 0x6f, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x07, 0x66, 0x72, 0x61, 0x6d, 0x65,
	...
	,
	...
	,
	...
	0x2e, 0x47, 0x75, 0x69, 0x6c, 0x64, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a, 0x16, 0x47, 0x55, 0x49,
	0x4c, 0x44, 0x50, 0x41, 0x52, 0x41, 0x4d, 0x5f, 0x43, 0x52, 0x45, 0x41, 0x54, 0x45, 0x47, 0x55,
	0x49, 0x4c, 0x44, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0
 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x4c, 0x56,
	0x55, 0x50, 0x5f, 0x45, 0x46, 0x46, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x31, 0x0a,
	0x07, 0x65, 0x66, 0x66, 0x65, 0x63, 0x74, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x17,
	0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x69, 0x6e, 0x67, 0x4c, 0x76, 0x75,
	0x70, 0x45, 0x66, 0x66, 0x65, 0x63, 0x74, 0x52, 0x07, 0x65, 0x66, 0x66, 0x65, 0x63, 0x74, 0x73,
	0x22, 0xaf, 0x02, 0x0a, 0x19, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x55, 0x70, 0x64,
	...
	0x5f, 0x55, 0x50, 0x44, 0x41, 0x54, 0x45, 0x5f, 0x4e, 0x54, 0x46, 0x52, 0x05, 0x70, 0x61, 0x72,
	0x61, 0x6d, 0x12, 0x38, 0x0a, 0x0b, 0x69, 0x74, 0x65, 0x6d, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x47, 0x75,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_GuildCmd_proto_enumTypes = make([]protoimpl.EnumInfo, 22)
var file_GuildCmd_proto_msgTypes = make([]protoimpl.MessageInfo, 111)
var file_GuildCmd_proto_goTypes = []interface{}{
	...
	(EModify)(0),                          // 13: Cmd.EModify
	(EGuildCityStatus)(0),                 // 14: Cmd.EGuildCityStatus
	(ECityAction)(0),                      // 15: Cmd.ECityAction
	(EIconState)(0),                       // 16: Cmd.EIconState
	(EArtifactOptType)(0),                 // 17: Cmd.EArtifactOptType
	(EGuildTreasureType)(0),               // 18: Cmd.EGuildTreasureType
	(ETreasureAction)(0),                  // 19: Cmd.ETreasureAction
	(ETreasurePoint)(0),                   // 20: Cmd.ETreasurePoint
	(EGCityState)(0),                      // 21: Cmd.EGCityState
	(*GuildPrayCFG)(nil),                  // 22: Cmd.GuildPrayCFG
	(*GuildMemberPray)(nil),               // 23: Cmd.GuildMemberPray
	(*BlobGuildPray)(nil),                 // 24: Cmd.BlobGuildPray
	(*BlobDonate)(nil),                    // 25: Cmd.BlobDonate
	(*UserGuildBuilding)(nil),             // 26: Cmd.UserGuildBuilding
	(*BlobGuildBuilding)(nil),             // 27: Cmd.BlobGuildBuilding
	(*GuildMember)(nil),                   // 28: Cmd.GuildMember
	(*BlobGuildMember)(nil),               // 29: Cmd.BlobGuildMember
	(*GuildApply)(nil),                    // 30: Cmd.GuildApply
	(*BlobGuildApply)(nil),                // 31: Cmd.BlobGuildApply
	(*GuildJob)(nil),                      // 32: Cmd.GuildJob
	(*GuildQuest)(nil),                    // 33: Cmd.GuildQuest
	(*GuildBuildMaterial)(nil),            // 34: Cmd.GuildBuildMaterial
	(*GuildBuilding)(nil),                 // 35: Cmd.GuildBuilding
	(*GuildBuildingData)(nil),             // 36: Cmd.GuildBuildingData
	(*GuildChallenge)(nil),                // 37: Cmd.GuildChallenge
	(*GuildChallengeData)(nil),            // 38: Cmd.GuildChallengeData
	(*GuildWelfareItem)(nil),              // 39: Cmd.GuildWelfareItem
	(*GuildWelfare)(nil),                  // 40: Cmd.GuildWelfare
	(*GuildArtifactItem)(nil),             // 41: Cmd.GuildArtifactItem
	(*GuildArtifactData)(nil),             // 42: Cmd.GuildArtifactData
	(*GuildArtifact)(nil),                 // 43: Cmd.GuildArtifact
	(*GQuest)(nil),                        // 44: Cmd.GQuest
	(*BlobGQuest)(nil),                    // 45: Cmd.BlobGQuest
	(*BlobGGvg)(nil),                      // 46: Cmd.BlobGGvg
	(*GuildTreasure)(nil),                 // 47: Cmd.GuildTreasure
	(*TreasureItem)(nil),                  // 48: Cmd.TreasureItem
	(*TreasureResult)(nil),                // 49: Cmd.TreasureResult
	(*BlobGuildTreasure)(nil),             // 50: Cmd.BlobGuildTreasure
	(*BlobGuildMisc)(nil),                 // 51: Cmd.BlobGuildMisc
	(*BlobGuildPack)(nil),                 // 52: Cmd.BlobGuildPack
	(*BlobGuildEvent)(nil),                // 53: Cmd.BlobGuildEvent
	(*GuildPhoto)(nil),                    // 54: Cmd.GuildPhoto
	(*PhotoFrame)(nil),                    // 55: Cmd.PhotoFrame
	(*BlobGuildPhoto)(nil),                // 56: Cmd.BlobGuildPhoto
	(*GuildSummaryData)(nil),              // 57: Cmd.GuildSummaryData
	(*GuildData)(nil),                     // 58: Cmd.GuildData
	(*QueryGuildListGuildCmd)(nil),        // 59: Cmd.QueryGuildListGuildCmd
	(*CreateGuildGuildCmd)(nil),           // 60: Cmd.CreateGuildGuildCmd
	(*EnterGuildGuildCmd)(nil),            // 61: Cmd.EnterGuildGuildCmd
	(*GuildMemberUpdateGuildCmd)(nil),     // 62: Cmd.GuildMemberUpdateGuildCmd
	(*GuildApplyUpdateGuildCmd)(nil),      // 63: Cmd.GuildApplyUpdateGuildCmd
	(*GuildDataUpdate)(nil),               // 64: Cmd.GuildDataUpdate
	(*GuildDataUpdateGuildCmd)(nil),       // 65: Cmd.GuildDataUpdateGuildCmd
	(*GuildMemberDataUpdate)(nil),         // 66: Cmd.GuildMemberDataUpdate
	(*GuildMemberDataUpdateGuildCmd)(nil), // 67: Cmd.GuildMemberDataUpdateGuildCmd
	(*ApplyGuildGuildCmd)(nil),            // 68: Cmd.ApplyGuildGuildCmd
	(*ProcessApplyGuildCmd)(nil),          // 69: Cmd.ProcessApplyGuildCmd
	(*InviteMemberGuildCmd)(nil),          // 70: Cmd.InviteMemberGuildCmd
	(*ProcessInviteGuildCmd)(nil),         // 71: Cmd.ProcessInviteGuildCmd
	(*SetGuildOptionGuildCmd)(nil),        // 72: Cmd.SetGuildOptionGuildCmd
	(*KickMemberGuildCmd)(nil),            // 73: Cmd.KickMemberGuildCmd
	(*ChangeJobGuildCmd)(nil),             // 74: Cmd.ChangeJobGuildCmd
	(*ExitGuildGuildCmd)(nil),             // 75: Cmd.ExitGuildGuildCmd
	(*ExchangeChairGuildCmd)(nil),         // 76: Cmd.ExchangeChairGuildCmd
	(*DismissGuildCmd)(nil),               // 77: Cmd.DismissGuildCmd
	(*LevelupGuildCmd)(nil),               // 78: Cmd.LevelupGuildCmd
	(*DonateGuildCmd)(nil),                // 79: Cmd.DonateGuildCmd
	(*DonateItem)(nil),                    // 80: Cmd.DonateItem
	(*DonateListGuildCmd)(nil),            // 81: Cmd.DonateListGuildCmd
	(*UpdateDonateItemGuildCmd)(nil),      // 82: Cmd.UpdateDonateItemGuildCmd
	(*DonateFrameGuildCmd)(nil),           // 83: Cmd.DonateFrameGuildCmd
	(*EnterTerritoryGuildCmd)(nil),        // 84: Cmd.EnterTerritoryGuildCmd
	(*PrayGuildCmd)(nil),                  // 85: Cmd.PrayGuildCmd
	(*GuildInfoNtf)(nil),                  // 86: Cmd.GuildInfoNtf
	(*GuildPrayNtfGuildCmd)(nil),          // 87: Cmd.GuildPrayNtfGuildCmd
	(*LevelupEffectGuildCmd)(nil),         // 88: Cmd.LevelupEffectGuildCmd
	(*QueryPackGuildCmd)(nil),             // 89: Cmd.QueryPackGuildCmd
	(*PackUpdateGuildCmd)(nil),            // 90: Cmd.PackUpdateGuildCmd
	(*ExchangeZoneGuildCmd)(nil),          // 91: Cmd.ExchangeZoneGuildCmd
	(*ExchangeZoneNtfGuildCmd)(nil),       // 92: Cmd.ExchangeZoneNtfGuildCmd
	(*ExchangeZoneAnswerGuildCmd)(nil),    // 93: Cmd.ExchangeZoneAnswerGuildCmd
	(*GuildEvent)(nil),                    // 94: Cmd.GuildEvent
	(*QueryEventListGuildCmd)(nil),        // 95: Cmd.QueryEventListGuildCmd
	(*NewEventGuildCmd)(nil),              // 96: Cmd.NewEventGuildCmd
	(*GuildReward)(nil),                   // 97: Cmd.GuildReward
	(*ApplyRewardConGuildCmd)(nil),        // 98: Cmd.ApplyRewardConGuildCmd
	(*FrameStatusGuildCmd)(nil),           // 99: Cmd.FrameStatusGuildCmd
	(*ModifyAuthGuildCmd)(nil),            // 100: Cmd.ModifyAuthGuildCmd
	(*JobUpdateGuildCmd)(nil),             // 101: Cmd.JobUpdateGuildCmd
	(*RenameQueryGuildCmd)(nil),           // 102: Cmd.RenameQueryGuildCmd
	(*GuildCityInfo)(nil),                 // 103: Cmd.GuildCityInfo
	(*QueryGuildCityInfoGuildCmd)(nil),    // 104: Cmd.QueryGuildCityInfoGuildCmd
	(*CityActionGuildCmd)(nil),            // 105: Cmd.CityActionGuildCmd
	(*IconInfo)(nil),                      // 106: Cmd.IconInfo
	(*GuildIconSyncGuildCmd)(nil),         // 107: Cmd.GuildIconSyncGuildCmd
	(*GuildIconAddGuildCmd)(nil),          // 108: Cmd.GuildIconAddGuildCmd
	(*GuildIconUploadGuildCmd)(nil),       // 109: Cmd.GuildIconUploadGuildCmd
	(*OpenFunctionGuildCmd)(nil),          // 110: Cmd.OpenFunctionGuildCmd
	(*BuildGuildCmd)(nil),                 // 111: Cmd.BuildGuildCmd
	(*SubmitMaterialGuildCmd)(nil),        // 112: Cmd.SubmitMaterialGuildCmd
	(*BuildingNtfGuildCmd)(nil),           // 113: Cmd.BuildingNtfGuildCmd
	(*BuildingSubmitCountGuildCmd)(nil),   // 114: Cmd.BuildingSubmitCountGuildCmd
	(*ChallengeUpdateNtfGuildCmd)(nil),    // 115: Cmd.ChallengeUpdateNtfGuildCmd
	(*WelfareNtfGuildCmd)(nil),            // 116: Cmd.WelfareNtfGuildCmd
	(*GetWelfareGuildCmd)(nil),            // 117: Cmd.GetWelfareGuildCmd
	(*BuildingLvupEffect)(nil),            // 118: Cmd.BuildingLvupEffect
	(*BuildingLvupEffGuildCmd)(nil),       // 119: Cmd.BuildingLvupEffGuildCmd
	(*ArtifactUpdateNtfGuildCmd)(nil),     // 120: Cmd.ArtifactUpdateNtfGuildCmd
	(*ArtifactProduceGuildCmd)(nil),       // 121: Cmd.ArtifactProduceGuildCmd
	(*ArtifactOptGuildCmd)(nil),           // 122: Cmd.ArtifactOptGuildCmd
	(*QueryGQuestGuildCmd)(nil),           // 123: Cmd.QueryGQuestGuildCmd
	(*TreasureActionGuildCmd)(nil),        // 124: Cmd.TreasureActionGuildCmd
	(*BuildingSubmitRankItem)(nil),        // 125: Cmd.BuildingSubmitRankItem
	(*QueryBuildingRankGuildCmd)(nil),     // 126: Cmd.QueryBuildingRankGuildCmd
	(*QueryTreasureResultGuildCmd)(nil),   // 127: Cmd.QueryTreasureResultGuildCmd
	(*CityShowInfo)(nil),                  // 128: Cmd.CityShowInfo
	(*QueryGCityShowInfoGuildCmd)(nil),    // 129: Cmd.QueryGCityShowInfoGuildCmd
	(*GvgOpenFireGuildCmd)(nil),           // 130: Cmd.GvgOpenFireGuildCmd
	(*EnterPunishTimeNtfGuildCmd)(nil),    // 131: Cmd.EnterPunishTimeNtfGuildCmd
	(*OpenRealtimeVoiceGuildCmd)(nil),     // 132: Cmd.OpenRealtimeVoiceGuildCmd
	(*UserAttr)(nil),                      // 133: Cmd.UserAttr
	(*ItemInfo)(nil),                      // 134: Cmd.ItemInfo
	(EGender)(0),                          // 135: Cmd.EGender
	(EProfession)(0),                      // 136: Cmd.EProfession
	(ESource)(0),                          // 137: Cmd.ESource
	(*QuestData)(nil),                     // 138: Cmd.QuestData
	(*ItemData)(nil),                      // 139: Cmd.ItemData
	(*DojoMsgBlob)(nil),                   // 140: Cmd.DojoMsgBlob
	(Command)(0),                          // 141: Cmd.Command
	(ERenameErrCode)(0),                   // 142: Cmd.ERenameErrCode
}
var file_GuildCmd_proto_depIdxs = []int32{
	3,   // 0: Cmd.GuildPrayCFG.type:type_name -> Cmd.EPrayType
	133, // 1: Cmd.GuildPrayCFG.attrs:type_name -> Cmd.UserAttr
	134, // 2: Cmd.GuildPrayCFG.costs:type_name -> Cmd.ItemInfo
	22,  // 3: Cmd.GuildMemberPray.cur:type_name -> Cmd.GuildPrayCFG
	22,  // 4: Cmd.GuildMemberPray.next:type_name -> Cmd.GuildPrayCFG
	23,  // 5: Cmd.BlobGuildPray.prays:type_name -> Cmd.GuildMemberPray
	80,  // 6: Cmd.BlobDonate.items:type_name -> Cmd.DonateItem
	6,   // 7: Cmd.UserGuildBuilding.type:type_name -> Cmd.EGuildBuilding
	26,  // 8: Cmd.BlobGuildBuilding.buildings:type_name -> Cmd.UserGuildBuilding
	135, // 9: Cmd.GuildMember.gender:type_name -> Cmd.EGender
	136, // 10: Cmd.GuildMember.profession:type_name -> Cmd.EProfession
	2,   // 11: Cmd.GuildMember.job:type_name -> Cmd.EGuildJob
	24,  // 12: Cmd.GuildMember.pray:type_name -> Cmd.BlobGuildPray
	25,  // 13: Cmd.GuildMember.donate:type_name -> Cmd.BlobDonate
	27,  // 14: Cmd.GuildMember.building:type_name -> Cmd.BlobGuildBuilding
	28,  // 15: Cmd.BlobGuildMember.members:type_name -> Cmd.GuildMember
	135, // 16: Cmd.GuildApply.gender:type_name -> Cmd.EGender
	136, // 17: Cmd.GuildApply.profession:type_name -> Cmd.EProfession
	30,  // 18: Cmd.BlobGuildApply.applys:type_name -> Cmd.GuildApply
	2,   // 19: Cmd.GuildJob.job:type_name -> Cmd.EGuildJob
	6,   // 20: Cmd.GuildBuilding.type:type_name -> Cmd.EGuildBuilding
	34,  // 21: Cmd.GuildBuilding.materials:type_name -> Cmd.GuildBuildMaterial
	34,  // 22: Cmd.GuildBuilding.restmaterials:type_name -> Cmd.GuildBuildMaterial
	35,  // 23: Cmd.GuildBuildingData.buildings:type_name -> Cmd.GuildBuilding
	37,  // 24: Cmd.GuildChallengeData.challenges:type_name -> Cmd.GuildChallenge
	7,   // 25: Cmd.GuildWelfareItem.type:type_name -> Cmd.EGuildWelfare
	137, // 26: Cmd.GuildWelfareItem.source:type_name -> Cmd.ESource
	39,  // 27: Cmd.GuildWelfare.items:type_name -> Cmd.GuildWelfareItem
	41,  // 28: Cmd.GuildArtifact.items:type_name -> Cmd.GuildArtifactItem
	42,  // 29: Cmd.GuildArtifact.datas:type_name -> Cmd.GuildArtifactData
	138, // 30: Cmd.GQuest.datas:type_name -> Cmd.QuestData
	44,  // 31: Cmd.BlobGQuest.quests:type_name -> Cmd.GQuest
	139, // 32: Cmd.TreasureItem.datas:type_name -> Cmd.ItemData
	8,   // 33: Cmd.TreasureResult.state:type_name -> Cmd.ETreasureState
	48,  // 34: Cmd.TreasureResult.items:type_name -> Cmd.TreasureItem
	47,  // 35: Cmd.BlobGuildTreasure.treasures:type_name -> Cmd.GuildTreasure
	49,  // 36: Cmd.BlobGuildTreasure.result:type_name -> Cmd.TreasureResult
	32,  // 37: Cmd.BlobGuildMisc.job:type_name -> Cmd.GuildJob
	33,  // 38: Cmd.BlobGuildMisc.quest:type_name -> Cmd.GuildQuest
	140, // 39: Cmd.BlobGuildMisc.dojomsg:type_name -> Cmd.DojoMsgBlob
	36,  // 40: Cmd.BlobGuildMisc.building:type_name -> Cmd.GuildBuildingData
	38,  // 41: Cmd.BlobGuildMisc.challenge:type_name -> Cmd.GuildChallengeData
	40,  // 42: Cmd.BlobGuildMisc.welfare:type_name -> Cmd.GuildWelfare
	43,  // 43: Cmd.BlobGuildMisc.artifact:type_name -> Cmd.GuildArtifact
	45,  // 44: Cmd.BlobGuildMisc.quests:type_name -> Cmd.BlobGQuest
	50,  // 45: Cmd.BlobGuildMisc.treasures:type_name -> Cmd.BlobGuildTreasure
	46,  // 46: Cmd.BlobGuildMisc.gvg:type_name -> Cmd.BlobGGvg
	134, // 47: Cmd.BlobGuildPack.item:type_name -> Cmd.ItemInfo
	139, // 48: Cmd.BlobGuildPack.data:type_name -> Cmd.ItemData
	94,  // 49: Cmd.BlobGuildEvent.events:type_name -> Cmd.GuildEvent
	137, // 50: Cmd.GuildPhoto.source:type_name -> Cmd.ESource
	54,  // 51: Cmd.PhotoFrame.photo:type_name -> Cmd.GuildPhoto
	55,  // 52: Cmd.BlobGuildPhoto.frames:type_name -> Cmd.PhotoFrame
	135, // 53: Cmd.GuildSummaryData.chairmangender:type_name -> Cmd.EGender
	57,  // 54: Cmd.GuildData.summary:type_name -> Cmd.GuildSummaryData
	28,  // 55: Cmd.GuildData.members:type_name -> Cmd.GuildMember
	30,  // 56: Cmd.GuildData.applys:type_name -> Cmd.GuildApply
	32,  // 57: Cmd.GuildData.jobs:type_name -> Cmd.GuildJob
	37,  // 58: Cmd.GuildData.challenges:type_name -> Cmd.GuildChallenge
	141, // 59: Cmd.QueryGuildListGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 60: Cmd.QueryGuildListGuildCmd.param:type_name -> Cmd.GuildParam
	57,  // 61: Cmd.QueryGuildListGuildCmd.list:type_name -> Cmd.GuildSummaryData
	141, // 62: Cmd.CreateGuildGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 63: Cmd.CreateGuildGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 64: Cmd.EnterGuildGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 65: Cmd.EnterGuildGuildCmd.param:type_name -> Cmd.GuildParam
	58,  // 66: Cmd.EnterGuildGuildCmd.data:type_name -> Cmd.GuildData
	141, // 67: Cmd.GuildMemberUpdateGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 68: Cmd.GuildMemberUpdateGuildCmd.param:type_name -> Cmd.GuildParam
	28,  // 69: Cmd.GuildMemberUpdateGuildCmd.updates:type_name -> Cmd.GuildMember
	141, // 70: Cmd.GuildApplyUpdateGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 71: Cmd.GuildApplyUpdateGuildCmd.param:type_name -> Cmd.GuildParam
	30,  // 72: Cmd.GuildApplyUpdateGuildCmd.updates:type_name -> Cmd.GuildApply
	9,   // 73: Cmd.GuildDataUpdate.type:type_name -> Cmd.EGuildData
	141, // 74: Cmd.GuildDataUpdateGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 75: Cmd.GuildDataUpdateGuildCmd.param:type_name -> Cmd.GuildParam
	64,  // 76: Cmd.GuildDataUpdateGuildCmd.updates:type_name -> Cmd.GuildDataUpdate
	11,  // 77: Cmd.GuildMemberDataUpdate.type:type_name -> Cmd.EGuildMemberData
	141, // 78: Cmd.GuildMemberDataUpdateGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 79: Cmd.GuildMemberDataUpdateGuildCmd.param:type_name -> Cmd.GuildParam
	10,  // 80: Cmd.GuildMemberDataUpdateGuildCmd.type:type_name -> Cmd.EGuildList
	66,  // 81: Cmd.GuildMemberDataUpdateGuildCmd.updates:type_name -> Cmd.GuildMemberDataUpdate
	141, // 82: Cmd.ApplyGuildGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 83: Cmd.ApplyGuildGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 84: Cmd.ProcessApplyGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 85: Cmd.ProcessApplyGuildCmd.param:type_name -> Cmd.GuildParam
	12,  // 86: Cmd.ProcessApplyGuildCmd.action:type_name -> Cmd.EGuildAction
	141, // 87: Cmd.InviteMemberGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 88: Cmd.InviteMemberGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 89: Cmd.ProcessInviteGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 90: Cmd.ProcessInviteGuildCmd.param:type_name -> Cmd.GuildParam
	12,  // 91: Cmd.ProcessInviteGuildCmd.action:type_name -> Cmd.EGuildAction
	141, // 92: Cmd.SetGuildOptionGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 93: Cmd.SetGuildOptionGuildCmd.param:type_name -> Cmd.GuildParam
	32,  // 94: Cmd.SetGuildOptionGuildCmd.jobs:type_name -> Cmd.GuildJob
	141, // 95: Cmd.KickMemberGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 96: Cmd.KickMemberGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 97: Cmd.ChangeJobGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 98: Cmd.ChangeJobGuildCmd.param:type_name -> Cmd.GuildParam
	2,   // 99: Cmd.ChangeJobGuildCmd.job:type_name -> Cmd.EGuildJob
	141, // 100: Cmd.ExitGuildGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 101: Cmd.ExitGuildGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 102: Cmd.ExchangeChairGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 103: Cmd.ExchangeChairGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 104: Cmd.DismissGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 105: Cmd.DismissGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 106: Cmd.LevelupGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 107: Cmd.LevelupGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 108: Cmd.DonateGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 109: Cmd.DonateGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 110: Cmd.DonateListGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 111: Cmd.DonateListGuildCmd.param:type_name -> Cmd.GuildParam
	80,  // 112: Cmd.DonateListGuildCmd.items:type_name -> Cmd.DonateItem
	141, // 113: Cmd.UpdateDonateItemGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 114: Cmd.UpdateDonateItemGuildCmd.param:type_name -> Cmd.GuildParam
	80,  // 115: Cmd.UpdateDonateItemGuildCmd.item:type_name -> Cmd.DonateItem
	80,  // 116: Cmd.UpdateDonateItemGuildCmd.del:type_name -> Cmd.DonateItem
	141, // 117: Cmd.DonateFrameGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 118: Cmd.DonateFrameGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 119: Cmd.EnterTerritoryGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 120: Cmd.EnterTerritoryGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 121: Cmd.PrayGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 122: Cmd.PrayGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 123: Cmd.GuildInfoNtf.cmd:type_name -> Cmd.Command
	0,   // 124: Cmd.GuildInfoNtf.param:type_name -> Cmd.GuildParam
	141, // 125: Cmd.GuildPrayNtfGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 126: Cmd.GuildPrayNtfGuildCmd.param:type_name -> Cmd.GuildParam
	23,  // 127: Cmd.GuildPrayNtfGuildCmd.prays:type_name -> Cmd.GuildMemberPray
	141, // 128: Cmd.LevelupEffectGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 129: Cmd.LevelupEffectGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 130: Cmd.QueryPackGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 131: Cmd.QueryPackGuildCmd.param:type_name -> Cmd.GuildParam
	139, // 132: Cmd.QueryPackGuildCmd.items:type_name -> Cmd.ItemData
	141, // 133: Cmd.PackUpdateGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 134: Cmd.PackUpdateGuildCmd.param:type_name -> Cmd.GuildParam
	139, // 135: Cmd.PackUpdateGuildCmd.updates:type_name -> Cmd.ItemData
	141, // 136: Cmd.ExchangeZoneGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 137: Cmd.ExchangeZoneGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 138: Cmd.ExchangeZoneNtfGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 139: Cmd.ExchangeZoneNtfGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 140: Cmd.ExchangeZoneAnswerGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 141: Cmd.ExchangeZoneAnswerGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 142: Cmd.QueryEventListGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 143: Cmd.QueryEventListGuildCmd.param:type_name -> Cmd.GuildParam
	94,  // 144: Cmd.QueryEventListGuildCmd.events:type_name -> Cmd.GuildEvent
	141, // 145: Cmd.NewEventGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 146: Cmd.NewEventGuildCmd.param:type_name -> Cmd.GuildParam
	94,  // 147: Cmd.NewEventGuildCmd.event:type_name -> Cmd.GuildEvent
	141, // 148: Cmd.ApplyRewardConGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 149: Cmd.ApplyRewardConGuildCmd.param:type_name -> Cmd.GuildParam
	97,  // 150: Cmd.ApplyRewardConGuildCmd.con:type_name -> Cmd.GuildReward
	97,  // 151: Cmd.ApplyRewardConGuildCmd.asset:type_name -> Cmd.GuildReward
	141, // 152: Cmd.FrameStatusGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 153: Cmd.FrameStatusGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 154: Cmd.ModifyAuthGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 155: Cmd.ModifyAuthGuildCmd.param:type_name -> Cmd.GuildParam
	13,  // 156: Cmd.ModifyAuthGuildCmd.modify:type_name -> Cmd.EModify
	2,   // 157: Cmd.ModifyAuthGuildCmd.job:type_name -> Cmd.EGuildJob
	5,   // 158: Cmd.ModifyAuthGuildCmd.auth:type_name -> Cmd.EAuth
	141, // 159: Cmd.JobUpdateGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 160: Cmd.JobUpdateGuildCmd.param:type_name -> Cmd.GuildParam
	32,  // 161: Cmd.JobUpdateGuildCmd.job:type_name -> Cmd.GuildJob
	141, // 162: Cmd.RenameQueryGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 163: Cmd.RenameQueryGuildCmd.param:type_name -> Cmd.GuildParam
	142, // 164: Cmd.RenameQueryGuildCmd.code:type_name -> Cmd.ERenameErrCode
	141, // 165: Cmd.QueryGuildCityInfoGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 166: Cmd.QueryGuildCityInfoGuildCmd.param:type_name -> Cmd.GuildParam
	103, // 167: Cmd.QueryGuildCityInfoGuildCmd.infos:type_name -> Cmd.GuildCityInfo
	141, // 168: Cmd.CityActionGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 169: Cmd.CityActionGuildCmd.param:type_name -> Cmd.GuildParam
	15,  // 170: Cmd.CityActionGuildCmd.action:type_name -> Cmd.ECityAction
	16,  // 171: Cmd.IconInfo.state:type_name -> Cmd.EIconState
	141, // 172: Cmd.GuildIconSyncGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 173: Cmd.GuildIconSyncGuildCmd.param:type_name -> Cmd.GuildParam
	106, // 174: Cmd.GuildIconSyncGuildCmd.infos:type_name -> Cmd.IconInfo
	141, // 175: Cmd.GuildIconAddGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 176: Cmd.GuildIconAddGuildCmd.param:type_name -> Cmd.GuildParam
	16,  // 177: Cmd.GuildIconAddGuildCmd.state:type_name -> Cmd.EIconState
	141, // 178: Cmd.GuildIconUploadGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 179: Cmd.GuildIconUploadGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 180: Cmd.OpenFunctionGuildCmd.cmd:type_name -> Cmd.Command
	...
	141, // 189: Cmd.BuildingNtfGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 190: Cmd.BuildingNtfGuildCmd.param:type_name -> Cmd.GuildParam
	35,  // 191: Cmd.BuildingNtfGuildCmd.buildings:type_name -> Cmd.GuildBuilding
	141, // 192: Cmd.BuildingSubmitCountGuildCmd.cmd:type_name -> Cmd.Command
	...
	141, // 195: Cmd.ChallengeUpdateNtfGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 196: Cmd.ChallengeUpdateNtfGuildCmd.param:type_name -> Cmd.GuildParam
	37,  // 197: Cmd.ChallengeUpdateNtfGuildCmd.updates:type_name -> Cmd.GuildChallenge
	37,  // 198: Cmd.ChallengeUpdateNtfGuildCmd.dels:type_name -> Cmd.GuildChallenge
	141, // 199: Cmd.WelfareNtfGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 200: Cmd.WelfareNtfGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 201: Cmd.GetWelfareGuildCmd.cmd:type_name -> Cmd.Command
	...
	141, // 204: Cmd.BuildingLvupEffGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 205: Cmd.BuildingLvupEffGuildCmd.param:type_name -> Cmd.GuildParam
	118, // 206: Cmd.BuildingLvupEffGuildCmd.effects:type_name -> Cmd.BuildingLvupEffect
	141, // 207: Cmd.ArtifactUpdateNtfGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 208: Cmd.ArtifactUpdateNtfGuildCmd.param:type_name -> Cmd.GuildParam
	41,  // 209: Cmd.ArtifactUpdateNtfGuildCmd.itemupdates:type_name -> Cmd.GuildArtifactItem
	42,  // 210: Cmd.ArtifactUpdateNtfGuildCmd.dataupdates:type_name -> Cmd.GuildArtifactData
	141, // 211: Cmd.ArtifactProduceGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 212: Cmd.ArtifactProduceGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 213: Cmd.ArtifactOptGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 214: Cmd.ArtifactOptGuildCmd.param:type_name -> Cmd.GuildParam
	17,  // 215: Cmd.ArtifactOptGuildCmd.opt:type_name -> Cmd.EArtifactOptType
	141, // 216: Cmd.QueryGQuestGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 217: Cmd.QueryGQuestGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 218: Cmd.TreasureActionGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 219: Cmd.TreasureActionGuildCmd.param:type_name -> Cmd.GuildParam
	19,  // 220: Cmd.TreasureActionGuildCmd.action:type_name -> Cmd.ETreasureAction
	20,  // 221: Cmd.TreasureActionGuildCmd.point:type_name -> Cmd.ETreasurePoint
	47,  // 222: Cmd.TreasureActionGuildCmd.treasure:type_name -> Cmd.GuildTreasure
	141, // 223: Cmd.QueryBuildingRankGuildCmd.cmd:type_name -> Cmd.Command
	...
	125, // 226: Cmd.QueryBuildingRankGuildCmd.items:type_name -> Cmd.BuildingSubmitRankItem
	141, // 227: Cmd.QueryTreasureResultGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 228: Cmd.QueryTreasureResultGuildCmd.param:type_name -> Cmd.GuildParam
	49,  // 229: Cmd.QueryTreasureResultGuildCmd.result:type_name -> Cmd.TreasureResult
	21,  // 230: Cmd.CityShowInfo.state:type_name -> Cmd.EGCityState
	141, // 231: Cmd.QueryGCityShowInfoGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 232: Cmd.QueryGCityShowInfoGuildCmd.param:type_name -> Cmd.GuildParam
	128, // 233: Cmd.QueryGCityShowInfoGuildCmd.infos:type_name -> Cmd.CityShowInfo
	141, // 234: Cmd.GvgOpenFireGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 235: Cmd.GvgOpenFireGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 236: Cmd.EnterPunishTimeNtfGuildCmd.cmd:type_name -> Cmd.Command
	0,   // 237: Cmd.EnterPunishTimeNtfGuildCmd.param:type_name -> Cmd.GuildParam
	141, // 238: Cmd.OpenRealtimeVoiceGuildCmd.cmd:type_name -> Cmd.Command
...
func file_GuildCmd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_GuildCmd_proto_msgTypes[76].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ApplyRewardConGuildCmd); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
