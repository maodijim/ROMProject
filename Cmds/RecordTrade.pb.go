...
const (
	...
	RecordUserTradeParam_QUERY_MERGE_PRICE_TRADE_PARAM   RecordUserTradeParam = 44
	RecordUserTradeParam_QUERY_ITEM_PRICE_TRADE_PARAM    RecordUserTradeParam = 45
)
...
var (
	RecordUserTradeParam_name = map[int32]string{
		...
		44: "QUERY_MERGE_PRICE_TRADE_PARAM",
		45: "QUERY_ITEM_PRICE_TRADE_PARAM",
	}
...
const (
	...
	EListNtfType_ELIST_NTF_MY_LOG_RED_POINT EListNtfType = 3
)
...
type GiveItemInfo struct {
	...
	Senderserverid *uint32      `protobuf:"varint,14,opt,name=senderserverid" json:"senderserverid,omitempty"`
}
...
func (x *GiveItemInfo) GetSenderserverid() uint32 {
	if x != nil && x.Senderserverid != nil {
...
type QueryMergePriceRecordTradeCmd struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cmd          *Command              `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=57" json:"cmd,omitempty"`
	Param        *RecordUserTradeParam `protobuf:"varint,2,opt,name=param,enum=Cmd.RecordUserTradeParam,def=44" json:"param,omitempty"`
	Itemid       *uint32               `protobuf:"varint,3,opt,name=itemid" json:"itemid,omitempty"`
	CurrentPrice *uint64               `protobuf:"varint,4,opt,name=current_price,json=currentPrice" json:"current_price,omitempty"`
	MergePrice   *uint64               `protobuf:"varint,5,opt,name=merge_price,json=mergePrice" json:"merge_price,omitempty"`
}

// Default values for QueryMergePriceRecordTradeCmd fields.
const (
	Default_QueryMergePriceRecordTradeCmd_Cmd   = Command_RECORD_USER_TRADE_PROTOCMD
	Default_QueryMergePriceRecordTradeCmd_Param = RecordUserTradeParam_QUERY_MERGE_PRICE_TRADE_PARAM
)

func (x *QueryMergePriceRecordTradeCmd) Reset() {
	*x = QueryMergePriceRecordTradeCmd{}
	if protoimpl.UnsafeEnabled {
		mi := &file_RecordTrade_proto_msgTypes[40]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *QueryMergePriceRecordTradeCmd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryMergePriceRecordTradeCmd) ProtoMessage() {}

func (x *QueryMergePriceRecordTradeCmd) ProtoReflect() protoreflect.Message {
	mi := &file_RecordTrade_proto_msgTypes[40]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryMergePriceRecordTradeCmd.ProtoReflect.Descriptor instead.
func (*QueryMergePriceRecordTradeCmd) Descriptor() ([]byte, []int) {
	return file_RecordTrade_proto_rawDescGZIP(), []int{40}
}

func (x *QueryMergePriceRecordTradeCmd) GetCmd() Command {
	if x != nil && x.Cmd != nil {
		return *x.Cmd
	}
	return Default_QueryMergePriceRecordTradeCmd_Cmd
}

func (x *QueryMergePriceRecordTradeCmd) GetParam() RecordUserTradeParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
	return Default_QueryMergePriceRecordTradeCmd_Param
}

func (x *QueryMergePriceRecordTradeCmd) GetItemid() uint32 {
	if x != nil && x.Itemid != nil {
		return *x.Itemid
	}
	return 0
...
func (x *QueryMergePriceRecordTradeCmd) GetCurrentPrice() uint64 {
...
func (x *QueryMergePriceRecordTradeCmd) GetMergePrice() uint64 {
	if x != nil && x.MergePrice != nil {
		return *x.MergePrice
	}
	return 0
}
...
type TradeItemPriceInfo struct {
	...
	Itemdata *ItemData `protobuf:"bytes,1,opt,name=itemdata" json:"itemdata,omitempty"`
	Price    *uint64   `protobuf:"varint,2,opt,name=price" json:"price,omitempty"`
}

func (x *TradeItemPriceInfo) Reset() {
	*x = TradeItemPriceInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_RecordTrade_proto_msgTypes[41]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *TradeItemPriceInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TradeItemPriceInfo) ProtoMessage() {}

func (x *TradeItemPriceInfo) ProtoReflect() protoreflect.Message {
	mi := &file_RecordTrade_proto_msgTypes[41]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TradeItemPriceInfo.ProtoReflect.Descriptor instead.
func (*TradeItemPriceInfo) Descriptor() ([]byte, []int) {
	return file_RecordTrade_proto_rawDescGZIP(), []int{41}
}

func (x *TradeItemPriceInfo) GetItemdata() *ItemData {
	if x != nil {
		return x.Itemdata
	}
	return nil
...
func (x *TradeItemPriceInfo) GetPrice() uint64 {
	if x != nil && x.Price != nil {
		return *x.Price
	}
	return 0
...
type QueryItemPriceRecordTradeCmd struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cmd   *Command              `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=57" json:"cmd,omitempty"`
	Param *RecordUserTradeParam `protobuf:"varint,2,opt,name=param,enum=Cmd.RecordUserTradeParam,def=45" json:"param,omitempty"`
	Items []*TradeItemPriceInfo `protobuf:"bytes,3,rep,name=items" json:"items,omitempty"`
}

// Default values for QueryItemPriceRecordTradeCmd fields.
const (
	Default_QueryItemPriceRecordTradeCmd_Cmd   = Command_RECORD_USER_TRADE_PROTOCMD
	Default_QueryItemPriceRecordTradeCmd_Param = RecordUserTradeParam_QUERY_ITEM_PRICE_TRADE_PARAM
)

func (x *QueryItemPriceRecordTradeCmd) Reset() {
	*x = QueryItemPriceRecordTradeCmd{}
	if protoimpl.UnsafeEnabled {
		mi := &file_RecordTrade_proto_msgTypes[42]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *QueryItemPriceRecordTradeCmd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryItemPriceRecordTradeCmd) ProtoMessage() {}

func (x *QueryItemPriceRecordTradeCmd) ProtoReflect() protoreflect.Message {
	mi := &file_RecordTrade_proto_msgTypes[42]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use QueryItemPriceRecordTradeCmd.ProtoReflect.Descriptor instead.
func (*QueryItemPriceRecordTradeCmd) Descriptor() ([]byte, []int) {
	return file_RecordTrade_proto_rawDescGZIP(), []int{42}
}

func (x *QueryItemPriceRecordTradeCmd) GetCmd() Command {
	if x != nil && x.Cmd != nil {
		return *x.Cmd
	}
	return Default_QueryItemPriceRecordTradeCmd_Cmd
}

func (x *QueryItemPriceRecordTradeCmd) GetParam() RecordUserTradeParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
	return Default_QueryItemPriceRecordTradeCmd_Param
}

func (x *QueryItemPriceRecordTradeCmd) GetItems() []*TradeItemPriceInfo {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_RecordTrade_proto_rawDesc = []byte{
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0xb7, 0x03, 0x0a, 0x0c, 0x47, 0x69, 0x76, 0x65, 0x49, 0x74,
	...
	,
	...
	0x72, 0x61, 0x6d, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x02, 0x69, 0x64, 0x12, 0x2d, 0x0a, 0x08, 0x69, 0x74, 0x65, 0x6d, 0x69, 0x6e, 0x66, 0x6f, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x47, 0x69, 0x76, 0x65,
	0x49, 0x74, 0x65, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x08, 0x69, 0x74, 0x65, 0x6d, 0x69, 0x6e,
	0x66, 0x6f, 0x22, 0xdc, 0x01, 0x0a, 0x18, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x61, 0x63, 0x6b,
	0x61, 0x67, 0x65, 0x53, 0x69, 0x7a, 0x65, 0x54, 0x72, 0x61, 0x64, 0x65, 0x43, 0x6d, 0x64, 0x12,
	...
	0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a, 0x1c, 0x43, 0x48, 0x45, 0x43, 0x4b, 0x5f, 0x50, 0x41, 0x43,
	0x4b, 0x41, 0x47, 0x45, 0x5f, 0x53, 0x49, 0x5a, 0x45, 0x5f, 0x54, 0x52, 0x41, 0x44, 0x45, 0x5f,
	0x43, 0x4d, 0x44, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x23, 0x0a, 0x05, 0x69, 0x74,
	...
	0x10, 0x0a, 0x03, 0x72, 0x65, 0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x03, 0x72, 0x65,
	0x74, 0x22, 0xf3, 0x01, 0x0a, 0x14, 0x51, 0x75, 0x63, 0x69, 0x6b, 0x54, 0x61, 0x6b, 0x65, 0x4c,
	0x6f, 0x67, 0x54, 0x72, 0x61, 0x64, 0x65, 0x43, 0x6d, 0x64, 0x12, 0x3a, 0x0a, 0x03, 0x63, 0x6d,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x43, 0x6f,
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x3a, 0x1a, 0x52, 0x45, 0x43, 0x4f, 0x52, 0x44, 0x5f, 0x55, 0x53,
	0x45, 0x52, 0x5f, 0x54, 0x52, 0x41, 0x44, 0x45, 0x5f, 0x50, 0x52, 0x4f, 0x54, 0x4f, 0x43, 0x4d,
	...
	,
	...
	0x6e, 0x74, 0x22, 0xd4, 0x02, 0x0a, 0x16, 0x51, 0x75, 0x65, 0x72, 0x79, 0x49, 0x74, 0x65, 0x6d,
	0x43, 0x6f, 0x75, 0x6e, 0x74, 0x54, 0x72, 0x61, 0x64, 0x65, 0x43, 0x6d, 0x64, 0x12, 0x3a, 0x0a,
	...
	0x72, 0x61, 0x6d, 0x3a, 0x1c, 0x51, 0x55, 0x45, 0x52, 0x59, 0x5f, 0x49, 0x54, 0x45, 0x4d, 0x5f,
	0x43, 0x4f, 0x55, 0x4e, 0x54, 0x5f, 0x54, 0x52, 0x41, 0x44, 0x45, 0x5f, 0x50, 0x41, 0x52, 0x41,
	0x4d, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x68, 0x61, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_RecordTrade_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_RecordTrade_proto_goTypes = []interface{}{
	...
	(*QueryMergePriceRecordTradeCmd)(nil),   // 50: Cmd.QueryMergePriceRecordTradeCmd
	(*TradeItemPriceInfo)(nil),              // 51: Cmd.TradeItemPriceInfo
	(*QueryItemPriceRecordTradeCmd)(nil),    // 52: Cmd.QueryItemPriceRecordTradeCmd
	(ETradeType)(0),                         // 53: Cmd.ETradeType
	(Command)(0),                            // 54: Cmd.Command
	(*TradeItemBaseInfo)(nil),               // 55: Cmd.TradeItemBaseInfo
	(*ItemData)(nil),                        // 56: Cmd.ItemData
	(ETRADE_RET_CODE)(0),                    // 57: Cmd.ETRADE_RET_CODE
	(*ItemInfo)(nil),                        // 58: Cmd.ItemInfo
}
var file_RecordTrade_proto_depIdxs = []int32{
	1,   // 0: Cmd.SearchCond.rank_type:type_name -> Cmd.RankType
	53,  // 1: Cmd.SearchCond.trade_type:type_name -> Cmd.ETradeType
	54,  // 2: Cmd.BriefPendingListRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 3: Cmd.BriefPendingListRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	54,  // 4: Cmd.DetailPendingListRecordTradeCmd.cmd:type_name -> Cmd.Command
	...
	55,  // 7: Cmd.DetailPendingListRecordTradeCmd.lists:type_name -> Cmd.TradeItemBaseInfo
	54,  // 8: Cmd.ItemSellInfoRecordTradeCmd.cmd:type_name -> Cmd.Command
	...
	53,  // 12: Cmd.ItemSellInfoRecordTradeCmd.type:type_name -> Cmd.ETradeType
	54,  // 13: Cmd.MyPendingListRecordTradeCmd.cmd:type_name -> Cmd.Command
	...
	55,  // 16: Cmd.MyPendingListRecordTradeCmd.lists:type_name -> Cmd.TradeItemBaseInfo
	...
	56,  // 22: Cmd.LogItemInfo.itemdata:type_name -> Cmd.ItemData
	53,  // 23: Cmd.LogItemInfo.trade_type:type_name -> Cmd.ETradeType
	54,  // 24: Cmd.MyTradeLogRecordTradeCmd.cmd:type_name -> Cmd.Command
	...
	54,  // 38: Cmd.ReqServerPriceRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 39: Cmd.ReqServerPriceRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	56,  // 40: Cmd.ReqServerPriceRecordTradeCmd.itemData:type_name -> Cmd.ItemData
	4,   // 41: Cmd.ReqServerPriceRecordTradeCmd.statetype:type_name -> Cmd.StateType
	53,  // 42: Cmd.ReqServerPriceRecordTradeCmd.trade_type:type_name -> Cmd.ETradeType
	54,  // 43: Cmd.BuyItemRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 44: Cmd.BuyItemRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	55,  // 45: Cmd.BuyItemRecordTradeCmd.item_info:type_name -> Cmd.TradeItemBaseInfo
	57,  // 46: Cmd.BuyItemRecordTradeCmd.ret:type_name -> Cmd.ETRADE_RET_CODE
	53,  // 47: Cmd.BuyItemRecordTradeCmd.type:type_name -> Cmd.ETradeType
	54,  // 48: Cmd.SellItemRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 49: Cmd.SellItemRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	55,  // 50: Cmd.SellItemRecordTradeCmd.item_info:type_name -> Cmd.TradeItemBaseInfo
	57,  // 51: Cmd.SellItemRecordTradeCmd.ret:type_name -> Cmd.ETRADE_RET_CODE
	53,  // 52: Cmd.SellItemRecordTradeCmd.type:type_name -> Cmd.ETradeType
	54,  // 53: Cmd.CancelItemRecordTrade.cmd:type_name -> Cmd.Command
	0,   // 54: Cmd.CancelItemRecordTrade.param:type_name -> Cmd.RecordUserTradeParam
	55,  // 55: Cmd.CancelItemRecordTrade.item_info:type_name -> Cmd.TradeItemBaseInfo
	57,  // 56: Cmd.CancelItemRecordTrade.ret:type_name -> Cmd.ETRADE_RET_CODE
	53,  // 57: Cmd.CancelItemRecordTrade.type:type_name -> Cmd.ETradeType
	54,  // 58: Cmd.ResellPendingRecordTrade.cmd:type_name -> Cmd.Command
	0,   // 59: Cmd.ResellPendingRecordTrade.param:type_name -> Cmd.RecordUserTradeParam
	55,  // 60: Cmd.ResellPendingRecordTrade.item_info:type_name -> Cmd.TradeItemBaseInfo
	57,  // 61: Cmd.ResellPendingRecordTrade.ret:type_name -> Cmd.ETRADE_RET_CODE
	53,  // 62: Cmd.ResellPendingRecordTrade.type:type_name -> Cmd.ETradeType
	54,  // 63: Cmd.PanelRecordTrade.cmd:type_name -> Cmd.Command
	...
	53,  // 66: Cmd.PanelRecordTrade.trade_type:type_name -> Cmd.ETradeType
	54,  // 67: Cmd.ListNtfRecordTrade.cmd:type_name -> Cmd.Command
	...
	53,  // 70: Cmd.ListNtfRecordTrade.trade_type:type_name -> Cmd.ETradeType
	54,  // 71: Cmd.HotItemidRecordTrade.cmd:type_name -> Cmd.Command
	0,   // 72: Cmd.HotItemidRecordTrade.param:type_name -> Cmd.RecordUserTradeParam
	54,  // 73: Cmd.NtfCanTakeCountTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 74: Cmd.NtfCanTakeCountTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	53,  // 75: Cmd.NtfCanTakeCountTradeCmd.trade_type:type_name -> Cmd.ETradeType
	54,  // 76: Cmd.GiveTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 77: Cmd.GiveTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	2,   // 78: Cmd.GiveTradeCmd.logtype:type_name -> Cmd.EOperType
	54,  // 79: Cmd.AcceptTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 80: Cmd.AcceptTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	54,  // 81: Cmd.RefuseTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 82: Cmd.RefuseTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	3,   // 83: Cmd.GiveItemInfo.status:type_name -> Cmd.ETakeStatus
	56,  // 84: Cmd.GiveItemInfo.itemdata:type_name -> Cmd.ItemData
	54,  // 85: Cmd.ReqGiveItemInfoCmd.cmd:type_name -> Cmd.Command
	...
	54,  // 88: Cmd.CheckPackageSizeTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 89: Cmd.CheckPackageSizeTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	58,  // 90: Cmd.CheckPackageSizeTradeCmd.items:type_name -> Cmd.ItemInfo
	54,  // 91: Cmd.QucikTakeLogTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 92: Cmd.QucikTakeLogTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	53,  // 93: Cmd.QucikTakeLogTradeCmd.trade_type:type_name -> Cmd.ETradeType
	54,  // 94: Cmd.QueryItemCountTradeCmd.cmd:type_name -> Cmd.Command
	...
	55,  // 97: Cmd.QueryItemCountTradeCmd.res_items:type_name -> Cmd.TradeItemBaseInfo
	7,   // 98: Cmd.QueryItemCountTradeCmd.type:type_name -> Cmd.ETradeItemQueryType
	54,  // 99: Cmd.LotteryGiveCmd.cmd:type_name -> Cmd.Command
	...
	54,  // 102: Cmd.TodayFinanceRank.cmd:type_name -> Cmd.Command
	...
	54,  // 107: Cmd.TodayFinanceDetail.cmd:type_name -> Cmd.Command
	...
	54,  // 112: Cmd.BoothPlayerPendingListCmd.cmd:type_name -> Cmd.Command
	0,   // 113: Cmd.BoothPlayerPendingListCmd.param:type_name -> Cmd.RecordUserTradeParam
	55,  // 114: Cmd.BoothPlayerPendingListCmd.lists:type_name -> Cmd.TradeItemBaseInfo
	54,  // 115: Cmd.UpdateOrderTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 116: Cmd.UpdateOrderTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	55,  // 117: Cmd.UpdateOrderTradeCmd.info:type_name -> Cmd.TradeItemBaseInfo
	53,  // 118: Cmd.UpdateOrderTradeCmd.type:type_name -> Cmd.ETradeType
	53,  // 119: Cmd.TradeInfo.tradetype:type_name -> Cmd.ETradeType
	2,   // 120: Cmd.TradeInfo.logtype:type_name -> Cmd.EOperType
	54,  // 121: Cmd.TakeAllLogCmd.cmd:type_name -> Cmd.Command
	0,   // 122: Cmd.TakeAllLogCmd.param:type_name -> Cmd.RecordUserTradeParam
	48,  // 123: Cmd.TakeAllLogCmd.infos:type_name -> Cmd.TradeInfo
	54,  // 124: Cmd.QueryMergePriceRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 125: Cmd.QueryMergePriceRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	56,  // 126: Cmd.TradeItemPriceInfo.itemdata:type_name -> Cmd.ItemData
	54,  // 127: Cmd.QueryItemPriceRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 128: Cmd.QueryItemPriceRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	51,  // 129: Cmd.QueryItemPriceRecordTradeCmd.items:type_name -> Cmd.TradeItemPriceInfo
...
func file_RecordTrade_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_RecordTrade_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryMergePriceRecordTradeCmd); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_RecordTrade_proto_msgTypes[41].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TradeItemPriceInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_RecordTrade_proto_msgTypes[42].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryItemPriceRecordTradeCmd); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
