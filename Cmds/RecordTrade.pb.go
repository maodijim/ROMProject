...
const (
	RecordUserTradeParam_BRIEF_PENDING_LIST_RECORDTRADE  RecordUserTradeParam = 1 //请求简单的挂单列表
	...
	RecordUserTradeParam_MY_PENDING_LIST_RECORDTRADE     RecordUserTradeParam = 7 //我的出售列表
	RecordUserTradeParam_MY_TRADE_LOG_LIST_RECORDTRADE   RecordUserTradeParam = 9
	RecordUserTradeParam_REQ_SERVER_PRICE_RECORDTRADE    RecordUserTradeParam = 14 //请求服务器价格
	RecordUserTradeParam_BUY_ITEM_RECORDTRADE            RecordUserTradeParam = 15 //buy
	RecordUserTradeParam_SELL_ITEM_RECORDTRADE           RecordUserTradeParam = 20 //sell
	RecordUserTradeParam_CANCEL_PENDING_RECORDTRADE      RecordUserTradeParam = 22 //cancel 撤单包括已经过期的取回
	RecordUserTradeParam_RESELL_PENDING_RECORDTRADE      RecordUserTradeParam = 23 //重新挂单出售
	...
	RecordUserTradeParam_HOT_ITEMID_RECORDTRADE          RecordUserTradeParam = 26 //热门在售道具id列表
	RecordUserTradeParam_TAKE_LOG_TRADE_PARAM            RecordUserTradeParam = 27 //领取物品
	RecordUserTradeParam_ADD_NEWLOG_TRADE_PARAM          RecordUserTradeParam = 28 //新增一条新的领取
	RecordUserTradeParam_FETCH_NAMEINFO_TRADE_PARAM      RecordUserTradeParam = 29 //获取买卖详细信息
	RecordUserTradeParam_NTF_CAN_TAKE_COUNT_TRADE_PARAM  RecordUserTradeParam = 30 //可以领取的总个数
	RecordUserTradeParam_GIVE_TRADE_PARAM                RecordUserTradeParam = 31 //赠送
	RecordUserTradeParam_REQ_GIVE_ITEM_INFO_TRADE_PARAM  RecordUserTradeParam = 32 //请求赠送信息
	RecordUserTradeParam_ACCEPT_TRADE_PARAM              RecordUserTradeParam = 33 //签收礼物
	RecordUserTradeParam_REFUSE_TRADE_PARAM              RecordUserTradeParam = 34 //拒绝
	RecordUserTradeParam_CHECK_PACKAGE_SIZE_TRADE_CMD    RecordUserTradeParam = 35
	RecordUserTradeParam_QUICK_TAKE_LOG_TRADE_PARAM      RecordUserTradeParam = 36 //一键领取
	RecordUserTradeParam_QUERY_ITEM_COUNT_TRADE_PARAM    RecordUserTradeParam = 37 //快速购买请求物品个数
	RecordUserTradeParam_QUERY_LOTTERY_GIVE_TRADE_PARAM  RecordUserTradeParam = 38 //请求扭蛋赠送
	...
	RecordUserTradeParam_BOOTH_PLAYER_PENDING_LIST       RecordUserTradeParam = 41 //请求摊位订单列表
	RecordUserTradeParam_UPDATE_ORDER_TRADE_PARAM        RecordUserTradeParam = 42 //更新订单信息
)
...
const (
	...
	RankType_RANKTYPE_REFINE_LV_INC    RankType = 3 //精炼等级升序
...
const (
	EOperType_EOperType_PayPending           EOperType = 0  //待付款
	EOperType_EOperType_NormalSell           EOperType = 1  //普通出售
	EOperType_EOperType_NoramlBuy            EOperType = 2  //普通购买
	EOperType_EOperType_Publicity            EOperType = 3  //公示期
	EOperType_EOperType_PublicitySellSuccess EOperType = 4  //公示期出售成功
	EOperType_EOperType_PublicitySellFail    EOperType = 5  //公示期出售失败
	EOperType_EOperType_PublicityBuySuccess  EOperType = 6  //公示期购买成功
	EOperType_EOperType_PublicityBuyFail     EOperType = 7  //公示期购买失败
	EOperType_EOperType_PublicityBuying      EOperType = 8  //公示期正在购买
	EOperType_EOperType_AutoOffTheShelf      EOperType = 9  //自动下架
	EOperType_EOperType_PayFail              EOperType = 10 //付款失败
	EOperType_EOperType_PayTimeout           EOperType = 11 //付款超时
)
...
const (
	ETakeStatus_ETakeStatus_CanTakeGive     ETakeStatus = 0 //可领取可赠送         -- 可领取可赠送
	ETakeStatus_ETakeStatus_Took            ETakeStatus = 1 //已领取               -- 已领取
	ETakeStatus_ETakeStatus_Taking          ETakeStatus = 2 //正在领取             -- 已领取
	ETakeStatus_ETakeStatus_Giving          ETakeStatus = 3 //正在赠送             -- 赠送中
	ETakeStatus_ETakeStatus_Give_Accepting  ETakeStatus = 4 //赠送正在领取中       -- 赠送中
	ETakeStatus_ETakeStatus_Give_Accepted_1 ETakeStatus = 5 //赠送已经领取额度未扣 -- 已赠送
	ETakeStatus_ETakeStatus_Give_Accepted_2 ETakeStatus = 6 //赠送已经领取额度已扣 -- 已赠送
)
...
const (
	StateType_St_OverlapNormal    StateType = 1 //堆叠物品普通
	StateType_St_NonoverlapNormal StateType = 2 //非堆叠物品普通
	StateType_St_WillPublicity    StateType = 3 //物品将要公示期
	StateType_St_InPublicity      StateType = 4 //物品正在公示期
)
...
type SearchCond struct {
	...
	PageIndex *uint32     `protobuf:"varint,7,opt,name=page_index,json=pageIndex" json:"page_index,omitempty"` //0
...
type BriefPendingListRecordTradeCmd struct {
	...
	PubLists []uint32              `protobuf:"varint,7,rep,name=pub_lists,json=pubLists" json:"pub_lists,omitempty"` //公示期 itemid 列表
	Lists    []uint32              `protobuf:"varint,8,rep,name=lists" json:"lists,omitempty"`                       //itemid 列表
}
...
type DetailPendingListRecordTradeCmd struct {
	...
	TotalPageCount *uint32               `protobuf:"varint,6,opt,name=total_page_count,json=totalPageCount" json:"total_page_count,omitempty"` //列表总页数
}
...
type BriefBuyInfo struct {
	...
	Name *string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`  //购买者名字
	Time *uint32 `protobuf:"varint,2,opt,name=time" json:"time,omitempty"` //购买时间
}
...
type ItemSellInfoRecordTradeCmd struct {
	...
	Count       *uint32               `protobuf:"varint,8,opt,name=count,def=0" json:"count,omitempty"`                             //交易所数量
	BuyerCount  *uint32               `protobuf:"varint,9,opt,name=buyer_count,json=buyerCount,def=0" json:"buyer_count,omitempty"` //购买人数
	BuyInfo     []*BriefBuyInfo       `protobuf:"bytes,10,rep,name=buy_info,json=buyInfo" json:"buy_info,omitempty"`                //最近被购买的情况
	...
	Quota       *uint64               `protobuf:"varint,13,opt,name=quota" json:"quota,omitempty"` // 订单额度单价
}
...
type NameInfo struct {
	...
	Name   *string `protobuf:"bytes,1,opt,name=name" json:"name,omitempty"`      //姓名
	Zoneid *uint32 `protobuf:"varint,2,opt,name=zoneid" json:"zoneid,omitempty"` //线id
	Count  *uint32 `protobuf:"varint,3,opt,name=count" json:"count,omitempty"`   //个数
}
...
type LogItemInfo struct {
	...
	Status       *ETakeStatus  `protobuf:"varint,2,opt,name=status,enum=Cmd.ETakeStatus" json:"status,omitempty"` //领取装备
	Logtype      *EOperType    `protobuf:"varint,3,opt,name=logtype,enum=Cmd.EOperType" json:"logtype,omitempty"` //日志类型
	Itemid       *uint32       `protobuf:"varint,4,opt,name=itemid" json:"itemid,omitempty"`
	RefineLv     *uint32       `protobuf:"varint,5,opt,name=refine_lv,json=refineLv" json:"refine_lv,omitempty"`                //精炼等级
	Damage       *bool         `protobuf:"varint,6,opt,name=damage" json:"damage,omitempty"`                                    //是否损坏
	Tradetime    *uint32       `protobuf:"varint,7,opt,name=tradetime" json:"tradetime,omitempty"`                              //交易时间
	Count        *uint32       `protobuf:"varint,8,opt,name=count" json:"count,omitempty"`                                      //成功的个数
	Price        *uint32       `protobuf:"varint,20,opt,name=price" json:"price,omitempty"`                                     //单价
	Tax          *uint32       `protobuf:"varint,9,opt,name=tax" json:"tax,omitempty"`                                          //出售扣费
	Getmoney     *uint32       `protobuf:"varint,10,opt,name=getmoney" json:"getmoney,omitempty"`                               //出售获得的总钱
	Costmoney    *uint32       `protobuf:"varint,11,opt,name=costmoney" json:"costmoney,omitempty"`                             //购买花费
	Failcount    *uint32       `protobuf:"varint,12,opt,name=failcount" json:"failcount,omitempty"`                             //公示期购买失败的个数
	Retmoney     *uint32       `protobuf:"varint,13,opt,name=retmoney" json:"retmoney,omitempty"`                               //公示期抢购退款
	Totalcount   *uint32       `protobuf:"varint,14,opt,name=totalcount" json:"totalcount,omitempty"`                           //公示期总抢购个数
	Endtime      *uint32       `protobuf:"varint,15,opt,name=endtime" json:"endtime,omitempty"`                                 //公示期结束时间
	NameInfo     *NameInfo     `protobuf:"bytes,16,opt,name=name_info,json=nameInfo" json:"name_info,omitempty"`                //一个名字
	IsManyPeople *bool         `protobuf:"varint,17,opt,name=is_many_people,json=isManyPeople" json:"is_many_people,omitempty"` //是否有多人
	NameList     *NameInfoList `protobuf:"bytes,18,opt,name=name_list,json=nameList" json:"name_list,omitempty"`                //所有的名字列表 服务端本地存储
	Itemdata     *ItemData     `protobuf:"bytes,19,opt,name=itemdata" json:"itemdata,omitempty"`                                //服务端本地存储
	// 赠送相关
	Receiverid     *uint64     `protobuf:"varint,21,opt,name=receiverid" json:"receiverid,omitempty"`          //赠送接收者id
	Receivername   *string     `protobuf:"bytes,22,opt,name=receivername" json:"receivername,omitempty"`       //赠送接受者姓名
	Receiverzoneid *uint32     `protobuf:"varint,23,opt,name=receiverzoneid" json:"receiverzoneid,omitempty"`  //赠送接收者线
	Quota          *uint64     `protobuf:"varint,24,opt,name=quota" json:"quota,omitempty"`                    //赠送花费额度
	Background     *uint32     `protobuf:"varint,25,opt,name=background" json:"background,omitempty"`          //赠送背景色
	Expiretime     *uint32     `protobuf:"varint,26,opt,name=expiretime" json:"expiretime,omitempty"`          //赠送超时时间
	RetCost        *uint32     `protobuf:"varint,27,opt,name=ret_cost,json=retCost" json:"ret_cost,omitempty"` //自动下架返回上架费
	Cangive        *bool       `protobuf:"varint,28,opt,name=cangive" json:"cangive,omitempty"`                //是否可以赠送  tradetime 没过期并且 cangive=true 才显示赠送按钮
...
func (x *LogItemInfo) GetPrice() uint32 {
...
func (x *LogItemInfo) GetTax() uint32 {
	if x != nil && x.Tax != nil {
		return *x.Tax
	}
	return 0
...
func (x *LogItemInfo) GetGetmoney() uint32 {
...
func (x *LogItemInfo) GetCostmoney() uint32 {
...
func (x *LogItemInfo) GetRetmoney() uint32 {
...
func (x *LogItemInfo) GetRetCost() uint32 {
...
type FetchNameInfoCmd struct {
	...
	Index          *uint32               `protobuf:"varint,5,opt,name=index" json:"index,omitempty"`                                           //页索引 第一页是 0
	TotalPageCount *uint32               `protobuf:"varint,6,opt,name=total_page_count,json=totalPageCount" json:"total_page_count,omitempty"` //总页数
...
type ReqServerPriceRecordTradeCmd struct {
	...
	Issell     *bool       `protobuf:"varint,6,opt,name=issell,def=0" json:"issell,omitempty"` //是否上架
	Statetype  *StateType  `protobuf:"varint,7,opt,name=statetype,enum=Cmd.StateType" json:"statetype,omitempty"`
	Count      *uint32     `protobuf:"varint,8,opt,name=count,def=0" json:"count,omitempty"`                                               //交易所数量
	BuyerCount *uint32     `protobuf:"varint,9,opt,name=buyer_count,json=buyerCount,def=0" json:"buyer_count,omitempty"`                   //购买人数
	EndTime    *uint32     `protobuf:"varint,10,opt,name=end_time,json=endTime,def=0" json:"end_time,omitempty"`                           //公示期结束时间
	TradeType  *ETradeType `protobuf:"varint,11,opt,name=trade_type,json=tradeType,enum=Cmd.ETradeType,def=1" json:"trade_type,omitempty"` // 交易类型
}
...
func (x *ReqServerPriceRecordTradeCmd) GetPrice() uint32 {
	if x != nil && x.Price != nil {
		return *x.Price
	}
	return 0
...
type HotItemidRecordTrade struct {
	...
	PubLists []uint32              `protobuf:"varint,5,rep,name=pub_lists,json=pubLists" json:"pub_lists,omitempty"` //公示期 itemid 列表
	Lists    []uint32              `protobuf:"varint,6,rep,name=lists" json:"lists,omitempty"`                       //itemid 列表
}
...
type GiveTradeCmd struct {
	...
	Id         *uint64               `protobuf:"varint,3,opt,name=id" json:"id,omitempty"`                              //唯一id
	Logtype    *EOperType            `protobuf:"varint,4,opt,name=logtype,enum=Cmd.EOperType" json:"logtype,omitempty"` //日志类型
	Friendid   *uint64               `protobuf:"varint,5,opt,name=friendid" json:"friendid,omitempty"`                  //好友的id
	Content    *string               `protobuf:"bytes,6,opt,name=content" json:"content,omitempty"`                     //留言内容
	Anonymous  *bool                 `protobuf:"varint,7,opt,name=anonymous" json:"anonymous,omitempty"`                //是否匿名
	Background *uint32               `protobuf:"varint,8,opt,name=background" json:"background,omitempty"`              //背景色
	// res
...
type GiveItemInfo struct {
	...
	Id           *uint64      `protobuf:"varint,1,opt,name=id" json:"id,omitempty"`                              //唯一id
	Status       *ETakeStatus `protobuf:"varint,2,opt,name=status,enum=Cmd.ETakeStatus" json:"status,omitempty"` //领取状态
...
type LotteryGiveInfo struct {
	...
	Count      *uint32 `protobuf:"varint,3,opt,name=count" json:"count,omitempty"`           //购买个数
	Content    *string `protobuf:"bytes,4,opt,name=content" json:"content,omitempty"`        //祝福内容
	Configid   *uint32 `protobuf:"varint,5,opt,name=configid" json:"configid,omitempty"`     //祝福内容的configid
	Receiverid *uint64 `protobuf:"varint,6,opt,name=receiverid" json:"receiverid,omitempty"` //接收者角色id
}
...
var file_RecordTrade_proto_rawDesc = []byte{
	...
	0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x14, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x05, 0x70, 0x72,
	0x69, 0x63, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x61, 0x78, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x03, 0x74, 0x61, 0x78, 0x12, 0x1a, 0x0a, 0x08, 0x67, 0x65, 0x74, 0x6d, 0x6f, 0x6e, 0x65,
	0x79, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x67, 0x65, 0x74, 0x6d, 0x6f, 0x6e, 0x65,
	0x79, 0x12, 0x1c, 0x0a, 0x09, 0x63, 0x6f, 0x73, 0x74, 0x6d, 0x6f, 0x6e, 0x65, 0x79, 0x18, 0x0b,
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x63, 0x6f, 0x73, 0x74, 0x6d, 0x6f, 0x6e, 0x65, 0x79, 0x12,
	...
	0x08, 0x72, 0x65, 0x74, 0x6d, 0x6f, 0x6e, 0x65, 0x79, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x20, 0x01, 0x28, 0x0d, 0x52, 0x07, 0x72, 0x65, 0x74, 0x43, 0x6f, 0x73, 0x74, 0x12, 0x18, 0x0a,
	...
	0x0d, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x1d, 0x0a, 0x06, 0x69, 0x73, 0x73, 0x65,
	...
	0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0xfd, 0x02, 0x0a, 0x15, 0x43, 0x61, 0x6e, 0x63, 0x65,
	...
	,
	...
	0x61, 0x72, 0x61, 0x6d, 0x3a, 0x11, 0x50, 0x41, 0x4e, 0x45, 0x4c, 0x5f, 0x52, 0x45, 0x43, 0x4f,
	...
	0x63, 0x68, 0x61, 0x72, 0x69, 0x64, 0x12, 0x27, 0x0a, 0x04, 0x6f, 0x70, 0x65, 0x72, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x45, 0x50, 0x61, 0x6e, 0x65,
	0x6c, 0x4f, 0x70, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x6f, 0x70, 0x65, 0x72, 0x12,
	0x40, 0x0a, 0x0a, 0x74, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20,
	...
	0x65, 0x22, 0x98, 0x02, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x4e, 0x74, 0x66, 0x52, 0x65, 0x63,
	0x6f, 0x72, 0x64, 0x54, 0x72, 0x61, 0x64, 0x65, 0x12, 0x3a, 0x0a, 0x03, 0x63, 0x6d, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x43, 0x6f, 0x6d, 0x6d,
	0x61, 0x6e, 0x64, 0x3a, 0x1a, 0x52, 0x45, 0x43, 0x4f, 0x52, 0x44, 0x5f, 0x55, 0x53, 0x45, 0x52,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0xbb,
	0x01, 0x0a, 0x0e, 0x52, 0x65, 0x66, 0x75, 0x73, 0x65, 0x54, 0x72, 0x61, 0x64, 0x65, 0x43, 0x6d,
	...
	0x64, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a, 0x12, 0x52, 0x45, 0x46, 0x55, 0x53, 0x45, 0x5f,
	0x54, 0x52, 0x41, 0x44, 0x45, 0x5f, 0x50, 0x41, 0x52, 0x41, 0x4d, 0x52, 0x05, 0x70, 0x61, 0x72,
	0x61, 0x6d, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02,
	0x69, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x8f, 0x03, 0x0a,
	0x0c, 0x47, 0x69, 0x76, 0x65, 0x49, 0x74, 0x65, 0x6d, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a,
	...
	0x43, 0x6d, 0x64, 0x2e, 0x45, 0x54, 0x61, 0x6b, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x69, 0x74, 0x65, 0x6d, 0x69,
	...
	,
	...
	,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x19, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x52, 0x65, 0x63, 0x6f, 0x72,
	0x64, 0x55, 0x73, 0x65, 0x72, 0x54, 0x72, 0x61, 0x64, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a,
	0x1a, 0x51, 0x55, 0x49, 0x43, 0x4b, 0x5f, 0x54, 0x41, 0x4b, 0x45, 0x5f, 0x4c, 0x4f, 0x47, 0x5f,
	0x54, 0x52, 0x41, 0x44, 0x45, 0x5f, 0x50, 0x41, 0x52, 0x41, 0x4d, 0x52, 0x05, 0x70, 0x61, 0x72,
	0x61, 0x6d, 0x12, 0x40, 0x0a, 0x0a, 0x74, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0f, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x45, 0x54, 0x72,
	...
	0x54, 0x79, 0x70, 0x65, 0x22, 0x39, 0x0a, 0x09, 0x49, 0x74, 0x65, 0x6d, 0x43, 0x6f, 0x75, 0x6e,
	...
	0x96, 0x02, 0x0a, 0x16, 0x51, 0x75, 0x65, 0x72, 0x79, 0x49, 0x74, 0x65, 0x6d, 0x43, 0x6f, 0x75,
	0x6e, 0x74, 0x54, 0x72, 0x61, 0x64, 0x65, 0x43, 0x6d, 0x64, 0x12, 0x3a, 0x0a, 0x03, 0x63, 0x6d,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x43, 0x6f,
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x3a, 0x1a, 0x52, 0x45, 0x43, 0x4f, 0x52, 0x44, 0x5f, 0x55, 0x53,
	0x45, 0x52, 0x5f, 0x54, 0x52, 0x41, 0x44, 0x45, 0x5f, 0x50, 0x52, 0x4f, 0x54, 0x4f, 0x43, 0x4d,
	...
	,
	...
	,
	...
	,
}
...
var file_RecordTrade_proto_enumTypes = make([]protoimpl.EnumInfo, 9)
var file_RecordTrade_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_RecordTrade_proto_goTypes = []interface{}{
	...
	(EFinanceDateType)(0),                   // 7: Cmd.EFinanceDateType
	(EFinanceRankType)(0),                   // 8: Cmd.EFinanceRankType
	(*SearchCond)(nil),                      // 9: Cmd.SearchCond
	(*BriefPendingListRecordTradeCmd)(nil),  // 10: Cmd.BriefPendingListRecordTradeCmd
	(*DetailPendingListRecordTradeCmd)(nil), // 11: Cmd.DetailPendingListRecordTradeCmd
	(*BriefBuyInfo)(nil),                    // 12: Cmd.BriefBuyInfo
	(*ItemSellInfoRecordTradeCmd)(nil),      // 13: Cmd.ItemSellInfoRecordTradeCmd
	(*MyPendingListRecordTradeCmd)(nil),     // 14: Cmd.MyPendingListRecordTradeCmd
	(*NameInfo)(nil),                        // 15: Cmd.NameInfo
	(*NameInfoList)(nil),                    // 16: Cmd.NameInfoList
	(*LogItemInfo)(nil),                     // 17: Cmd.LogItemInfo
	(*MyTradeLogRecordTradeCmd)(nil),        // 18: Cmd.MyTradeLogRecordTradeCmd
	(*TakeLogCmd)(nil),                      // 19: Cmd.TakeLogCmd
	(*AddNewLog)(nil),                       // 20: Cmd.AddNewLog
	(*FetchNameInfoCmd)(nil),                // 21: Cmd.FetchNameInfoCmd
	(*ReqServerPriceRecordTradeCmd)(nil),    // 22: Cmd.ReqServerPriceRecordTradeCmd
	(*BuyItemRecordTradeCmd)(nil),           // 23: Cmd.BuyItemRecordTradeCmd
	(*SellItemRecordTradeCmd)(nil),          // 24: Cmd.SellItemRecordTradeCmd
	(*CancelItemRecordTrade)(nil),           // 25: Cmd.CancelItemRecordTrade
	(*ResellPendingRecordTrade)(nil),        // 26: Cmd.ResellPendingRecordTrade
	(*PanelRecordTrade)(nil),                // 27: Cmd.PanelRecordTrade
	(*ListNtfRecordTrade)(nil),              // 28: Cmd.ListNtfRecordTrade
	(*HotItemidRecordTrade)(nil),            // 29: Cmd.HotItemidRecordTrade
	(*NtfCanTakeCountTradeCmd)(nil),         // 30: Cmd.NtfCanTakeCountTradeCmd
	(*GiveTradeCmd)(nil),                    // 31: Cmd.GiveTradeCmd
	(*AcceptTradeCmd)(nil),                  // 32: Cmd.AcceptTradeCmd
	(*RefuseTradeCmd)(nil),                  // 33: Cmd.RefuseTradeCmd
	(*GiveItemInfo)(nil),                    // 34: Cmd.GiveItemInfo
	(*ReqGiveItemInfoCmd)(nil),              // 35: Cmd.ReqGiveItemInfoCmd
	(*CheckPackageSizeTradeCmd)(nil),        // 36: Cmd.CheckPackageSizeTradeCmd
	(*QucikTakeLogTradeCmd)(nil),            // 37: Cmd.QucikTakeLogTradeCmd
	(*ItemCount)(nil),                       // 38: Cmd.ItemCount
	(*QueryItemCountTradeCmd)(nil),          // 39: Cmd.QueryItemCountTradeCmd
	(*LotteryGiveInfo)(nil),                 // 40: Cmd.LotteryGiveInfo
	(*LotteryGiveCmd)(nil),                  // 41: Cmd.LotteryGiveCmd
	(*TodayFinanceItem)(nil),                // 42: Cmd.TodayFinanceItem
	(*TodayFinanceRank)(nil),                // 43: Cmd.TodayFinanceRank
	(*TodayFinanceDetail)(nil),              // 44: Cmd.TodayFinanceDetail
	(*BoothPlayerPendingListCmd)(nil),       // 45: Cmd.BoothPlayerPendingListCmd
	(*UpdateOrderTradeCmd)(nil),             // 46: Cmd.UpdateOrderTradeCmd
	(ETradeType)(0),                         // 47: Cmd.ETradeType
	(Command)(0),                            // 48: Cmd.Command
	(*TradeItemBaseInfo)(nil),               // 49: Cmd.TradeItemBaseInfo
	(*ItemData)(nil),                        // 50: Cmd.ItemData
	(ETRADE_RET_CODE)(0),                    // 51: Cmd.ETRADE_RET_CODE
	(*ItemInfo)(nil),                        // 52: Cmd.ItemInfo
}
var file_RecordTrade_proto_depIdxs = []int32{
	1,   // 0: Cmd.SearchCond.rank_type:type_name -> Cmd.RankType
	47,  // 1: Cmd.SearchCond.trade_type:type_name -> Cmd.ETradeType
	48,  // 2: Cmd.BriefPendingListRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 3: Cmd.BriefPendingListRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	48,  // 4: Cmd.DetailPendingListRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 5: Cmd.DetailPendingListRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	9,   // 6: Cmd.DetailPendingListRecordTradeCmd.search_cond:type_name -> Cmd.SearchCond
	49,  // 7: Cmd.DetailPendingListRecordTradeCmd.lists:type_name -> Cmd.TradeItemBaseInfo
	48,  // 8: Cmd.ItemSellInfoRecordTradeCmd.cmd:type_name -> Cmd.Command
	...
	12,  // 11: Cmd.ItemSellInfoRecordTradeCmd.buy_info:type_name -> Cmd.BriefBuyInfo
	47,  // 12: Cmd.ItemSellInfoRecordTradeCmd.type:type_name -> Cmd.ETradeType
	48,  // 13: Cmd.MyPendingListRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 14: Cmd.MyPendingListRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	9,   // 15: Cmd.MyPendingListRecordTradeCmd.search_cond:type_name -> Cmd.SearchCond
	49,  // 16: Cmd.MyPendingListRecordTradeCmd.lists:type_name -> Cmd.TradeItemBaseInfo
	15,  // 17: Cmd.NameInfoList.name_infos:type_name -> Cmd.NameInfo
	3,   // 18: Cmd.LogItemInfo.status:type_name -> Cmd.ETakeStatus
	2,   // 19: Cmd.LogItemInfo.logtype:type_name -> Cmd.EOperType
	15,  // 20: Cmd.LogItemInfo.name_info:type_name -> Cmd.NameInfo
	16,  // 21: Cmd.LogItemInfo.name_list:type_name -> Cmd.NameInfoList
	50,  // 22: Cmd.LogItemInfo.itemdata:type_name -> Cmd.ItemData
	47,  // 23: Cmd.LogItemInfo.trade_type:type_name -> Cmd.ETradeType
	48,  // 24: Cmd.MyTradeLogRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 25: Cmd.MyTradeLogRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	17,  // 26: Cmd.MyTradeLogRecordTradeCmd.log_list:type_name -> Cmd.LogItemInfo
	47,  // 27: Cmd.MyTradeLogRecordTradeCmd.trade_type:type_name -> Cmd.ETradeType
	48,  // 28: Cmd.TakeLogCmd.cmd:type_name -> Cmd.Command
	0,   // 29: Cmd.TakeLogCmd.param:type_name -> Cmd.RecordUserTradeParam
	17,  // 30: Cmd.TakeLogCmd.log:type_name -> Cmd.LogItemInfo
	48,  // 31: Cmd.AddNewLog.cmd:type_name -> Cmd.Command
	0,   // 32: Cmd.AddNewLog.param:type_name -> Cmd.RecordUserTradeParam
	17,  // 33: Cmd.AddNewLog.log:type_name -> Cmd.LogItemInfo
	48,  // 34: Cmd.FetchNameInfoCmd.cmd:type_name -> Cmd.Command
	0,   // 35: Cmd.FetchNameInfoCmd.param:type_name -> Cmd.RecordUserTradeParam
	2,   // 36: Cmd.FetchNameInfoCmd.type:type_name -> Cmd.EOperType
	16,  // 37: Cmd.FetchNameInfoCmd.name_list:type_name -> Cmd.NameInfoList
	48,  // 38: Cmd.ReqServerPriceRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 39: Cmd.ReqServerPriceRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	50,  // 40: Cmd.ReqServerPriceRecordTradeCmd.itemData:type_name -> Cmd.ItemData
	4,   // 41: Cmd.ReqServerPriceRecordTradeCmd.statetype:type_name -> Cmd.StateType
	47,  // 42: Cmd.ReqServerPriceRecordTradeCmd.trade_type:type_name -> Cmd.ETradeType
	48,  // 43: Cmd.BuyItemRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 44: Cmd.BuyItemRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	49,  // 45: Cmd.BuyItemRecordTradeCmd.item_info:type_name -> Cmd.TradeItemBaseInfo
	51,  // 46: Cmd.BuyItemRecordTradeCmd.ret:type_name -> Cmd.ETRADE_RET_CODE
	47,  // 47: Cmd.BuyItemRecordTradeCmd.type:type_name -> Cmd.ETradeType
	48,  // 48: Cmd.SellItemRecordTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 49: Cmd.SellItemRecordTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	49,  // 50: Cmd.SellItemRecordTradeCmd.item_info:type_name -> Cmd.TradeItemBaseInfo
	51,  // 51: Cmd.SellItemRecordTradeCmd.ret:type_name -> Cmd.ETRADE_RET_CODE
	47,  // 52: Cmd.SellItemRecordTradeCmd.type:type_name -> Cmd.ETradeType
	48,  // 53: Cmd.CancelItemRecordTrade.cmd:type_name -> Cmd.Command
	0,   // 54: Cmd.CancelItemRecordTrade.param:type_name -> Cmd.RecordUserTradeParam
	49,  // 55: Cmd.CancelItemRecordTrade.item_info:type_name -> Cmd.TradeItemBaseInfo
	51,  // 56: Cmd.CancelItemRecordTrade.ret:type_name -> Cmd.ETRADE_RET_CODE
	47,  // 57: Cmd.CancelItemRecordTrade.type:type_name -> Cmd.ETradeType
	48,  // 58: Cmd.ResellPendingRecordTrade.cmd:type_name -> Cmd.Command
	0,   // 59: Cmd.ResellPendingRecordTrade.param:type_name -> Cmd.RecordUserTradeParam
	49,  // 60: Cmd.ResellPendingRecordTrade.item_info:type_name -> Cmd.TradeItemBaseInfo
	51,  // 61: Cmd.ResellPendingRecordTrade.ret:type_name -> Cmd.ETRADE_RET_CODE
	47,  // 62: Cmd.ResellPendingRecordTrade.type:type_name -> Cmd.ETradeType
	48,  // 63: Cmd.PanelRecordTrade.cmd:type_name -> Cmd.Command
	...
	47,  // 66: Cmd.PanelRecordTrade.trade_type:type_name -> Cmd.ETradeType
	48,  // 67: Cmd.ListNtfRecordTrade.cmd:type_name -> Cmd.Command
	...
	47,  // 70: Cmd.ListNtfRecordTrade.trade_type:type_name -> Cmd.ETradeType
	48,  // 71: Cmd.HotItemidRecordTrade.cmd:type_name -> Cmd.Command
	0,   // 72: Cmd.HotItemidRecordTrade.param:type_name -> Cmd.RecordUserTradeParam
	48,  // 73: Cmd.NtfCanTakeCountTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 74: Cmd.NtfCanTakeCountTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	47,  // 75: Cmd.NtfCanTakeCountTradeCmd.trade_type:type_name -> Cmd.ETradeType
	48,  // 76: Cmd.GiveTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 77: Cmd.GiveTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	2,   // 78: Cmd.GiveTradeCmd.logtype:type_name -> Cmd.EOperType
	48,  // 79: Cmd.AcceptTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 80: Cmd.AcceptTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	48,  // 81: Cmd.RefuseTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 82: Cmd.RefuseTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	3,   // 83: Cmd.GiveItemInfo.status:type_name -> Cmd.ETakeStatus
	50,  // 84: Cmd.GiveItemInfo.itemdata:type_name -> Cmd.ItemData
	48,  // 85: Cmd.ReqGiveItemInfoCmd.cmd:type_name -> Cmd.Command
	0,   // 86: Cmd.ReqGiveItemInfoCmd.param:type_name -> Cmd.RecordUserTradeParam
	34,  // 87: Cmd.ReqGiveItemInfoCmd.iteminfo:type_name -> Cmd.GiveItemInfo
	48,  // 88: Cmd.CheckPackageSizeTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 89: Cmd.CheckPackageSizeTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	52,  // 90: Cmd.CheckPackageSizeTradeCmd.items:type_name -> Cmd.ItemInfo
	48,  // 91: Cmd.QucikTakeLogTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 92: Cmd.QucikTakeLogTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	47,  // 93: Cmd.QucikTakeLogTradeCmd.trade_type:type_name -> Cmd.ETradeType
	48,  // 94: Cmd.QueryItemCountTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 95: Cmd.QueryItemCountTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	38,  // 96: Cmd.QueryItemCountTradeCmd.items:type_name -> Cmd.ItemCount
	49,  // 97: Cmd.QueryItemCountTradeCmd.res_items:type_name -> Cmd.TradeItemBaseInfo
	48,  // 98: Cmd.LotteryGiveCmd.cmd:type_name -> Cmd.Command
	0,   // 99: Cmd.LotteryGiveCmd.param:type_name -> Cmd.RecordUserTradeParam
	40,  // 100: Cmd.LotteryGiveCmd.iteminfo:type_name -> Cmd.LotteryGiveInfo
	48,  // 101: Cmd.TodayFinanceRank.cmd:type_name -> Cmd.Command
	0,   // 102: Cmd.TodayFinanceRank.param:type_name -> Cmd.RecordUserTradeParam
	8,   // 103: Cmd.TodayFinanceRank.rank_type:type_name -> Cmd.EFinanceRankType
	7,   // 104: Cmd.TodayFinanceRank.date_type:type_name -> Cmd.EFinanceDateType
	42,  // 105: Cmd.TodayFinanceRank.lists:type_name -> Cmd.TodayFinanceItem
	48,  // 106: Cmd.TodayFinanceDetail.cmd:type_name -> Cmd.Command
	0,   // 107: Cmd.TodayFinanceDetail.param:type_name -> Cmd.RecordUserTradeParam
	8,   // 108: Cmd.TodayFinanceDetail.rank_type:type_name -> Cmd.EFinanceRankType
	7,   // 109: Cmd.TodayFinanceDetail.date_type:type_name -> Cmd.EFinanceDateType
	42,  // 110: Cmd.TodayFinanceDetail.lists:type_name -> Cmd.TodayFinanceItem
	48,  // 111: Cmd.BoothPlayerPendingListCmd.cmd:type_name -> Cmd.Command
	0,   // 112: Cmd.BoothPlayerPendingListCmd.param:type_name -> Cmd.RecordUserTradeParam
	49,  // 113: Cmd.BoothPlayerPendingListCmd.lists:type_name -> Cmd.TradeItemBaseInfo
	48,  // 114: Cmd.UpdateOrderTradeCmd.cmd:type_name -> Cmd.Command
	0,   // 115: Cmd.UpdateOrderTradeCmd.param:type_name -> Cmd.RecordUserTradeParam
	49,  // 116: Cmd.UpdateOrderTradeCmd.info:type_name -> Cmd.TradeItemBaseInfo
	47,  // 117: Cmd.UpdateOrderTradeCmd.type:type_name -> Cmd.ETradeType
