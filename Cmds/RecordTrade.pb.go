...
type LogItemInfo struct {
	...
	Price          *uint32       `protobuf:"varint,20,opt,name=price" json:"price,omitempty"`
	Tax            *uint32       `protobuf:"varint,9,opt,name=tax" json:"tax,omitempty"`
	Getmoney       *uint32       `protobuf:"varint,10,opt,name=getmoney" json:"getmoney,omitempty"`
	Costmoney      *uint32       `protobuf:"varint,11,opt,name=costmoney" json:"costmoney,omitempty"`
	Failcount      *uint32       `protobuf:"varint,12,opt,name=failcount" json:"failcount,omitempty"`
	Retmoney       *uint32       `protobuf:"varint,13,opt,name=retmoney" json:"retmoney,omitempty"`
	...
	RetCost        *uint32       `protobuf:"varint,27,opt,name=ret_cost,json=retCost" json:"ret_cost,omitempty"`
