...
const (
	...
	EAstrolabeType_EASTROLABETYPE_MAX        EAstrolabeType = 2
)
...
type AstrolabeQueryCmd struct {
	...
	Stars []uint32        `protobuf:"varint,3,rep,name=stars" json:"stars,omitempty"` // 已激活星盘星位, 星盘id*10000+星位id
}
...
type AstrolabeActivateStarCmd struct {
	...
	Stars   []uint32        `protobuf:"varint,3,rep,name=stars" json:"stars,omitempty"`     // 星盘id*10000+星位id
	Success *bool           `protobuf:"varint,5,opt,name=success" json:"success,omitempty"` // 服务器返回, true表示成功
}
...
type AstrolabeQueryResetCmd struct {
	...
	Type  *EAstrolabeType      `protobuf:"varint,3,opt,name=type,enum=Cmd.EAstrolabeType" json:"type,omitempty"` // 星盘类型
	Items []*AstrolabeCostData `protobuf:"bytes,4,rep,name=items" json:"items,omitempty"`                        // 服务器返回, 返回道具列表
}
...
type AstrolabeResetCmd struct {
	...
	Stars   []uint32        `protobuf:"varint,3,rep,name=stars" json:"stars,omitempty"`     // 星盘id*10000+星位id
	Success *bool           `protobuf:"varint,4,opt,name=success" json:"success,omitempty"` // 服务器返回, true表示成功
}
...
var file_AstrolabeCmd_proto_rawDesc = []byte{
	...
	0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xa9, 0x01, 0x0a, 0x11, 0x41, 0x73, 0x74, 0x72, 0x6f,
	...
	0x72, 0x73, 0x22, 0xd2, 0x01, 0x0a, 0x18, 0x41, 0x73, 0x74, 0x72, 0x6f, 0x6c, 0x61, 0x62, 0x65,
	0x41, 0x63, 0x74, 0x69, 0x76, 0x61, 0x74, 0x65, 0x53, 0x74, 0x61, 0x72, 0x43, 0x6d, 0x64, 0x12,
	0x3d, 0x0a, 0x03, 0x63, 0x6d, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c, 0x2e, 0x43,
	0x6d, 0x64, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x3a, 0x1d, 0x53, 0x43, 0x45, 0x4e,
	0x45, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x41, 0x53, 0x54, 0x52, 0x4f, 0x4c, 0x41, 0x42, 0x45,
	...
	,
	...
	0x53, 0x53, 0x49, 0x4f, 0x4e, 0x10, 0x01, 0x12, 0x16, 0x0a, 0x12, 0x45, 0x41, 0x53, 0x54, 0x52,
	0x4f, 0x4c, 0x41, 0x42, 0x45, 0x54, 0x59, 0x50, 0x45, 0x5f, 0x4d, 0x41, 0x58, 0x10, 0x02,
}
...
var file_AstrolabeCmd_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
...
var file_AstrolabeCmd_proto_depIdxs = []int32{
	7,  // 0: Cmd.AstrolabeQueryCmd.cmd:type_name -> Cmd.Command
	0,  // 1: Cmd.AstrolabeQueryCmd.param:type_name -> Cmd.AstrolabeParam
	7,  // 2: Cmd.AstrolabeActivateStarCmd.cmd:type_name -> Cmd.Command
	0,  // 3: Cmd.AstrolabeActivateStarCmd.param:type_name -> Cmd.AstrolabeParam
	7,  // 4: Cmd.AstrolabeQueryResetCmd.cmd:type_name -> Cmd.Command
	0,  // 5: Cmd.AstrolabeQueryResetCmd.param:type_name -> Cmd.AstrolabeParam
	1,  // 6: Cmd.AstrolabeQueryResetCmd.type:type_name -> Cmd.EAstrolabeType
	2,  // 7: Cmd.AstrolabeQueryResetCmd.items:type_name -> Cmd.AstrolabeCostData
	7,  // 8: Cmd.AstrolabeResetCmd.cmd:type_name -> Cmd.Command
	0,  // 9: Cmd.AstrolabeResetCmd.param:type_name -> Cmd.AstrolabeParam
