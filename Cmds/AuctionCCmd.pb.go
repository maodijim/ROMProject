...
const (
	...
	AuctionCParam_AUCTIONCPARAM_NTF_MY_SIGNUP_INFO          AuctionCParam = 14 //推送我自己的报名信息
	AuctionCParam_AUCTIONCPARAM_NTF_MY_OFFERPRICE           AuctionCParam = 15 //推送我自己的竞拍价格
	AuctionCParam_AUCTIONCPARAM_NTF_NEXT_AUCTION_INFO       AuctionCParam = 16 //推送我下一个拍品信息
	AuctionCParam_AUCTIONCPARAM_REQ_ACUTION_INFO            AuctionCParam = 17 //请求拍卖行状态信息
	AuctionCParam_AUCTIONCPARAM_NTF_CUR_AUCTION_INFO        AuctionCParam = 18 //推送正在拍卖的物品id给全服所有玩家
	AuctionCParam_AUCTIONCPARAM_NTF_OVERTAKE_PRICE          AuctionCParam = 19 //通知玩家价格被超过了
	AuctionCParam_AUCTIONCPARAM_REQ_MY_TRADED_PRICE         AuctionCParam = 20 //请求我的拍卖交易完成后的出价
	AuctionCParam_AUCTIONCPARAM_NTF_MASK_PRICE              AuctionCParam = 21 //通知出价档禁止信息
	AuctionCParam_AUTIONCPARAM_AUCTION_DIALOG               AuctionCParam = 22 //通知竞拍dialog信息
)
...
const (
	EAuctionState_EAuctionState_Close            EAuctionState = 1 //关闭
	EAuctionState_EAuctionState_SignUp           EAuctionState = 2 //报名
	EAuctionState_EAuctionState_SignUpVerify     EAuctionState = 3 //报名审核
	EAuctionState_EAuctionState_AuctionPublicity EAuctionState = 6 //公示期
	EAuctionState_EAuctionState_Auction          EAuctionState = 4 //竞拍
	EAuctionState_EAuctionState_AuctionEnd       EAuctionState = 5 //竞拍结束
)
...
const (
	...
	EAuctionResult_EAuctionResult_Fail      EAuctionResult = 1 //竞拍失败，流拍
	EAuctionResult_EAuctionResult_Sucess    EAuctionResult = 2 //竞拍成功
	EAuctionResult_EAuctionResult_AtAuction EAuctionResult = 3 //拍卖中
)
...
const (
	...
	AuctionEvent_AuctionEvent_Start         AuctionEvent = 1 //[时间]  [道具名]拍卖正式开始，拍卖底价zenyXXXXXX
	AuctionEvent_AuctionEvent_OfferPrice    AuctionEvent = 2 //[时间]  出价  [线] [玩家名] 出价zenyXXXXXXX
	AuctionEvent_AuctionEvent_Result1       AuctionEvent = 3 //[时间]  30秒  若无竞价，拍品将由[线][玩家名]获得
	AuctionEvent_AuctionEvent_Result2       AuctionEvent = 4 //[时间]  20秒  拍品即将落锤，还有没有竞价者？
	AuctionEvent_AuctionEvent_Result3       AuctionEvent = 5 //[时间]  10秒  最后十秒，拍品即将归 [线][玩家名]
	AuctionEvent_AuctionEvent_ResultSuccess AuctionEvent = 6 //[时间]  成交  恭喜[线] [玩家名] 成功拍得[道具名]，下一场拍卖将在60秒后开始，敬请等待。
	AuctionEvent_AuctionEvent_ResultFail    AuctionEvent = 7 //[时间]  流拍  拍卖时间内无人出价，[道具名]流拍。
)
...
const (
	// sell
	ERecordType_ERecordType_SignUp           ERecordType = 1 //拍品报名
	ERecordType_ERecordType_SignUpSuccess    ERecordType = 2 //拍品报名成功
	ERecordType_ERecordType_SignUpFail       ERecordType = 3 //报名失败的拍品
	ERecordType_ERecordType_SellSucess       ERecordType = 4 //竞拍出售成功审核中
	ERecordType_ERecordType_SellFail         ERecordType = 5 //流拍
	ERecordType_ERecordType_SellSucessPass   ERecordType = 6 //竞拍出售成功审核通过
	ERecordType_ERecordType_SellSucessNoPass ERecordType = 7 //竞拍出售成功审核不通过
	// buy
	ERecordType_ERecordType_MaxOfferPrice    ERecordType = 8  //最高出价
	ERecordType_ERecordType_OverTakePrice    ERecordType = 9  //出价被超过
	ERecordType_ERecordType_BuySuccess       ERecordType = 10 //竞拍获得道具审核中
	ERecordType_ERecordType_BuySuccessPass   ERecordType = 11 //竞拍获得道具审核通过
	ERecordType_ERecordType_BuySuccessNoPass ERecordType = 12 //竞拍获得道具审核不通过
)
...
const (
	EAuctionTakeStatus_EAuctionTakeStatus_None    EAuctionTakeStatus = 0 //不可领取
	EAuctionTakeStatus_EAuctionTakeStatus_CanTake EAuctionTakeStatus = 1 //可领取
	EAuctionTakeStatus_EAuctionTakeStatus_Took    EAuctionTakeStatus = 2 //已领取
)
...
const (
	...
	EDialogType_EDialogType_AuctionStart    EDialogType = 1 // 竞拍开始
	EDialogType_EDialogType_AuctionSuccess  EDialogType = 2 // 竞拍成功
	EDialogType_EDialogType_AuctionFail     EDialogType = 3 // 流拍
	EDialogType_EDialogType_AuctionPubicity EDialogType = 4 // 公示期
)
...
type NtfAuctionStateCCmd struct {
	...
	Batchid     *uint64        `protobuf:"varint,4,opt,name=batchid" json:"batchid,omitempty"`         //批次
	Auctiontime *uint32        `protobuf:"varint,5,opt,name=auctiontime" json:"auctiontime,omitempty"` //拍卖时间
...
type OpenAuctionPanelCCmd struct {
	...
	Open  *bool          `protobuf:"varint,3,opt,name=open" json:"open,omitempty"` //true: 打开面板 false:关闭面板
}
...
type SignUpItemInfo struct {
	...
	Auction *uint32 `protobuf:"varint,3,opt,name=auction,def=0" json:"auction,omitempty"` // 0:禁止上架；1:物品；2:附魔装备
}
...
type NtfSignUpInfoCCmd struct {
	...
	Iteminfos []*SignUpItemInfo `protobuf:"bytes,3,rep,name=iteminfos" json:"iteminfos,omitempty"` //拍卖的商品订单
}
...
type NtfMySignUpInfoCCmd struct {
	...
	Signuped []uint32       `protobuf:"varint,4,rep,name=signuped" json:"signuped,omitempty"` //我已经报名的itemid列表
}
...
type SignUpItemCCmd struct {
	...
	Guid     *string         `protobuf:"bytes,5,opt,name=guid" json:"guid,omitempty"` // 装备
}
...
type AuctionItemInfo struct {
	...
	Itemid      *uint32         `protobuf:"varint,1,opt,name=itemid" json:"itemid,omitempty"`
	Price       *uint32         `protobuf:"varint,2,opt,name=price" json:"price,omitempty"` //起拍价格
	...
	PeopleCnt   *uint32         `protobuf:"varint,6,opt,name=people_cnt,json=peopleCnt" json:"people_cnt,omitempty"`       //竞拍人数
	TradePrice  *uint64         `protobuf:"varint,7,opt,name=trade_price,json=tradePrice" json:"trade_price,omitempty"`    //成交价格
	AuctionTime *uint32         `protobuf:"varint,8,opt,name=auction_time,json=auctionTime" json:"auction_time,omitempty"` //拍卖时间
	// optional uint64 my_price = 9;         //我的出价删除
	CurPrice  *uint64   `protobuf:"varint,10,opt,name=cur_price,json=curPrice" json:"cur_price,omitempty"`    //当前价格
	MaskPrice *uint32   `protobuf:"varint,11,opt,name=mask_price,json=maskPrice" json:"mask_price,omitempty"` //出价档位被禁止，二进制表示，3表示，第一档第二档被禁止
	SignupId  *uint64   `protobuf:"varint,12,opt,name=signup_id,json=signupId" json:"signup_id,omitempty"`    // 报名id
	Itemdata  *ItemData `protobuf:"bytes,13,opt,name=itemdata" json:"itemdata,omitempty"`                     // 装备拍品信息
}
...
type FlowingWaterInfo struct {
	...
	MaxPrice   *bool         `protobuf:"varint,6,opt,name=max_price,json=maxPrice" json:"max_price,omitempty"` //是否是最高价
...
func (x *FlowingWaterInfo) GetTime() uint32 {
	if x != nil && x.Time != nil {
		return *x.Time
	}
	return 0
...
type OfferPriceCCmd struct {
	...
	MaxPrice *uint64        `protobuf:"varint,4,opt,name=max_price,json=maxPrice" json:"max_price,omitempty"` //当前价格
	AddPrice *uint64        `protobuf:"varint,5,opt,name=add_price,json=addPrice" json:"add_price,omitempty"` //我的出价 max_price+add_price
	Level    *uint32        `protobuf:"varint,6,opt,name=level" json:"level,omitempty"`                       //价格档次
	SignupId *uint64        `protobuf:"varint,7,opt,name=signup_id,json=signupId" json:"signup_id,omitempty"`
}
...
type AuctionRecord struct {
	...
	Batchid    *uint64             `protobuf:"varint,12,opt,name=batchid" json:"batchid,omitempty"` //拍卖场次id
...
var file_AuctionCCmd_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x61, 0x22, 0xdf, 0x01, 0x0a, 0x12, 0x4e, 0x74, 0x66, 0x41, 0x75, 0x63, 0x74,
	...
	,
	...
	0x69, 0x6f, 0x6e, 0x43, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a, 0x23, 0x41, 0x55, 0x43, 0x54, 0x49,
	0x4f, 0x4e, 0x43, 0x50, 0x41, 0x52, 0x41, 0x4d, 0x5f, 0x52, 0x45, 0x51, 0x5f, 0x4c, 0x41, 0x53,
	0x54, 0x5f, 0x41, 0x55, 0x43, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x49, 0x4e, 0x46, 0x4f, 0x52, 0x05,
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x22, 0x8d, 0x02, 0x0a, 0x0e, 0x4f, 0x66, 0x66, 0x65, 0x72, 0x50,
	0x72, 0x69, 0x63, 0x65, 0x43, 0x43, 0x6d, 0x64, 0x12, 0x31, 0x0a, 0x03, 0x63, 0x6d, 0x64, 0x18,
	...
	,
	...
	,
	...
	,
	...
	0x50, 0x52, 0x4f, 0x54, 0x4f, 0x43, 0x4d, 0x44, 0x52, 0x03, 0x63, 0x6d, 0x64, 0x12, 0x4c, 0x0a,
	...
	,
	...
	,
}
