...
const (
	EAuguryType_EAUGURYTYPE_LOVE_SEASON EAuguryType = 1 //恋爱的季节
	EAuguryType_EAUGURYTYPE_STAR_GUIDE  EAuguryType = 2 //星座的指引
	EAuguryType_EAUGURYTYPE_ADVENTURE   EAuguryType = 3 //冒险的极意
	EAuguryType_EAUGURYTYPE_VALENTINE   EAuguryType = 4 //老的占卜
	EAuguryType_EAUGURYTYPE_ACTIVITY    EAuguryType = 5 //活动占卜
)
...
type AuguryInvite struct {
	...
	Isextra     *bool        `protobuf:"varint,7,opt,name=isextra" json:"isextra,omitempty"` //是否使用额外次数
}
...
type AuguryAnswer struct {
	...
	Titleid  *uint32      `protobuf:"varint,3,opt,name=titleid" json:"titleid,omitempty"`
	Answer   *uint32      `protobuf:"varint,4,opt,name=answer" json:"answer,omitempty"`     //1:第一个答案 2:第二个答案
	Answerid *uint64      `protobuf:"varint,5,opt,name=answerid" json:"answerid,omitempty"` //回答者的角色id
}
...
var file_SceneAugury_proto_rawDesc = []byte{
	...
	,
}
...
var file_SceneAugury_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_SceneAugury_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_SceneAugury_proto_goTypes = []interface{}{
	(AuguryParam)(0),          // 0: Cmd.AuguryParam
	(EAuguryType)(0),          // 1: Cmd.EAuguryType
	(EReplyType)(0),           // 2: Cmd.EReplyType
	(*AuguryInvite)(nil),      // 3: Cmd.AuguryInvite
	(*AuguryInviteReply)(nil), // 4: Cmd.AuguryInviteReply
	(*AuguryChat)(nil),        // 5: Cmd.AuguryChat
	(*AuguryTitle)(nil),       // 6: Cmd.AuguryTitle
	(*AuguryAnswer)(nil),      // 7: Cmd.AuguryAnswer
	(*AuguryQuit)(nil),        // 8: Cmd.AuguryQuit
	(Command)(0),              // 9: Cmd.Command
}
var file_SceneAugury_proto_depIdxs = []int32{
	9,  // 0: Cmd.AuguryInvite.cmd:type_name -> Cmd.Command
	0,  // 1: Cmd.AuguryInvite.param:type_name -> Cmd.AuguryParam
	1,  // 2: Cmd.AuguryInvite.type:type_name -> Cmd.EAuguryType
	9,  // 3: Cmd.AuguryInviteReply.cmd:type_name -> Cmd.Command
	0,  // 4: Cmd.AuguryInviteReply.param:type_name -> Cmd.AuguryParam
	2,  // 5: Cmd.AuguryInviteReply.type:type_name -> Cmd.EReplyType
	1,  // 6: Cmd.AuguryInviteReply.augurytype:type_name -> Cmd.EAuguryType
	9,  // 7: Cmd.AuguryChat.cmd:type_name -> Cmd.Command
	0,  // 8: Cmd.AuguryChat.param:type_name -> Cmd.AuguryParam
	9,  // 9: Cmd.AuguryTitle.cmd:type_name -> Cmd.Command
	0,  // 10: Cmd.AuguryTitle.param:type_name -> Cmd.AuguryParam
	1,  // 11: Cmd.AuguryTitle.type:type_name -> Cmd.EAuguryType
	9,  // 12: Cmd.AuguryAnswer.cmd:type_name -> Cmd.Command
	0,  // 13: Cmd.AuguryAnswer.param:type_name -> Cmd.AuguryParam
	9,  // 14: Cmd.AuguryQuit.cmd:type_name -> Cmd.Command
