...
const (
	...
	EBossRefreshState_EBOSSREFRESHSTATE_APPEARED EBossRefreshState = 1 // 已现身
	EBossRefreshState_EBOSSREFRESHSTATE_UPCOMING EBossRefreshState = 2 // 即将刷新
	EBossRefreshState_EBOSSREFRESHSTATE_SHORT    EBossRefreshState = 3 // 较短时间
	EBossRefreshState_EBOSSREFRESHSTATE_LONG     EBossRefreshState = 4 // 较长时间
...
var file_BossCmd_proto_rawDesc = []byte{
	...
	,
	...
	0x53, 0x54, 0x45, 0x50, 0x5f, 0x4d, 0x41, 0x58, 0x10, 0x0e,
}
...
var file_BossCmd_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_BossCmd_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_BossCmd_proto_goTypes = []interface{}{
	...
	(*BossInfoItem)(nil),           // 3: Cmd.BossInfoItem
	(*BossListUserCmd)(nil),        // 4: Cmd.BossListUserCmd
	(*BossPosUserCmd)(nil),         // 5: Cmd.BossPosUserCmd
	(*KillBossUserCmd)(nil),        // 6: Cmd.KillBossUserCmd
	(*BossKillerData)(nil),         // 7: Cmd.BossKillerData
	(*QueryKillerInfoBossCmd)(nil), // 8: Cmd.QueryKillerInfoBossCmd
	(*WorldBossNtf)(nil),           // 9: Cmd.WorldBossNtf
	(*StepSyncBossCmd)(nil),        // 10: Cmd.StepSyncBossCmd
	(Command)(0),                   // 11: Cmd.Command
	(*ScenePos)(nil),               // 12: Cmd.ScenePos
	(EProfession)(0),               // 13: Cmd.EProfession
	(EGender)(0),                   // 14: Cmd.EGender
	(*ConfigParam)(nil),            // 15: Cmd.ConfigParam
}
var file_BossCmd_proto_depIdxs = []int32{
	1,  // 0: Cmd.BossInfoItem.refreshstate:type_name -> Cmd.EBossRefreshState
	11, // 1: Cmd.BossListUserCmd.cmd:type_name -> Cmd.Command
	0,  // 2: Cmd.BossListUserCmd.param:type_name -> Cmd.BossParam
	3,  // 3: Cmd.BossListUserCmd.bosslist:type_name -> Cmd.BossInfoItem
	3,  // 4: Cmd.BossListUserCmd.minilist:type_name -> Cmd.BossInfoItem
	3,  // 5: Cmd.BossListUserCmd.deadlist:type_name -> Cmd.BossInfoItem
	11, // 6: Cmd.BossPosUserCmd.cmd:type_name -> Cmd.Command
	0,  // 7: Cmd.BossPosUserCmd.param:type_name -> Cmd.BossParam
	12, // 8: Cmd.BossPosUserCmd.pos:type_name -> Cmd.ScenePos
	11, // 9: Cmd.KillBossUserCmd.cmd:type_name -> Cmd.Command
	0,  // 10: Cmd.KillBossUserCmd.param:type_name -> Cmd.BossParam
	13, // 11: Cmd.BossKillerData.profession:type_name -> Cmd.EProfession
	14, // 12: Cmd.BossKillerData.gender:type_name -> Cmd.EGender
	11, // 13: Cmd.QueryKillerInfoBossCmd.cmd:type_name -> Cmd.Command
	0,  // 14: Cmd.QueryKillerInfoBossCmd.param:type_name -> Cmd.BossParam
	7,  // 15: Cmd.QueryKillerInfoBossCmd.userdata:type_name -> Cmd.BossKillerData
	11, // 16: Cmd.WorldBossNtf.cmd:type_name -> Cmd.Command
	0,  // 17: Cmd.WorldBossNtf.param:type_name -> Cmd.BossParam
	11, // 18: Cmd.StepSyncBossCmd.cmd:type_name -> Cmd.Command
	0,  // 19: Cmd.StepSyncBossCmd.param:type_name -> Cmd.BossParam
	2,  // 20: Cmd.StepSyncBossCmd.step:type_name -> Cmd.EBossStep
	15, // 21: Cmd.StepSyncBossCmd.params:type_name -> Cmd.ConfigParam
