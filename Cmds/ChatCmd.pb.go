...
const (
	...
	ChatParam_CHATPARAM_SHARE_MSG_CMD              ChatParam = 28
	ChatParam_CHATPARAM_SHARE_SUCCESS_NOTIFY       ChatParam = 29
)
...
var (
	ChatParam_name = map[int32]string{
		...
		28: "CHATPARAM_SHARE_MSG_CMD",
		29: "CHATPARAM_SHARE_SUCCESS_NOTIFY",
	}
...
const (
	...
	EGameChatChannel_ECHAT_CHANNEL_RESERVE_ROOM    EGameChatChannel = 12
	EGameChatChannel_ECHAT_CHANNEL_GVG             EGameChatChannel = 13
	EGameChatChannel_ECHAT_CHANNEL_MAX             EGameChatChannel = 14
)
...
var (
	EGameChatChannel_name = map[int32]string{
		...
		12: "ECHAT_CHANNEL_RESERVE_ROOM",
		13: "ECHAT_CHANNEL_GVG",
		14: "ECHAT_CHANNEL_MAX",
	}
...
type EShareMsgType int32

const (
	EShareMsgType_ESHARE_MIN              EShareMsgType = 0
	EShareMsgType_ESHARE_SPEC_ITEM_GET    EShareMsgType = 1
	EShareMsgType_ESHARE_LOTTERY_TEN      EShareMsgType = 2
	EShareMsgType_ESHARE_REFINE           EShareMsgType = 3
	EShareMsgType_ESHARE_NEW_EQUIP        EShareMsgType = 4
	EShareMsgType_ESHARE_ENCHANT          EShareMsgType = 5
	EShareMsgType_ESHARE_EXTRACTION       EShareMsgType = 6
	EShareMsgType_ESHARE_COMPOSE_ARTIFACT EShareMsgType = 7
	EShareMsgType_ESHARE_REMOULD_ARTIFACT EShareMsgType = 8
)

// Enum value maps for EShareMsgType.
var (
	EShareMsgType_name = map[int32]string{
		0: "ESHARE_MIN",
		1: "ESHARE_SPEC_ITEM_GET",
		2: "ESHARE_LOTTERY_TEN",
		3: "ESHARE_REFINE",
		4: "ESHARE_NEW_EQUIP",
		5: "ESHARE_ENCHANT",
		6: "ESHARE_EXTRACTION",
		7: "ESHARE_COMPOSE_ARTIFACT",
		8: "ESHARE_REMOULD_ARTIFACT",
	}
	EShareMsgType_value = map[string]int32{
		"ESHARE_MIN":              0,
...
func (x EShareMsgType) Enum() *EShareMsgType {
	p := new(EShareMsgType)
	*p = x
	return p
}

func (x EShareMsgType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EShareMsgType) Descriptor() protoreflect.EnumDescriptor {
	return file_ChatCmd_proto_enumTypes[10].Descriptor()
}

func (EShareMsgType) Type() protoreflect.EnumType {
	return &file_ChatCmd_proto_enumTypes[10]
}

func (x EShareMsgType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *EShareMsgType) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
...
// Deprecated: Use EShareMsgType.Descriptor instead.
func (EShareMsgType) EnumDescriptor() ([]byte, []int) {
...
type GemInfo struct {
	...
	ExtraFeatureLevel *uint32     `protobuf:"varint,3,opt,name=extra_feature_level,json=extraFeatureLevel" json:"extra_feature_level,omitempty"`
}
...
func (x *GemInfo) GetExtraFeatureLevel() uint32 {
	if x != nil && x.ExtraFeatureLevel != nil {
		return *x.ExtraFeatureLevel
	}
	return 0
}
...
type ChatCmd struct {
	...
	Items       []*ItemInfo         `protobuf:"bytes,13,rep,name=items" json:"items,omitempty"`
}
...
func (x *ChatCmd) GetItems() []*ItemInfo {
	if x != nil {
		return x.Items
	}
	return nil
...
type ChatRetCmd struct {
	...
	ChatFrame     *uint32                 `protobuf:"varint,35,opt,name=chat_frame,json=chatFrame" json:"chat_frame,omitempty"`
	Items         []*ItemInfo             `protobuf:"bytes,36,rep,name=items" json:"items,omitempty"`
	ShareData     *ShareMsgData           `protobuf:"bytes,37,opt,name=share_data,json=shareData" json:"share_data,omitempty"`
}
...
func (x *ChatRetCmd) GetChatFrame() uint32 {
...
func (x *ChatRetCmd) GetItems() []*ItemInfo {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *ChatRetCmd) GetShareData() *ShareMsgData {
	if x != nil {
		return x.ShareData
	}
	return nil
...
type ChatUserIDInfo struct {
	...
	GuildJob        *EGuildJob `protobuf:"varint,7,opt,name=guild_job,json=guildJob,enum=Cmd.EGuildJob" json:"guild_job,omitempty"`
}
...
func (x *ChatUserIDInfo) GetGuildJob() EGuildJob {
	if x != nil && x.GuildJob != nil {
		return *x.GuildJob
	}
...
type RedPacketContent struct {
	...
	TargetId       *uint64           `protobuf:"varint,18,opt,name=target_id,json=targetId" json:"target_id,omitempty"`
	GuildJob       *EGuildJob        `protobuf:"varint,19,opt,name=guild_job,json=guildJob,enum=Cmd.EGuildJob" json:"guild_job,omitempty"`
...
func (x *RedPacketContent) GetTargetId() uint64 {
	if x != nil && x.TargetId != nil {
		return *x.TargetId
	}
	return 0
...
func (x *RedPacketContent) GetGuildJob() EGuildJob {
	if x != nil && x.GuildJob != nil {
		return *x.GuildJob
	}
	return EGuildJob_EGUILDJOB_MIN
...
type SendRedPacketCmd struct {
	...
	BeBlacked  *bool             `protobuf:"varint,6,opt,name=be_blacked,json=beBlacked" json:"be_blacked,omitempty"`
}
...
func (x *SendRedPacketCmd) GetGuid() string {
	if x != nil && x.Guid != nil {
		return *x.Guid
	}
	return ""
...
func (x *SendRedPacketCmd) GetBeBlacked() bool {
	if x != nil && x.BeBlacked != nil {
		return *x.BeBlacked
	}
	return false
}
...
type ReceiveRedPacketCmd struct {
	...
	MercenaryGuild       *uint32         `protobuf:"varint,7,opt,name=mercenary_guild,json=mercenaryGuild" json:"mercenary_guild,omitempty"`
}
...
func (x *ReceiveRedPacketCmd) GetMercenaryGuild() uint32 {
	if x != nil && x.MercenaryGuild != nil {
...
type ShareItemData struct {
	...
	ExtractLv *uint32 `protobuf:"varint,4,opt,name=extract_lv,json=extractLv" json:"extract_lv,omitempty"`
}

func (x *ShareItemData) Reset() {
	*x = ShareItemData{}
	if protoimpl.UnsafeEnabled {
...
func (x *ShareItemData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShareItemData) ProtoMessage() {}

func (x *ShareItemData) ProtoReflect() protoreflect.Message {
	mi := &file_ChatCmd_proto_msgTypes[36]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShareItemData.ProtoReflect.Descriptor instead.
func (*ShareItemData) Descriptor() ([]byte, []int) {
	return file_ChatCmd_proto_rawDescGZIP(), []int{36}
}

func (x *ShareItemData) GetGuid() string {
	if x != nil && x.Guid != nil {
		return *x.Guid
	}
	return ""
...
func (x *ShareItemData) GetItemid() uint32 {
	if x != nil && x.Itemid != nil {
		return *x.Itemid
	}
	return 0
...
func (x *ShareItemData) GetCount() uint32 {
	if x != nil && x.Count != nil {
		return *x.Count
	}
	return 0
...
func (x *ShareItemData) GetExtractLv() uint32 {
	if x != nil && x.ExtractLv != nil {
		return *x.ExtractLv
	}
	return 0
}

type ShareMsgData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Type       *EShareMsgType   `protobuf:"varint,1,opt,name=type,enum=Cmd.EShareMsgType" json:"type,omitempty"`
	ShareItems []*ShareItemData `protobuf:"bytes,2,rep,name=share_items,json=shareItems" json:"share_items,omitempty"`
	Items      []*ItemData      `protobuf:"bytes,3,rep,name=items" json:"items,omitempty"`
}

func (x *ShareMsgData) Reset() {
	*x = ShareMsgData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ChatCmd_proto_msgTypes[37]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ShareMsgData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShareMsgData) ProtoMessage() {}

func (x *ShareMsgData) ProtoReflect() protoreflect.Message {
	mi := &file_ChatCmd_proto_msgTypes[37]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShareMsgData.ProtoReflect.Descriptor instead.
func (*ShareMsgData) Descriptor() ([]byte, []int) {
	return file_ChatCmd_proto_rawDescGZIP(), []int{37}
}

func (x *ShareMsgData) GetType() EShareMsgType {
	if x != nil && x.Type != nil {
		return *x.Type
	}
	return EShareMsgType_ESHARE_MIN
}

func (x *ShareMsgData) GetShareItems() []*ShareItemData {
	if x != nil {
		return x.ShareItems
	}
	return nil
...
func (x *ShareMsgData) GetItems() []*ItemData {
	if x != nil {
		return x.Items
	}
	return nil
...
type ShareMsgCmd struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cmd       *Command      `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=59" json:"cmd,omitempty"`
	Param     *ChatParam    `protobuf:"varint,2,opt,name=param,enum=Cmd.ChatParam,def=28" json:"param,omitempty"`
	ShareData *ShareMsgData `protobuf:"bytes,3,opt,name=share_data,json=shareData" json:"share_data,omitempty"`
}

// Default values for ShareMsgCmd fields.
const (
	Default_ShareMsgCmd_Cmd   = Command_CHAT_PROTOCMD
	Default_ShareMsgCmd_Param = ChatParam_CHATPARAM_SHARE_MSG_CMD
)

func (x *ShareMsgCmd) Reset() {
	*x = ShareMsgCmd{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ChatCmd_proto_msgTypes[38]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ShareMsgCmd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShareMsgCmd) ProtoMessage() {}

func (x *ShareMsgCmd) ProtoReflect() protoreflect.Message {
	mi := &file_ChatCmd_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShareMsgCmd.ProtoReflect.Descriptor instead.
func (*ShareMsgCmd) Descriptor() ([]byte, []int) {
	return file_ChatCmd_proto_rawDescGZIP(), []int{38}
}

func (x *ShareMsgCmd) GetCmd() Command {
	if x != nil && x.Cmd != nil {
		return *x.Cmd
	}
	return Default_ShareMsgCmd_Cmd
}

func (x *ShareMsgCmd) GetParam() ChatParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
	return Default_ShareMsgCmd_Param
}

func (x *ShareMsgCmd) GetShareData() *ShareMsgData {
	if x != nil {
		return x.ShareData
	}
	return nil
...
type ShareSuccessNofityCmd struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cmd   *Command   `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=59" json:"cmd,omitempty"`
	Param *ChatParam `protobuf:"varint,2,opt,name=param,enum=Cmd.ChatParam,def=29" json:"param,omitempty"`
}

// Default values for ShareSuccessNofityCmd fields.
const (
	Default_ShareSuccessNofityCmd_Cmd   = Command_CHAT_PROTOCMD
	Default_ShareSuccessNofityCmd_Param = ChatParam_CHATPARAM_SHARE_SUCCESS_NOTIFY
)

func (x *ShareSuccessNofityCmd) Reset() {
	*x = ShareSuccessNofityCmd{}
	if protoimpl.UnsafeEnabled {
		mi := &file_ChatCmd_proto_msgTypes[39]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ShareSuccessNofityCmd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ShareSuccessNofityCmd) ProtoMessage() {}

func (x *ShareSuccessNofityCmd) ProtoReflect() protoreflect.Message {
	mi := &file_ChatCmd_proto_msgTypes[39]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ShareSuccessNofityCmd.ProtoReflect.Descriptor instead.
func (*ShareSuccessNofityCmd) Descriptor() ([]byte, []int) {
	return file_ChatCmd_proto_rawDescGZIP(), []int{39}
}

func (x *ShareSuccessNofityCmd) GetCmd() Command {
	if x != nil && x.Cmd != nil {
		return *x.Cmd
	}
	return Default_ShareSuccessNofityCmd_Cmd
}

func (x *ShareSuccessNofityCmd) GetParam() ChatParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
	return Default_ShareSuccessNofityCmd_Param
}
...
var file_ChatCmd_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x65, 0x6c, 0x3a, 0x13, 0x45, 0x43, 0x48, 0x41, 0x54, 0x5f, 0x43, 0x48, 0x41, 0x4e, 0x4e,
	0x45, 0x4c, 0x5f, 0x52, 0x4f, 0x55, 0x4e, 0x44, 0x52, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65,
	0x6c, 0x12, 0x3b, 0x0a, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x6a, 0x6f, 0x62, 0x18, 0x09, 0x20, 0x01,
	...
	0x4e, 0x5f, 0x4d, 0x49, 0x4e, 0x52, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x6a, 0x6f, 0x62, 0x12, 0x31,
	0x0a, 0x06, 0x67, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0c,
	0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x45, 0x47, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x3a, 0x0b, 0x45, 0x47,
	0x45, 0x4e, 0x44, 0x45, 0x52, 0x5f, 0x4d, 0x49, 0x4e, 0x52, 0x06, 0x67, 0x65, 0x6e, 0x64, 0x65,
	0x72, 0x12, 0x1b, 0x0a, 0x05, 0x62, 0x6c, 0x69, 0x6e, 0x6b, 0x18, 0x14, 0x20, 0x01, 0x28, 0x08,
	0x3a, 0x05, 0x66, 0x61, 0x6c, 0x73, 0x65, 0x52, 0x05, 0x62, 0x6c, 0x69, 0x6e, 0x6b, 0x12, 0x10,
	0x0a, 0x03, 0x73, 0x74, 0x72, 0x18, 0x04, 0x20, 0x02, 0x28, 0x09, 0x52, 0x03, 0x73, 0x74, 0x72,
	...
	0x65, 0x18, 0x12, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x67, 0x75, 0x69, 0x6c, 0x64, 0x6e, 0x61,
	0x6d, 0x65, 0x12, 0x1d, 0x0a, 0x08, 0x73, 0x79, 0x73, 0x6d, 0x73, 0x67, 0x69, 0x64, 0x18, 0x1a,
	0x20, 0x01, 0x28, 0x0d, 0x3a, 0x01, 0x30, 0x52, 0x08, 0x73, 0x79, 0x73, 0x6d, 0x73, 0x67, 0x69,
	0x64, 0x12, 0x25, 0x0a, 0x05, 0x70, 0x68, 0x6f, 0x74, 0x6f, 0x18, 0x1d, 0x20, 0x01, 0x28, 0x0b,
	...
	0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x43,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0e, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x43, 0x68, 0x61, 0x74,
	0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a, 0x12, 0x43, 0x48, 0x41, 0x54, 0x50, 0x41, 0x52, 0x41, 0x4d,
	0x5f, 0x46, 0x41, 0x43, 0x45, 0x53, 0x48, 0x4f, 0x57, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d,
	...
	,
	...
	0x4f, 0x4e, 0x5f, 0x4d, 0x49, 0x4e, 0x52, 0x07, 0x72, 0x6f, 0x6c, 0x65, 0x4a, 0x6f, 0x62, 0x12,
	0x31, 0x0a, 0x06, 0x67, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	,
	...
	0x12, 0x33, 0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x43, 0x6d, 0x64, 0x2e, 0x43, 0x68, 0x61, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x49, 0x44, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x49,
	0x44, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x65, 0x5f, 0x62, 0x6c, 0x61, 0x63,
	0x6b, 0x65, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x62, 0x65, 0x42, 0x6c, 0x61,
	0x63, 0x6b, 0x65, 0x64, 0x22, 0xec, 0x02, 0x0a, 0x13, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_ChatCmd_proto_enumTypes = make([]protoimpl.EnumInfo, 11)
var file_ChatCmd_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_ChatCmd_proto_goTypes = []interface{}{
	...
	(EShareMsgType)(0),                      // 10: Cmd.EShareMsgType
	(*OfflineMsg)(nil),                      // 11: Cmd.OfflineMsg
	(*OffMsgUserAddItem)(nil),               // 12: Cmd.OffMsgUserAddItem
	(*OffMsgUserQuotaData)(nil),             // 13: Cmd.OffMsgUserQuotaData
	(*QueryItemData)(nil),                   // 14: Cmd.QueryItemData
	(*PlayExpressionChatCmd)(nil),           // 15: Cmd.PlayExpressionChatCmd
	(*QueryUserInfo)(nil),                   // 16: Cmd.QueryUserInfo
	(*QueryUserInfoChatCmd)(nil),            // 17: Cmd.QueryUserInfoChatCmd
	(*GemInfo)(nil),                         // 18: Cmd.GemInfo
	(*QueryUserGemChatCmd)(nil),             // 19: Cmd.QueryUserGemChatCmd
	(*BarrageChatCmd)(nil),                  // 20: Cmd.BarrageChatCmd
	(*ColorInfo)(nil),                       // 21: Cmd.ColorInfo
	(*BarrageMsgChatCmd)(nil),               // 22: Cmd.BarrageMsgChatCmd
	(*ChatCmd)(nil),                         // 23: Cmd.ChatCmd
	(*ChatRetCmd)(nil),                      // 24: Cmd.ChatRetCmd
	(*QueryVoiceUserCmd)(nil),               // 25: Cmd.QueryVoiceUserCmd
	(*GetVoiceIDChatCmd)(nil),               // 26: Cmd.GetVoiceIDChatCmd
	(*LoveLetterNtf)(nil),                   // 27: Cmd.LoveLetterNtf
	(*ChatSelfNtf)(nil),                     // 28: Cmd.ChatSelfNtf
	(*NpcChatNtf)(nil),                      // 29: Cmd.NpcChatNtf
	...
	(*ShareItemData)(nil),                   // 47: Cmd.ShareItemData
	(*ShareMsgData)(nil),                    // 48: Cmd.ShareMsgData
	(*ShareMsgCmd)(nil),                     // 49: Cmd.ShareMsgCmd
	(*ShareSuccessNofityCmd)(nil),           // 50: Cmd.ShareSuccessNofityCmd
	(EMoneyType)(0),                         // 51: Cmd.EMoneyType
	(*ItemData)(nil),                        // 52: Cmd.ItemData
	(*SysMsg)(nil),                          // 53: Cmd.SysMsg
	(*TutorReward)(nil),                     // 54: Cmd.TutorReward
	(*WeddingEventMsgCCmd)(nil),             // 55: Cmd.WeddingEventMsgCCmd
	(*ItemInfo)(nil),                        // 56: Cmd.ItemInfo
	(EQuotaType)(0),                         // 57: Cmd.EQuotaType
	(Command)(0),                            // 58: Cmd.Command
	(*UserData)(nil),                        // 59: Cmd.UserData
	(*UserAttr)(nil),                        // 60: Cmd.UserAttr
	(*HighRefineData)(nil),                  // 61: Cmd.HighRefineData
	(*ScenePos)(nil),                        // 62: Cmd.ScenePos
	(*GuildPhoto)(nil),                      // 63: Cmd.GuildPhoto
	(EProfession)(0),                        // 64: Cmd.EProfession
	(EGender)(0),                            // 65: Cmd.EGender
	(*MsgParam)(nil),                        // 66: Cmd.MsgParam
	(EGuildJob)(0),                          // 67: Cmd.EGuildJob
}
var file_ChatCmd_proto_depIdxs = []int32{
	1,   // 0: Cmd.OfflineMsg.type:type_name -> Cmd.EOfflineMsg
	24,  // 1: Cmd.OfflineMsg.chat:type_name -> Cmd.ChatRetCmd
	35,  // 2: Cmd.OfflineMsg.expression:type_name -> Cmd.ExpressionChatCmd
	51,  // 3: Cmd.OfflineMsg.moneytype:type_name -> Cmd.EMoneyType
	52,  // 4: Cmd.OfflineMsg.itemdata:type_name -> Cmd.ItemData
	53,  // 5: Cmd.OfflineMsg.syscmd:type_name -> Cmd.SysMsg
	54,  // 6: Cmd.OfflineMsg.tutorreward:type_name -> Cmd.TutorReward
	12,  // 7: Cmd.OfflineMsg.useradditem:type_name -> Cmd.OffMsgUserAddItem
	55,  // 8: Cmd.OfflineMsg.weddingmsg:type_name -> Cmd.WeddingEventMsgCCmd
	13,  // 9: Cmd.OfflineMsg.quotadata:type_name -> Cmd.OffMsgUserQuotaData
	2,   // 10: Cmd.OffMsgUserAddItem.type:type_name -> Cmd.EUserAddItemType
	56,  // 11: Cmd.OffMsgUserAddItem.items:type_name -> Cmd.ItemInfo
	3,   // 12: Cmd.OffMsgUserQuotaData.oper:type_name -> Cmd.EUserQuotaOper
	57,  // 13: Cmd.OffMsgUserQuotaData.type:type_name -> Cmd.EQuotaType
	58,  // 14: Cmd.QueryItemData.cmd:type_name -> Cmd.Command
	0,   // 15: Cmd.QueryItemData.param:type_name -> Cmd.ChatParam
	52,  // 16: Cmd.QueryItemData.data:type_name -> Cmd.ItemData
	58,  // 17: Cmd.PlayExpressionChatCmd.cmd:type_name -> Cmd.Command
	0,   // 18: Cmd.PlayExpressionChatCmd.param:type_name -> Cmd.ChatParam
	59,  // 19: Cmd.QueryUserInfo.datas:type_name -> Cmd.UserData
	60,  // 20: Cmd.QueryUserInfo.attrs:type_name -> Cmd.UserAttr
	52,  // 21: Cmd.QueryUserInfo.equip:type_name -> Cmd.ItemData
	52,  // 22: Cmd.QueryUserInfo.fashion:type_name -> Cmd.ItemData
	61,  // 23: Cmd.QueryUserInfo.highrefine:type_name -> Cmd.HighRefineData
	58,  // 24: Cmd.QueryUserInfoChatCmd.cmd:type_name -> Cmd.Command
	...
	16,  // 27: Cmd.QueryUserInfoChatCmd.info:type_name -> Cmd.QueryUserInfo
	52,  // 28: Cmd.GemInfo.attrgems:type_name -> Cmd.ItemData
	52,  // 29: Cmd.GemInfo.skillgems:type_name -> Cmd.ItemData
	58,  // 30: Cmd.QueryUserGemChatCmd.cmd:type_name -> Cmd.Command
	0,   // 31: Cmd.QueryUserGemChatCmd.param:type_name -> Cmd.ChatParam
	18,  // 32: Cmd.QueryUserGemChatCmd.info:type_name -> Cmd.GemInfo
	58,  // 33: Cmd.BarrageChatCmd.cmd:type_name -> Cmd.Command
	0,   // 34: Cmd.BarrageChatCmd.param:type_name -> Cmd.ChatParam
	5,   // 35: Cmd.BarrageChatCmd.opt:type_name -> Cmd.EBarrageOpt
	58,  // 36: Cmd.BarrageMsgChatCmd.cmd:type_name -> Cmd.Command
	0,   // 37: Cmd.BarrageMsgChatCmd.param:type_name -> Cmd.ChatParam
	62,  // 38: Cmd.BarrageMsgChatCmd.msgpos:type_name -> Cmd.ScenePos
	21,  // 39: Cmd.BarrageMsgChatCmd.clr:type_name -> Cmd.ColorInfo
	58,  // 40: Cmd.ChatCmd.cmd:type_name -> Cmd.Command
	0,   // 41: Cmd.ChatCmd.param:type_name -> Cmd.ChatParam
	6,   // 42: Cmd.ChatCmd.channel:type_name -> Cmd.EGameChatChannel
	63,  // 43: Cmd.ChatCmd.photo:type_name -> Cmd.GuildPhoto
	32,  // 44: Cmd.ChatCmd.expression:type_name -> Cmd.FavoriteExpression
	56,  // 45: Cmd.ChatCmd.items:type_name -> Cmd.ItemInfo
	58,  // 46: Cmd.ChatRetCmd.cmd:type_name -> Cmd.Command
	0,   // 47: Cmd.ChatRetCmd.param:type_name -> Cmd.ChatParam
	6,   // 48: Cmd.ChatRetCmd.channel:type_name -> Cmd.EGameChatChannel
	64,  // 49: Cmd.ChatRetCmd.rolejob:type_name -> Cmd.EProfession
	65,  // 50: Cmd.ChatRetCmd.gender:type_name -> Cmd.EGender
	63,  // 51: Cmd.ChatRetCmd.photo:type_name -> Cmd.GuildPhoto
	32,  // 52: Cmd.ChatRetCmd.expression:type_name -> Cmd.FavoriteExpression
	45,  // 53: Cmd.ChatRetCmd.redpacketret:type_name -> Cmd.SendRedPacketSocialRet
	56,  // 54: Cmd.ChatRetCmd.items:type_name -> Cmd.ItemInfo
	48,  // 55: Cmd.ChatRetCmd.share_data:type_name -> Cmd.ShareMsgData
	58,  // 56: Cmd.QueryVoiceUserCmd.cmd:type_name -> Cmd.Command
	0,   // 57: Cmd.QueryVoiceUserCmd.param:type_name -> Cmd.ChatParam
	58,  // 58: Cmd.GetVoiceIDChatCmd.cmd:type_name -> Cmd.Command
	0,   // 59: Cmd.GetVoiceIDChatCmd.param:type_name -> Cmd.ChatParam
	58,  // 60: Cmd.LoveLetterNtf.cmd:type_name -> Cmd.Command
	0,   // 61: Cmd.LoveLetterNtf.param:type_name -> Cmd.ChatParam
	58,  // 62: Cmd.ChatSelfNtf.cmd:type_name -> Cmd.Command
	0,   // 63: Cmd.ChatSelfNtf.param:type_name -> Cmd.ChatParam
	23,  // 64: Cmd.ChatSelfNtf.chat:type_name -> Cmd.ChatCmd
	58,  // 65: Cmd.NpcChatNtf.cmd:type_name -> Cmd.Command
	0,   // 66: Cmd.NpcChatNtf.param:type_name -> Cmd.ChatParam
	6,   // 67: Cmd.NpcChatNtf.channel:type_name -> Cmd.EGameChatChannel
	66,  // 68: Cmd.NpcChatNtf.params:type_name -> Cmd.MsgParam
	58,  // 69: Cmd.QueryUserShowInfoCmd.cmd:type_name -> Cmd.Command
	0,   // 70: Cmd.QueryUserShowInfoCmd.param:type_name -> Cmd.ChatParam
	16,  // 71: Cmd.QueryUserShowInfoCmd.info:type_name -> Cmd.QueryUserInfo
	58,  // 72: Cmd.SystemBarrageChatCmd.cmd:type_name -> Cmd.Command
	...
	58,  // 76: Cmd.QueryFavoriteExpressionChatCmd.cmd:type_name -> Cmd.Command
	...
	58,  // 79: Cmd.UpdateFavoriteExpressionChatCmd.cmd:type_name -> Cmd.Command
	...
	58,  // 83: Cmd.ExpressionChatCmd.cmd:type_name -> Cmd.Command
	...
	58,  // 86: Cmd.FaceShowChatCmd.cmd:type_name -> Cmd.Command
	0,   // 87: Cmd.FaceShowChatCmd.param:type_name -> Cmd.ChatParam
	6,   // 88: Cmd.FaceShowChatCmd.channel:type_name -> Cmd.EGameChatChannel
	58,  // 89: Cmd.ClientLogChatCmd.cmd:type_name -> Cmd.Command
	0,   // 90: Cmd.ClientLogChatCmd.param:type_name -> Cmd.ChatParam
	64,  // 91: Cmd.ChatUserInfo.roleJob:type_name -> Cmd.EProfession
	65,  // 92: Cmd.ChatUserInfo.gender:type_name -> Cmd.EGender
	67,  // 93: Cmd.ChatUserIDInfo.guild_job:type_name -> Cmd.EGuildJob
	6,   // 94: Cmd.RedPacketContent.channel:type_name -> Cmd.EGameChatChannel
	67,  // 95: Cmd.RedPacketContent.guild_job:type_name -> Cmd.EGuildJob
	9,   // 96: Cmd.RedPacketContent.type:type_name -> Cmd.ERedPacketType
	41,  // 97: Cmd.RedPacketContent.receivedInfos:type_name -> Cmd.ReceivedInfo
	58,  // 98: Cmd.SendRedPacketCmd.cmd:type_name -> Cmd.Command
	0,   // 99: Cmd.SendRedPacketCmd.param:type_name -> Cmd.ChatParam
	40,  // 100: Cmd.SendRedPacketCmd.content:type_name -> Cmd.RedPacketContent
	39,  // 101: Cmd.SendRedPacketCmd.userIDInfo:type_name -> Cmd.ChatUserIDInfo
	58,  // 102: Cmd.ReceiveRedPacketCmd.cmd:type_name -> Cmd.Command
	0,   // 103: Cmd.ReceiveRedPacketCmd.param:type_name -> Cmd.ChatParam
	39,  // 104: Cmd.ReceiveRedPacketCmd.userIDInfo:type_name -> Cmd.ChatUserIDInfo
	58,  // 105: Cmd.InitUserRedPacketCmd.cmd:type_name -> Cmd.Command
	0,   // 106: Cmd.InitUserRedPacketCmd.param:type_name -> Cmd.ChatParam
	58,  // 107: Cmd.ReceiveRedPacketRet.cmd:type_name -> Cmd.Command
	0,   // 108: Cmd.ReceiveRedPacketRet.param:type_name -> Cmd.ChatParam
	40,  // 109: Cmd.ReceiveRedPacketRet.content:type_name -> Cmd.RedPacketContent
	39,  // 110: Cmd.ReceiveRedPacketRet.userIDInfo:type_name -> Cmd.ChatUserIDInfo
	10,  // 111: Cmd.ShareMsgData.type:type_name -> Cmd.EShareMsgType
	47,  // 112: Cmd.ShareMsgData.share_items:type_name -> Cmd.ShareItemData
	52,  // 113: Cmd.ShareMsgData.items:type_name -> Cmd.ItemData
	58,  // 114: Cmd.ShareMsgCmd.cmd:type_name -> Cmd.Command
	0,   // 115: Cmd.ShareMsgCmd.param:type_name -> Cmd.ChatParam
	48,  // 116: Cmd.ShareMsgCmd.share_data:type_name -> Cmd.ShareMsgData
	58,  // 117: Cmd.ShareSuccessNofityCmd.cmd:type_name -> Cmd.Command
	0,   // 118: Cmd.ShareSuccessNofityCmd.param:type_name -> Cmd.ChatParam
...
func file_ChatCmd_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ChatCmd_proto_msgTypes[37].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShareMsgData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ChatCmd_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShareMsgCmd); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_ChatCmd_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShareSuccessNofityCmd); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
