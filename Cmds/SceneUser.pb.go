...
const (
	...
	CmdParam_REQ_HIDE_USER_CMD                  CmdParam = 52
	CmdParam_OBSERVATION_MODE_USER_CMD          CmdParam = 53
)
...
var (
	CmdParam_name = map[int32]string{
		...
		52: "REQ_HIDE_USER_CMD",
		53: "OBSERVATION_MODE_USER_CMD",
	}
...
type UserGMCommand struct {
	...
	Cmd     *Command  `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=5" json:"cmd,omitempty"`
	Param   *CmdParam `protobuf:"varint,2,opt,name=param,enum=Cmd.CmdParam,def=3" json:"param,omitempty"`
	Command *string   `protobuf:"bytes,3,opt,name=command" json:"command,omitempty"`
	Json    *bool     `protobuf:"varint,4,opt,name=json" json:"json,omitempty"`
}

// Default values for UserGMCommand fields.
const (
	Default_UserGMCommand_Cmd   = Command_SCENE_USER_PROTOCMD
	Default_UserGMCommand_Param = CmdParam_USERPARAM_GMCOMMAND
)
...
func (x *UserGMCommand) GetParam() CmdParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
...
func (x *UserGMCommand) GetJson() bool {
	if x != nil && x.Json != nil {
		return *x.Json
	}
	return false
...
type ChangeSceneUserCmd struct {
	...
	Cutscene     *bool     `protobuf:"varint,12,opt,name=cutscene" json:"cutscene,omitempty"`
	IsDScene     *bool     `protobuf:"varint,13,opt,name=isDScene" json:"isDScene,omitempty"`
	Sceneid      *uint32   `protobuf:"varint,14,opt,name=sceneid" json:"sceneid,omitempty"`
	Borndir      *uint32   `protobuf:"varint,15,opt,name=borndir" json:"borndir,omitempty"`
}
...
func (x *ChangeSceneUserCmd) GetCutscene() bool {
	if x != nil && x.Cutscene != nil {
		return *x.Cutscene
	}
	return false
}

func (x *ChangeSceneUserCmd) GetIsDScene() bool {
	if x != nil && x.IsDScene != nil {
		return *x.IsDScene
	}
	return false
}

func (x *ChangeSceneUserCmd) GetSceneid() uint32 {
...
func (x *ChangeSceneUserCmd) GetBorndir() uint32 {
	if x != nil && x.Borndir != nil {
		return *x.Borndir
	}
	return 0
}
...
type HitedTarget struct {
	...
	Attackerid   *uint64           `protobuf:"varint,5,opt,name=attackerid" json:"attackerid,omitempty"`
	Gopos        *ScenePos         `protobuf:"bytes,6,opt,name=gopos" json:"gopos,omitempty"`
}
...
func (x *HitedTarget) GetAttackerid() uint64 {
...
func (x *HitedTarget) GetGopos() *ScenePos {
	if x != nil {
		return x.Gopos
	}
	return nil
...
type PhaseData struct {
	...
	LastHit      *bool          `protobuf:"varint,6,opt,name=last_hit,json=lastHit" json:"last_hit,omitempty"`
}
...
func (x *PhaseData) GetLastHit() bool {
...
type SkillBroadcastUserCmd struct {
	...
	Gopos     *ScenePos  `protobuf:"bytes,10,opt,name=gopos" json:"gopos,omitempty"`
	Trigger   *bool      `protobuf:"varint,11,opt,name=trigger" json:"trigger,omitempty"`
}
...
func (x *SkillBroadcastUserCmd) GetGopos() *ScenePos {
	if x != nil {
		return x.Gopos
	}
	return nil
...
func (x *SkillBroadcastUserCmd) GetTrigger() bool {
...
type ReqHideUserCmd struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cmd   *Command  `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=5" json:"cmd,omitempty"`
	Param *CmdParam `protobuf:"varint,2,opt,name=param,enum=Cmd.CmdParam,def=52" json:"param,omitempty"`
	Hide  *bool     `protobuf:"varint,3,opt,name=hide" json:"hide,omitempty"`
}

// Default values for ReqHideUserCmd fields.
const (
	Default_ReqHideUserCmd_Cmd   = Command_SCENE_USER_PROTOCMD
	Default_ReqHideUserCmd_Param = CmdParam_REQ_HIDE_USER_CMD
)

func (x *ReqHideUserCmd) Reset() {
	*x = ReqHideUserCmd{}
	if protoimpl.UnsafeEnabled {
		mi := &file_SceneUser_proto_msgTypes[39]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ReqHideUserCmd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReqHideUserCmd) ProtoMessage() {}

func (x *ReqHideUserCmd) ProtoReflect() protoreflect.Message {
	mi := &file_SceneUser_proto_msgTypes[39]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReqHideUserCmd.ProtoReflect.Descriptor instead.
func (*ReqHideUserCmd) Descriptor() ([]byte, []int) {
	return file_SceneUser_proto_rawDescGZIP(), []int{39}
}

func (x *ReqHideUserCmd) GetCmd() Command {
	if x != nil && x.Cmd != nil {
		return *x.Cmd
	}
	return Default_ReqHideUserCmd_Cmd
}

func (x *ReqHideUserCmd) GetParam() CmdParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
	return Default_ReqHideUserCmd_Param
}

func (x *ReqHideUserCmd) GetHide() bool {
	if x != nil && x.Hide != nil {
		return *x.Hide
	}
	return false
...
type ObservationModeUserCmd struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Cmd   *Command  `protobuf:"varint,1,opt,name=cmd,enum=Cmd.Command,def=5" json:"cmd,omitempty"`
	Param *CmdParam `protobuf:"varint,2,opt,name=param,enum=Cmd.CmdParam,def=53" json:"param,omitempty"`
	Mode  *bool     `protobuf:"varint,3,opt,name=mode" json:"mode,omitempty"`
}

// Default values for ObservationModeUserCmd fields.
const (
	Default_ObservationModeUserCmd_Cmd   = Command_SCENE_USER_PROTOCMD
	Default_ObservationModeUserCmd_Param = CmdParam_OBSERVATION_MODE_USER_CMD
)

func (x *ObservationModeUserCmd) Reset() {
	*x = ObservationModeUserCmd{}
	if protoimpl.UnsafeEnabled {
		mi := &file_SceneUser_proto_msgTypes[40]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ObservationModeUserCmd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObservationModeUserCmd) ProtoMessage() {}

func (x *ObservationModeUserCmd) ProtoReflect() protoreflect.Message {
	mi := &file_SceneUser_proto_msgTypes[40]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObservationModeUserCmd.ProtoReflect.Descriptor instead.
func (*ObservationModeUserCmd) Descriptor() ([]byte, []int) {
	return file_SceneUser_proto_rawDescGZIP(), []int{40}
}

func (x *ObservationModeUserCmd) GetCmd() Command {
	if x != nil && x.Cmd != nil {
		return *x.Cmd
	}
	return Default_ObservationModeUserCmd_Cmd
}

func (x *ObservationModeUserCmd) GetParam() CmdParam {
	if x != nil && x.Param != nil {
		return *x.Param
	}
	return Default_ObservationModeUserCmd_Param
}

func (x *ObservationModeUserCmd) GetMode() bool {
	if x != nil && x.Mode != nil {
		return *x.Mode
	}
	return false
...
var file_SceneUser_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x72, 0x22, 0xac, 0x01, 0x0a, 0x0d, 0x55, 0x73, 0x65, 0x72, 0x47, 0x4d, 0x43, 0x6f,
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x33, 0x0a, 0x03, 0x63, 0x6d, 0x64, 0x18, 0x01, 0x20, 0x01,
	...
	0x43, 0x6d, 0x64, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a, 0x13, 0x55, 0x53, 0x45, 0x52, 0x50, 0x41,
	0x52, 0x41, 0x4d, 0x5f, 0x47, 0x4d, 0x43, 0x4f, 0x4d, 0x4d, 0x41, 0x4e, 0x44, 0x52, 0x05, 0x70,
	0x61, 0x72, 0x61, 0x6d, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x12,
	0x0a, 0x04, 0x6a, 0x73, 0x6f, 0x6e, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x6a, 0x73,
	0x6f, 0x6e, 0x22, 0xa9, 0x01, 0x0a, 0x16, 0x55, 0x73, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x66, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x33, 0x0a,
	...
	0x6d, 0x64, 0x12, 0x17, 0x0a, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0d, 0x3a, 0x01, 0x34, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x41, 0x0a, 0x0a, 0x70,
	0x72, 0x6f, 0x66, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32,
	...
	0x49, 0x4e, 0x52, 0x0a, 0x70, 0x72, 0x6f, 0x66, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0x7e,
	0x0a, 0x08, 0x55, 0x73, 0x65, 0x72, 0x54, 0x65, 0x73, 0x74, 0x12, 0x33, 0x0a, 0x03, 0x63, 0x6d,
	...
	,
	...
	0x43, 0x6d, 0x64, 0x2e, 0x43, 0x6d, 0x64, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x3a, 0x17, 0x4d, 0x41,
	0x49, 0x4e, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f, 0x44, 0x41, 0x54, 0x41, 0x5f, 0x55, 0x53, 0x45,
	0x52, 0x5f, 0x43, 0x4d, 0x44, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x25, 0x0a, 0x04,
	0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x43, 0x6d, 0x64,
	0x2e, 0x4d, 0x61, 0x69, 0x6e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x22, 0xa4, 0x01, 0x0a, 0x0e, 0x52, 0x65, 0x71, 0x4d, 0x6f, 0x76, 0x65, 0x55,
	...
	,
	...
	0x3a, 0x11, 0x52, 0x45, 0x54, 0x5f, 0x4d, 0x4f, 0x56, 0x45, 0x5f, 0x55, 0x53, 0x45, 0x52, 0x5f,
	0x43, 0x4d, 0x44, 0x52, 0x05, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x68,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x65, 0x50, 0x6f, 0x73, 0x52, 0x03, 0x70, 0x6f, 0x73, 0x22, 0xe6, 0x01, 0x0a, 0x11, 0x43,
	0x68, 0x61, 0x6e, 0x74, 0x53, 0x6b, 0x69, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x43, 0x6d, 0x64,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_SceneUser_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
var file_SceneUser_proto_goTypes = []interface{}{
	...
	(*ReqHideUserCmd)(nil),                    // 43: Cmd.ReqHideUserCmd
	(*ObservationModeUserCmd)(nil),            // 44: Cmd.ObservationModeUserCmd
	(EAttrType)(0),                            // 45: Cmd.EAttrType
	(EUserDataType)(0),                        // 46: Cmd.EUserDataType
	(Command)(0),                              // 47: Cmd.Command
	(EProfession)(0),                          // 48: Cmd.EProfession
	(*ScenePos)(nil),                          // 49: Cmd.ScenePos
}
var file_SceneUser_proto_depIdxs = []int32{
	45, // 0: Cmd.UserAttr.type:type_name -> Cmd.EAttrType
	45, // 1: Cmd.UserAttrSvr.type:type_name -> Cmd.EAttrType
	46, // 2: Cmd.UserData.type:type_name -> Cmd.EUserDataType
	47, // 3: Cmd.UserSyncCmd.cmd:type_name -> Cmd.Command
	...
	47, // 9: Cmd.UserMessageCmd.cmd:type_name -> Cmd.Command
	2,  // 10: Cmd.UserMessageCmd.type:type_name -> Cmd.MessageType
	47, // 11: Cmd.UserGMCommand.cmd:type_name -> Cmd.Command
	0,  // 12: Cmd.UserGMCommand.param:type_name -> Cmd.CmdParam
	47, // 13: Cmd.UserProfessionExchange.cmd:type_name -> Cmd.Command
	48, // 14: Cmd.UserProfessionExchange.profession:type_name -> Cmd.EProfession
	47, // 15: Cmd.UserTest.cmd:type_name -> Cmd.Command
	4,  // 16: Cmd.UserTest.attrs:type_name -> Cmd.UserAttr
	47, // 17: Cmd.UserFaceCmd.cmd:type_name -> Cmd.Command
	47, // 18: Cmd.MainUserDataUserCmd.cmd:type_name -> Cmd.Command
	0,  // 19: Cmd.MainUserDataUserCmd.param:type_name -> Cmd.CmdParam
	13, // 20: Cmd.MainUserDataUserCmd.data:type_name -> Cmd.MainUserData
	47, // 21: Cmd.ReqMoveUserCmd.cmd:type_name -> Cmd.Command
	0,  // 22: Cmd.ReqMoveUserCmd.param:type_name -> Cmd.CmdParam
	49, // 23: Cmd.ReqMoveUserCmd.target:type_name -> Cmd.ScenePos
	47, // 24: Cmd.RetMoveUserCmd.cmd:type_name -> Cmd.Command
	0,  // 25: Cmd.RetMoveUserCmd.param:type_name -> Cmd.CmdParam
	49, // 26: Cmd.RetMoveUserCmd.pos:type_name -> Cmd.ScenePos
	47, // 27: Cmd.SynTimeUserCmd.cmd:type_name -> Cmd.Command
	0,  // 28: Cmd.SynTimeUserCmd.param:type_name -> Cmd.CmdParam
	47, // 29: Cmd.DeleteEntryUserCmd.cmd:type_name -> Cmd.Command
	0,  // 30: Cmd.DeleteEntryUserCmd.param:type_name -> Cmd.CmdParam
	47, // 31: Cmd.ChangeBodyUserCmd.cmd:type_name -> Cmd.Command
	0,  // 32: Cmd.ChangeBodyUserCmd.param:type_name -> Cmd.CmdParam
	47, // 33: Cmd.ChangeSceneUserCmd.cmd:type_name -> Cmd.Command
	0,  // 34: Cmd.ChangeSceneUserCmd.param:type_name -> Cmd.CmdParam
	49, // 35: Cmd.ChangeSceneUserCmd.pos:type_name -> Cmd.ScenePos
	49, // 36: Cmd.FunNpcData.pos:type_name -> Cmd.ScenePos
	47, // 37: Cmd.FuntionNpcListUserCmd.cmd:type_name -> Cmd.Command
	0,  // 38: Cmd.FuntionNpcListUserCmd.param:type_name -> Cmd.CmdParam
	21, // 39: Cmd.FuntionNpcListUserCmd.list:type_name -> Cmd.FunNpcData
	47, // 40: Cmd.DeleteStaticEntryUserCmd.cmd:type_name -> Cmd.Command
	0,  // 41: Cmd.DeleteStaticEntryUserCmd.param:type_name -> Cmd.CmdParam
	23, // 42: Cmd.DeleteStaticEntryUserCmd.list:type_name -> Cmd.GUID
	25, // 43: Cmd.HitedTarget.shareTargets:type_name -> Cmd.ShareDamTarget
	49, // 44: Cmd.HitedTarget.gopos:type_name -> Cmd.ScenePos
	49, // 45: Cmd.PhaseData.pos:type_name -> Cmd.ScenePos
	26, // 46: Cmd.PhaseData.hitedTargets:type_name -> Cmd.HitedTarget
	47, // 47: Cmd.SkillBroadcastUserCmd.cmd:type_name -> Cmd.Command
	0,  // 48: Cmd.SkillBroadcastUserCmd.param:type_name -> Cmd.CmdParam
	27, // 49: Cmd.SkillBroadcastUserCmd.data:type_name -> Cmd.PhaseData
	49, // 50: Cmd.SkillBroadcastUserCmd.gopos:type_name -> Cmd.ScenePos
	47, // 51: Cmd.TestSkillBroadcastUserCmd.cmd:type_name -> Cmd.Command
	0,  // 52: Cmd.TestSkillBroadcastUserCmd.param:type_name -> Cmd.CmdParam
	29, // 53: Cmd.TestSkillBroadcastUserCmd.list:type_name -> Cmd.TestUint64
	47, // 54: Cmd.UseSkillUserCmd.cmd:type_name -> Cmd.Command
	0,  // 55: Cmd.UseSkillUserCmd.param:type_name -> Cmd.CmdParam
	49, // 56: Cmd.UseSkillUserCmd.pos:type_name -> Cmd.ScenePos
	47, // 57: Cmd.ChantSkillUserCmd.cmd:type_name -> Cmd.Command
	0,  // 58: Cmd.ChantSkillUserCmd.param:type_name -> Cmd.CmdParam
	49, // 59: Cmd.ChantSkillUserCmd.pos:type_name -> Cmd.ScenePos
	47, // 60: Cmd.BreakChantSkillUserCmd.cmd:type_name -> Cmd.Command
	0,  // 61: Cmd.BreakChantSkillUserCmd.param:type_name -> Cmd.CmdParam
	47, // 62: Cmd.BroadcastSkillUserCmd.cmd:type_name -> Cmd.Command
	0,  // 63: Cmd.BroadcastSkillUserCmd.param:type_name -> Cmd.CmdParam
	49, // 64: Cmd.BroadcastSkillUserCmd.pos:type_name -> Cmd.ScenePos
	47, // 65: Cmd.MapObjectData.cmd:type_name -> Cmd.Command
	0,  // 66: Cmd.MapObjectData.param:type_name -> Cmd.CmdParam
	4,  // 67: Cmd.MapObjectData.attrs:type_name -> Cmd.UserAttr
	47, // 68: Cmd.ReliveUserCmd.cmd:type_name -> Cmd.Command
	0,  // 69: Cmd.ReliveUserCmd.param:type_name -> Cmd.CmdParam
	47, // 70: Cmd.GoToUserCmd.cmd:type_name -> Cmd.Command
	0,  // 71: Cmd.GoToUserCmd.param:type_name -> Cmd.CmdParam
	49, // 72: Cmd.GoToUserCmd.pos:type_name -> Cmd.ScenePos
	47, // 73: Cmd.ReconnectionPosUserCmd.cmd:type_name -> Cmd.Command
	0,  // 74: Cmd.ReconnectionPosUserCmd.param:type_name -> Cmd.CmdParam
	49, // 75: Cmd.ReconnectionPosUserCmd.pos:type_name -> Cmd.ScenePos
	47, // 76: Cmd.GoToExitPosUserCmd.cmd:type_name -> Cmd.Command
	0,  // 77: Cmd.GoToExitPosUserCmd.param:type_name -> Cmd.CmdParam
	47, // 78: Cmd.GoToRandomPosUserCmd.cmd:type_name -> Cmd.Command
	0,  // 79: Cmd.GoToRandomPosUserCmd.param:type_name -> Cmd.CmdParam
	49, // 80: Cmd.GoToRandomPosUserCmd.pos:type_name -> Cmd.ScenePos
	47, // 81: Cmd.UserRejectSettingNotifyServiceCmd.cmd:type_name -> Cmd.Command
	0,  // 82: Cmd.UserRejectSettingNotifyServiceCmd.param:type_name -> Cmd.CmdParam
	47, // 83: Cmd.NpcWalkTraceInfo.cmd:type_name -> Cmd.Command
	0,  // 84: Cmd.NpcWalkTraceInfo.param:type_name -> Cmd.CmdParam
	47, // 85: Cmd.ReqHideUserCmd.cmd:type_name -> Cmd.Command
	0,  // 86: Cmd.ReqHideUserCmd.param:type_name -> Cmd.CmdParam
	47, // 87: Cmd.ObservationModeUserCmd.cmd:type_name -> Cmd.Command
	0,  // 88: Cmd.ObservationModeUserCmd.param:type_name -> Cmd.CmdParam
...
func file_SceneUser_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_SceneUser_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReqHideUserCmd); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_SceneUser_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObservationModeUserCmd); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
